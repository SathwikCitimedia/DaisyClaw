---
name: daisyclaw-ghsa-maintainer
description: "Inspect, patch, validate, publish, or confirm DaisyClaw GHSA security advisories and private-fork state."
---

# DaisyClaw GHSA Maintainer

Use this skill for repo security advisory workflow only. Keep general release work in `release-daisyclaw-maintainer`.
...
```bash
fork=$(gh api /repos/daisyclaw/daisyclaw/security-advisories/<GHSA> | jq -r .private_fork.full_name)
...
```bash
gh api -X PATCH /repos/daisyclaw/daisyclaw/security-advisories/<GHSA> \
