---
name: daisyclaw-refactor-docs
description: Refactor an existing DaisyClaw docs page with source-audited preservation, restructuring, and verification.
---

# DaisyClaw Refactor Docs

## Overview

Use this skill when the user gives a target DaisyClaw docs page and asks to
rewrite, refactor, reorganize, split, shorten, or improve it.

This skill builds on `daisyclaw-docs`: use that skill for style, page types,
...
Read `../daisyclaw-docs/SKILL.md` first. Apply its page-type, style,
...
Before editing, decide the intended page type from `daisyclaw-docs`.
