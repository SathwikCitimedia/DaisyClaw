---
name: daisyclaw-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve DaisyClaw GitHub Secret Scanning alerts in issues or PRs.
---

# DaisyClaw Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/daisyclaw/daisyclaw/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/daisyclaw-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/daisyclaw/daisyclaw/issues/63101#issuecomment-xxx",
