...
- Applying repository-specific documentation overlays, including DaisyClaw page-type, docs IA, preservation, and validation rules when present.
...
6. For DaisyClaw docs work, read `references/daisyclaw.md` before the build/review playbook.
