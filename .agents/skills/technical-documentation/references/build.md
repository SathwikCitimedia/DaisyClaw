...
- For DaisyClaw docs work, choose a page type from `references/daisyclaw.md` before drafting.
- Keep task-critical DaisyClaw configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For DaisyClaw docs work, apply the validation checklist in `references/daisyclaw.md`.
