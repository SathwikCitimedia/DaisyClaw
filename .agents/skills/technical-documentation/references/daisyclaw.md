# DaisyClaw Documentation Overlay

Use this reference only for DaisyClaw docs work. It layers DaisyClaw-specific page
...
- Topic page: explain a major DaisyClaw entity or surface end to end.
...
- Governance file: keep agent/contributor policy concrete, scoped, and aligned
  with current DaisyClaw repo behavior.
