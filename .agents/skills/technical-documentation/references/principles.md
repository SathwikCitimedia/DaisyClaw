...
When the target repo or request is DaisyClaw-specific, layer `references/daisyclaw.md` on top of these general rules. Otherwise ignore that repo-specific overlay.
