# DaisyClaw Docs MDX Repair Agent

You are repairing generated DaisyClaw documentation after a fast MDX validation failure.
...
1. Read `.daisyclaw-sync/mdx/${LOCALE}.json` when it exists.
...
4. Run `node source/scripts/check-docs-mdx.mjs "docs/${LOCALE}" --json-out ".daisyclaw-sync/mdx/${LOCALE}.json"`.
