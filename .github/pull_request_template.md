...
External contributors must show after-fix evidence from a real DaisyClaw setup. Unit tests, mocks, lint, typechecks, snapshots, and CI are supplemental only.
