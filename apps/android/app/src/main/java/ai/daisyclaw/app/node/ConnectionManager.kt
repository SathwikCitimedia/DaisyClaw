...
import ai.daisyclaw.app.gateway.GatewayClientInfo
import ai.daisyclaw.app.gateway.GatewayConnectOptions
import ai.daisyclaw.app.gateway.GatewayEndpoint
import ai.daisyclaw.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "DaisyClawAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "daisyclaw-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "daisyclaw-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
