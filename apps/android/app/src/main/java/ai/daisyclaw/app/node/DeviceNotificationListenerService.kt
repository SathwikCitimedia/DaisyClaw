...
import ai.daisyclaw.app.NotificationBurstLimiter
import ai.daisyclaw.app.SecurePrefs
import ai.daisyclaw.app.allowsPackage
import ai.daisyclaw.app.isWithinQuietHours
...
class DeviceNotificationListenerService : NotificationListenerService() {
  ...
  companion object {
    ...
    private fun recentPackagesPrefs(context: Context) = context.applicationContext.getSharedPreferences("daisyclaw.secure", Context.MODE_PRIVATE)
