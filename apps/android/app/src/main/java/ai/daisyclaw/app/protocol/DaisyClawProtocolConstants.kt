...
/** Capability ids advertised by the Android node to the DaisyClaw gateway. */
enum class DaisyClawCapability(
  val rawValue: String,
) {
  Canvas("canvas"),
  Camera("camera"),
...
enum class DaisyClawCanvasCommand(
  val rawValue: String,
) {
...
enum class DaisyClawCanvasA2UICommand(
  val rawValue: String,
) {
...
enum class DaisyClawCameraCommand(
  val rawValue: String,
) {
  List("camera.list"),
  Snap("camera.snap"),
...
enum class DaisyClawSmsCommand(
  val rawValue: String,
) {
  Send("sms.send"),
  Search("sms.search"),
...
enum class DaisyClawTalkCommand(
  val rawValue: String,
) {
...
enum class DaisyClawLocationCommand(
  val rawValue: String,
) {
  Get("location.get"),
  ;
...
enum class DaisyClawDeviceCommand(
  val rawValue: String,
) {
...
enum class DaisyClawNotificationsCommand(
  val rawValue: String,
) {
...
enum class DaisyClawSystemCommand(
  val rawValue: String,
) {
...
enum class DaisyClawPhotosCommand(
  val rawValue: String,
) {
...
enum class DaisyClawContactsCommand(
  val rawValue: String,
) {
...
enum class DaisyClawCalendarCommand(
  val rawValue: String,
) {
...
enum class DaisyClawMotionCommand(
  val rawValue: String,
) {
...
enum class DaisyClawCallLogCommand(
  val rawValue: String,
) {
