...
fun CanvasScreen(
  ...
  AndroidView(
    ...
    factory = {
      ...
      if (isDebuggable) {
        Log.d("DaisyClawWebView", "userAgent: ${webSettings.userAgentString}")
      }
      ...
      webView.webViewClient =
        object : WebViewClient() {
          ...
          override fun onReceivedError(
            ...
            Log.e("DaisyClawWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
          }
          ...
          override fun onPageFinished(
            ...
            currentPageUrlRef.set(url)
            if (isDebuggable) {
              Log.d("DaisyClawWebView", "onPageFinished: $url")
            }
      ...
      if (WebViewFeature.isFeatureSupported(WebViewFeature.WEB_MESSAGE_LISTENER)) {
        ...
        Log.w("DaisyClawWebView", "WebMessageListener unsupported; canvas actions disabled")
      }
...
internal class CanvasA2UIActionBridge(
  ...
  companion object {
    const val interfaceName: String = "daisyclawCanvasA2UIAction"
