      ...
      Surface(
        ...
        Column(
          ...
          if (pairingRequired) {
            ...
            CommandBlock("daisyclaw devices list")
            CommandBlock("daisyclaw devices approve <requestId>")
          }
          Text("DaisyClaw Android ${daisyClawAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("daisyclaw qr --setup-code-only")
          CommandBlock("daisyclaw qr --json")
          Text(
...
private fun gatewayPairingInstruction(problem: GatewayConnectionProblem?): String =
  if (problem?.canAutoRetry == true) {
    "Approve this phone on the gateway. DaisyClaw will reconnect automatically."
  } else {
