...
private val LocalDaisyClawDarkTheme = staticCompositionLocalOf { true }
...
fun DaisyClawTheme(
  ...
  DaisyClawSystemBarAppearance(lightAppearance = !isDark)

  CompositionLocalProvider(
    LocalMobileColors provides mobileColors,
    LocalDaisyClawDarkTheme provides isDark,
  ) {
...
@Composable
internal fun DaisyClawSystemBarAppearance(lightAppearance: Boolean) {
...
fun overlayContainerColor(): Color {
  ...
  val isDark = LocalDaisyClawDarkTheme.current
