...
import ai.daisyclaw.app.GatewayDeviceTokenSummary
import ai.daisyclaw.app.GatewayNodeSummary
import ai.daisyclaw.app.GatewayNodesDevicesSummary
import ai.daisyclaw.app.GatewayPairedDeviceSummary
import ai.daisyclaw.app.GatewayPendingDeviceSummary
...
private fun nodeSubtitle(node: GatewayNodeSummary): String {
  ...
  val version = node.version?.let { "DaisyClaw $it" }
