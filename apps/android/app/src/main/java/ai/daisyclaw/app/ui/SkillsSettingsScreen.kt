...
internal fun SkillsSettingsScreen(
  ...
  SettingsDetailFrame(
    title = "Skills",
    subtitle = "Installed capabilities available to DaisyClaw.",
...
private fun skillSourceLabel(skill: GatewaySkillSummary): String =
  when (skill.source) {
    "daisyclaw-bundled" -> if (skill.bundled) "Built-in" else "Bundled"
    "daisyclaw-managed" -> "Installed"
    "daisyclaw-workspace" -> "Workspace"
    "daisyclaw-extra" -> "Extra"
    else -> "Skill"
  }
