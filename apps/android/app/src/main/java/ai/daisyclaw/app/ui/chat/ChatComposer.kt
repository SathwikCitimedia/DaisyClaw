...
import ai.daisyclaw.app.ui.mobileAccentBorderStrong
...
import ai.daisyclaw.app.ui.mobileHeadline
import ai.daisyclaw.app.ui.mobileSurface
import ai.daisyclaw.app.ui.mobileText
import ai.daisyclaw.app.ui.mobileTextSecondary
import ai.daisyclaw.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.daisyclaw.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.daisyclaw.app.ui.mobileFontFamily,
