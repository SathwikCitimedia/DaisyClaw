...
class ChatMarkdownTest {
  ...
  fun markdownLinksUseLabelTextAndDestinationUrl() {
    val annotated = buildChatInlineMarkdown("Open [docs](https://docs.daisyclaw.ai/help/testing) now")
    ...
    assertEquals("https://docs.daisyclaw.ai/help/testing", (links.single().item as LinkAnnotation.Url).url)
  }

  @Test
  fun markdownLinksDropUnsafeDestinations() {
    listOf(
      "intent://example/#Intent;scheme=daisyclaw;end",
