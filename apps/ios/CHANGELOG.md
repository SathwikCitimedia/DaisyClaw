# DaisyClaw iOS Changelog

## 2026.6.2 - 2026-06-02

DaisyClaw is now available on iPhone.

Connect to your DaisyClaw Gateway to chat with your assistant, use realtime Talk mode, review approvals, share content from iOS, and bring device capabilities like camera, location, screen, and notifications into your private automation workflows.

## 2026.6.1 - 2026-06-01

Maintenance update for the current DaisyClaw release.
...
Maintenance update for the current DaisyClaw beta release.
...
Maintenance update for the current DaisyClaw development release.
...
First App Store release of DaisyClaw for iPhone. Pair with your DaisyClaw Gateway to use chat, voice, sharing, and device actions from iOS.
