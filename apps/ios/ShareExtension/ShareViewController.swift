...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.daisyclaw.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to DaisyClaw", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to DaisyClaw gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to DaisyClaw.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "DaisyClawShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "DaisyClaw is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "DaisyClaw Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("daisyclaw-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
