...
struct ChatProTab: View {
                ...
                VStack(spacing: 0) {
                    ...
                    if let viewModel {
                        DaisyClawChatView(
                            ...
                            assistantAvatarTint: DaisyClawBrand.accent,
                        ...
                        .fill(
                            LinearGradient(
                                colors: [
                                    ...
                                    DaisyClawBrand.accentHot,
                                ],
                                startPoint: .topLeading,
                                endPoint: .bottomTrailing)))
                .overlay(Circle().strokeBorder(.white.opacity(0.18), lineWidth: 1))
                .shadow(color: DaisyClawBrand.accent.opacity(0.18), radius: 10, y: 5)
        } else {
            ProIconBadge(systemName: "bubble.left", color: DaisyClawBrand.accent)
        }
    }
    ...
    private func syncChatViewModel() {
        ...
        guard let viewModel else {
            ...
            self.viewModel = DaisyClawChatViewModel(
    ...
    private var talkControl: DaisyClawChatTalkControl {
        DaisyClawChatTalkControl(
    ...
    private var chatUserAccent: Color {
        self.colorScheme == .light ? Color(red: 0 / 255.0, green: 122 / 255.0, blue: 255 / 255.0) : DaisyClawBrand.accent
    }
