...
struct CommandCenterTab: View {
    ...
    @State private var defaultChatSessionEntry: DaisyClawChatSessionEntry?
    @State private var recentChatSessions: [DaisyClawChatSessionEntry] = []
    var headerTitle: String = "DaisyClaw"
    var headerLeadingAction: DaisyClawSidebarHeaderAction?
        ...
        NavigationStack {
            GeometryReader { geometry in
                ZStack {
                    ...
                    .safeAreaPadding(.bottom, DaisyClawProMetric.bottomScrollInset)
                }
            }
    ...
    private var header: some View {
            ...
            subtitleLineLimit: 1)
        {
            ...
            {
                DaisyClawProMark(size: 28, shadowRadius: 5)
            }
        } accessory: {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                HStack(spacing: 0) {
                    ...
                    self.gatewayFact(
                        ...
                        color: DaisyClawBrand.accentHot)
                }
                .padding(.vertical, 9)
                .background {
        ...
        HStack(spacing: 8) {
            ...
            if let badgeValue {
                Text(badgeValue)
                    ...
                    .padding(.vertical, 3)
                    .background(DaisyClawBrand.accentHot, in: Capsule())
            }
            Spacer(minLength: 8)
            if let value {
                if let action {
    ...
    private var gatewayStatusColor: Color {
        self.gatewayConnected ? DaisyClawBrand.ok : .secondary
    }
    ...
    private var defaultChatWorkItem: WorkItem {
        ...
        return WorkItem(
            ...
            trailing: "chat",
            color: isOpen ? DaisyClawBrand.accent : DaisyClawBrand.ok,
            progress: nil,
            route: .chat(nil))
    }
    ...
    private func refreshRecentSessionsIfNeeded() async {
        ...
        do {
            let transport: any DaisyClawChatTransport = self.appModel.isAppleReviewDemoModeEnabled
    ...
    private static func sessionChoices(
        _ sessions: [DaisyClawChatSessionEntry],
        currentSessionKey: String,
        defaultSessionKey: String) -> [DaisyClawChatSessionEntry]
    {
    ...
    static func sessionWorkItem(
        for session: DaisyClawChatSessionEntry,
        currentSessionKey: String) -> WorkItem
    {
        ...
        return WorkItem(
            ...
            trailing: "chat",
            color: isCurrent ? DaisyClawBrand.accent : DaisyClawBrand.ok,
            progress: nil,
            route: .chat(session.key))
    }

    fileprivate static func sessionTitle(_ session: DaisyClawChatSessionEntry) -> String {
    ...
    fileprivate static func sessionDetail(_ session: DaisyClawChatSessionEntry) -> String {
...
struct CommandSessionsScreen: View {
    ...
    @State private var sessions: [DaisyClawChatSessionEntry] = []
    @State private var isLoading = false
    @State private var loadErrorText: String?
    let headerLeadingAction: DaisyClawSidebarHeaderAction?
    let openChat: () -> Void

    init(headerLeadingAction: DaisyClawSidebarHeaderAction? = nil, openChat: @escaping () -> Void) {
