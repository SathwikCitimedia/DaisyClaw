...
struct IPadSkillWorkshopScreen: View {
    ...
    init(headerLeadingAction: DaisyClawSidebarHeaderAction? = nil, openSettings: @escaping () -> Void = {}) {
    ...
    private var filtersCard: some View {
        ProCard(radius: DaisyClawProMetric.cardRadius) {
    ...
    private var proposalList: some View {
        ProCard(padding: 0, radius: DaisyClawProMetric.cardRadius) {
            VStack(spacing: 0) {
                ProPanelHeader(
                    title: "Queue",
...
private struct IPadSkillProposalKanbanCard: View {
    ...
    var body: some View {
                    ...
                    HStack(alignment: .top, spacing: 10) {
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            Text(self.proposal.title)
                                .font(.subheadline.weight(.semibold))
                                .foregroundStyle(self.isSelected ? DaisyClawBrand.accent : .primary)
                                .lineLimit(2)
        ...
        .padding(12)
        .background(
            self.isSelected ? DaisyClawBrand.accent.opacity(0.08) : Color.clear,
...
struct IPadSkillProposal: Identifiable {
    ...
    var statusColor: Color {
        switch self.status {
        case "pending": DaisyClawBrand.warn
        case "applied": DaisyClawBrand.ok
        case "rejected": .secondary
        case "quarantined", "stale": DaisyClawBrand.warn
        default: DaisyClawBrand.accent
        }
    }
