...
struct RootTabsPhoneControlHub: View {
    ...
    private var headerCard: some View {
        if self.isCompactHeight {
            ProCard(padding: 8, radius: DaisyClawProMetric.cardRadius) {
                HStack(spacing: 12) {
                    DaisyClawProMark(size: 24, shadowRadius: 3)
            ...
            ProCard(radius: DaisyClawProMetric.cardRadius) {
                VStack(alignment: .leading, spacing: 12) {
                    HStack(spacing: 12) {
                        DaisyClawProMark(size: 32, shadowRadius: 4)
                        VStack(alignment: .leading, spacing: 3) {
                            Text(self.sidebarActiveAgentTitle)
                                .font(.headline)
                                .lineLimit(1)
    ...
    private var phoneDetailBackAction: DaisyClawSidebarHeaderAction {
        DaisyClawSidebarHeaderAction(
            systemName: "chevron.left",
            accessibilityLabel: "Back to Control",
            accessibilityIdentifier: "DaisyClawPhoneDetailBackButton",
