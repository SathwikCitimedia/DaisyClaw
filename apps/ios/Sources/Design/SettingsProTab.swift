...
struct SettingsProTab: View {
    ...
    @AppStorage("location.enabledMode") var locationModeRaw: String = DaisyClawLocationMode.off.rawValue
    ...
    @State var previousLocationModeRaw: String = DaisyClawLocationMode.off.rawValue
