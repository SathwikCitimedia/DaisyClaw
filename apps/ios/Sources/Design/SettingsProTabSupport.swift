...
private struct SettingsGatewayStatesPreview: View {
                ...
                VStack(alignment: .leading, spacing: 16) {
                    self.stateSection("Connected") {
                        self.gatewayStatusCard(
                            ...
                            detail: "Connected to daisyclaw-gateway.tailnet.ts.net.",
                            value: "online",
                            color: DaisyClawBrand.ok)
                        self.gatewayFactsCard(
                            address: "100.88.41.20:18789",
                            server: "daisyclaw-gateway",
                            discovered: "3",
                            agent: "Aiden")
                    }
    ...
    private static let pairingProblem = GatewayConnectionProblem(
        ...
        message: "Run /pair approve in your DaisyClaw chat before this iPad can connect.",
