...
private struct ExecApprovalPromptCard: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            VStack(alignment: .leading, spacing: 6) {
                Text("Exec approval required")
                    .font(.headline)
                Text("DaisyClaw opened from a notification. Review this exec request before continuing.")
                    .font(.subheadline)
        ...
        .padding(18)
        .proPanelSurface(tint: DaisyClawBrand.accentHot, radius: 20, isProminent: true)
    }
