...
extension GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [
            ...
            DaisyClawCapability.screen.rawValue,
        ]
        ...
        if cameraEnabled { caps.append(DaisyClawCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(DaisyClawCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = DaisyClawLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(DaisyClawCapability.location.rawValue) }

        caps.append(DaisyClawCapability.device.rawValue)
        caps.append(DaisyClawCapability.talk.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(DaisyClawCapability.watch.rawValue)
        }
        caps.append(DaisyClawCapability.photos.rawValue)
        caps.append(DaisyClawCapability.contacts.rawValue)
        caps.append(DaisyClawCapability.calendar.rawValue)
        caps.append(DaisyClawCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(DaisyClawCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            DaisyClawScreenCommand.record.rawValue,
            DaisyClawSystemCommand.notify.rawValue,
            DaisyClawChatCommand.push.rawValue,
        ...
        if caps.contains(DaisyClawCapability.camera.rawValue) {
            commands.append(DaisyClawCameraCommand.list.rawValue)
            commands.append(DaisyClawCameraCommand.snap.rawValue)
            commands.append(DaisyClawCameraCommand.clip.rawValue)
        }
        if caps.contains(DaisyClawCapability.location.rawValue) {
            commands.append(DaisyClawLocationCommand.get.rawValue)
        }
        if caps.contains(DaisyClawCapability.device.rawValue) {
            commands.append(DaisyClawDeviceCommand.status.rawValue)
            commands.append(DaisyClawDeviceCommand.info.rawValue)
        }
        if caps.contains(DaisyClawCapability.watch.rawValue) {
            commands.append(DaisyClawWatchCommand.status.rawValue)
            commands.append(DaisyClawWatchCommand.notify.rawValue)
        }
        if caps.contains(DaisyClawCapability.photos.rawValue) {
            commands.append(DaisyClawPhotosCommand.latest.rawValue)
        }
        if caps.contains(DaisyClawCapability.contacts.rawValue) {
            commands.append(DaisyClawContactsCommand.search.rawValue)
            commands.append(DaisyClawContactsCommand.add.rawValue)
        }
        if caps.contains(DaisyClawCapability.calendar.rawValue) {
            commands.append(DaisyClawCalendarCommand.events.rawValue)
            commands.append(DaisyClawCalendarCommand.add.rawValue)
        }
        if caps.contains(DaisyClawCapability.reminders.rawValue) {
            commands.append(DaisyClawRemindersCommand.list.rawValue)
            commands.append(DaisyClawRemindersCommand.add.rawValue)
        }
        if caps.contains(DaisyClawCapability.motion.rawValue) {
            commands.append(DaisyClawMotionCommand.activity.rawValue)
            commands.append(DaisyClawMotionCommand.pedometer.rawValue)
        }
