...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.daisyclaw.gateway"
    private static let nodeService = "ai.daisyclaw.node"
    private static let talkService = "ai.daisyclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.daisyclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.daisyclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("daisyclaw-gateway.log")
    }
