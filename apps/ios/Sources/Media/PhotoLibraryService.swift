...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: DaisyClawPhotosLatestParams) async throws -> DaisyClawPhotosLatestPayload {
        ...
        var results: [DaisyClawPhotoPayload] = []
        ...
        return DaisyClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> DaisyClawPhotoPayload
    {
