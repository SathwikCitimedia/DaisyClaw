...
struct OnboardingIntroStep: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            DaisyClawProMark(size: 64, shadowRadius: 14)
                .padding(.bottom, 18)
            ...
            Text("Turn this device into a secure DaisyClaw node for chat, voice, camera, and device tools.")
                .font(.subheadline)
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                Label("Use DaisyClaw from your phone", systemImage: "message.fill")
            }
            ...
            HStack(alignment: .top, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    Text("Security notice")
                        .font(.headline)
                    Text(
                        "The connected DaisyClaw agent can use device capabilities you enable, "
...
struct OnboardingWelcomeStep: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("Scan a QR code from your DaisyClaw gateway or continue with manual setup.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
                .padding(.horizontal, 32)
            ...
            VStack(alignment: .leading, spacing: 8) {
                Text("How to pair")
                    .font(.headline)
                Text("In your DaisyClaw chat, run")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
                Text("/pair qr")
