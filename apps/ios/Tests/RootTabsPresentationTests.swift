...
@Suite struct RootTabsPresentationTests {
    ...
    @Test func chatSidebarDestinationCanUseRouteHeaderInsteadOfAgentBranding() {
        ...
        #expect(ChatProTab.defaultHeaderTitle(showsAgentBadge: true, agentDisplayName: "DaisyClaw") == "DaisyClaw")
        #expect(ChatProTab.defaultHeaderTitle(showsAgentBadge: false, agentDisplayName: "DaisyClaw") == "Chat")
    }
