...
@Suite struct RootTabsSourceGuardTests {
    @Test func hiddenSidebarRevealUsesDestinationHeaderWithoutReservedRail() throws {
        ...
        #expect(componentSource.contains("DaisyClawSidebarHeaderLeadingSlot"))
    ...
    @Test func sidebarKeepsNavigationModelDestinationOnly() throws {
        ...
        #expect(source.contains("DaisyClawProMark(size: 30"))
        #expect(source.contains("Text(\"DaisyClaw\")"))
    ...
    @Test func sidebarRoutesUseDestinationHeadersInsteadOfRepeatedProductBranding() throws {
        ...
        #expect(!sidebarDetail.contains("headerTitle: \"DaisyClaw\""))
        #expect(agentOverviewSource.contains("DaisyClawAdaptiveHeaderRow("))
        #expect(agentOverviewSource.contains("title: self.headerTitle"))
        #expect(!agentOverviewSource.contains("Text(\"DaisyClaw\")"))
        #expect(docsSource.contains("DaisyClawAdaptiveHeaderRow("))
        #expect(docsSource.contains("title: \"Docs\""))
        #expect(!docsSource.contains("Text(\"DaisyClaw Docs\")"))
    }
    ...
    @Test func agentsDirectRouteKeepsSingleSidebarControl() throws {
        ...
        #expect(nodesSource.contains("DaisyClawSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
        #expect(dreamingSource.contains("DaisyClawSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
    }
    ...
    @Test func routedHeadersUseSharedAdaptiveLayout() throws {
        ...
        #expect(componentsSource.contains("struct DaisyClawAdaptiveHeaderRow<Leading: View, Accessory: View>: View"))
        ...
        #expect(featureChromeSource.contains("DaisyClawAdaptiveHeaderRow("))
        #expect(docsSource.contains("DaisyClawAdaptiveHeaderRow("))
        #expect(overviewSource.contains("DaisyClawAdaptiveHeaderRow("))
        #expect(chatSource.contains("DaisyClawAdaptiveHeaderRow("))
        #expect(agentOverviewSource.contains("DaisyClawAdaptiveHeaderRow("))
        #expect(settingsSource.contains("DaisyClawAdaptiveHeaderRow("))
    }
    ...
    @Test func phoneHubKeepsDocsAsDestinationOnly() throws {
        ...
        #expect(source.contains("DaisyClawDocsScreen("))
        ...
        #expect(!source.contains("https://docs.daisyclaw.ai"))
    }
    ...
    @Test func phoneHubHeaderStaysTaskFirst() throws {
        ...
        #expect(source.contains("private var phoneDetailBackAction: DaisyClawSidebarHeaderAction"))
        #expect(source.contains("accessibilityLabel: \"Back to Control\""))
        #expect(source.contains("accessibilityIdentifier: \"DaisyClawPhoneDetailBackButton\""))
    ...
    @Test func activityScreenStaysSplitFromTaskFeatureScreens() throws {
        ...
        #expect(!taskSource.contains("import DaisyClawChatUI"))
    ...
    @Test func routedFeatureChromeStaysSplitFromTaskFeatureScreens() throws {
        ...
        #expect(chromeSource.contains("DaisyClawSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
        #expect(chromeSource.contains("DaisyClawGatewayCompactPill()"))
    ...
    @Test func routedGatewayPillsOpenGatewaySettings() throws {
        ...
        #expect(agentOverviewSource.contains("DaisyClawGatewayCompactPill()"))
    ...
    @Test func gatewaySettingsKeepsPairingTrustDiagnosticsAndTailscaleActions() throws {
        ...
        #expect(actionsSource.contains("Run /pair approve in your DaisyClaw chat"))
    ...
    @Test func gatewaySettingsPreviewMatrixCoversPrimaryStates() throws {
        ...
        #expect(supportSource.contains("Run /pair approve in your DaisyClaw chat"))
    ...
    private static func proComponentsSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/Design/DaisyClawProComponents.swift")
    }
    ...
    private static func docsSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/Design/DaisyClawDocsScreen.swift")
    }
    ...
    private static func sharedChatPreviewSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("shared/DaisyClawKit/Sources/DaisyClawChatUI/ChatView+Previews.swift")
    }
    ...
    private static func xcodeProjectSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("DaisyClaw.xcodeproj/project.pbxproj")
    }
