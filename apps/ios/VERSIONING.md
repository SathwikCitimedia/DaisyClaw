# DaisyClaw iOS Versioning

DaisyClaw iOS uses a **pinned CalVer release version** instead of reading the current gateway version automatically on every build.
