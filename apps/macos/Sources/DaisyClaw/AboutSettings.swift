...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/daisyclaw/daisyclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/daisyclaw/daisyclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://daisyclaw.ai")
            ...
            Text("© 2026 DaisyClaw Foundation — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "DaisyClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "DaisyClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "DaisyClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "DaisyClawGitCommit") as? String) ??
            "unknown"
    }
