...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: DaisyClawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": DaisyClawProtocol.AnyCodable("start"),
                "name": DaisyClawProtocol.AnyCodable("bash"),
            ],
            summary: nil)
