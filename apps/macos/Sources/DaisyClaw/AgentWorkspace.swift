...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.daisyclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return DaisyClawConfigFile.defaultWorkspaceURL() }
