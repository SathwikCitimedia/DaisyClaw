...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.daisyclaw", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install DaisyClaw CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .daisyclawSelectSettingsTab, object: tab)
        }
    }
