...
enum DaisyClawConfigFile {
    private static let logger = Logger(subsystem: "ai.daisyclaw", category: "config")
    ...
    static func url() -> URL {
        DaisyClawPaths.configURL
    }

    static func stateDirURL() -> URL {
        DaisyClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        DaisyClawPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-daisyclaw-config-file",
            "event": "config.write",
