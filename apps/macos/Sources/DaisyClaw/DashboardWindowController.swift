...
final class DashboardWindowController: NSWindowController, WKNavigationDelegate, NSWindowDelegate {
    ...
    private static func installNativeChromeScript(into userContentController: WKUserContentController) {
        let css = """
        html.daisyclaw-native-macos {
          --daisyclaw-native-titlebar-height: 50px;
        }
        @media (min-width: 700px) {
          html.daisyclaw-native-macos .sidebar-shell {
            padding-top: max(14px, var(--daisyclaw-native-titlebar-height)) !important;
          }
          html.daisyclaw-native-macos .sidebar-shell__header {
        ...
        (() => {
          try {
            if (document.getElementById("daisyclaw-native-macos-chrome")) return;
            const style = document.createElement("style");
            style.id = "daisyclaw-native-macos-chrome";
            style.textContent = \(Self.jsStringLiteral(css));
            document.documentElement.classList.add("daisyclaw-native-macos");
        ...
        auth: DashboardWindowAuth)
    {
        ...
        (() => {
          try {
            ...
            Object.defineProperty(window, "__DAISYCLAW_NATIVE_CONTROL_AUTH__", {
              value: \(json),
              configurable: true,
            });
          } catch {}
