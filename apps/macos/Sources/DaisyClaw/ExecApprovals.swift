...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.daisyclaw", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        DaisyClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        DaisyClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }

    private static func legacyStateDirURLs() -> [URL] {
        if let home = DaisyClawEnv.path("DAISYCLAW_HOME") {
            var urls = [
                URL(fileURLWithPath: home, isDirectory: true)
                    .appendingPathComponent(".daisyclaw", isDirectory: true),
            ]
    ...
    private static func legacyFileURLIfPending() -> URL? {
        guard DaisyClawEnv.path("DAISYCLAW_STATE_DIR") != nil else { return nil }
    ...
    private static func ensureSecureStateDirectory() {
        let url = DaisyClawPaths.stateDirURL
        do {
