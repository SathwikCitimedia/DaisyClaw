...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.daisyclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".daisyclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
        ...
        quiet: Bool) async -> CommandResult
    {
        ...
        #endif
        let command = CommandResolver.daisyclawCommand(
            subcommand: "gateway",
