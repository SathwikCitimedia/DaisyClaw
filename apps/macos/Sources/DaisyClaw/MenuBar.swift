...
struct DaisyClawApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.daisyclaw", category: "app")
    ...
    var body: some Scene {
        ...
        Window("DaisyClaw Settings", id: SettingsWindowOpener.windowID) {
    ...
    private func applyStatusItemAppearance(paused _: Bool, sleeping _: Bool) {
        ...
        self.statusItem?.button?.toolTip = self.state.voiceWakeMeterActive
            ? "DaisyClaw - Voice Wake live meter active"
            : "DaisyClaw"
    }
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "ai.daisyclaw", category: "Chat")
