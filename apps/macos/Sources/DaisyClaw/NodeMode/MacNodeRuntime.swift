...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case DaisyClawBrowserCommand.proxy.rawValue:
            ...
            case DaisyClawLocationCommand.get.rawValue:
            ...
            case DaisyClawSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case DaisyClawSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case DaisyClawSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case DaisyClawSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case DaisyClawSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case DaisyClawCanvasA2UICommand.push.rawValue,
             DaisyClawCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func handleBrowserProxyInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        guard DaisyClawConfigFile.browserControlEnabled() else {
            return BridgeInvokeResponse(
                id: req.id,
                ok: false,
                error: DaisyClawNodeError(
    ...
    private func handleScreenSnapshotInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        let res: (data: Data, format: DaisyClawScreenSnapshotFormat, width: Int, height: Int)
        do {
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return baseUrl.appendingPathComponent("__daisyclaw__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(DaisyClawSystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(DaisyClawSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: DaisyClawSystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> DaisyClawLocationMode {
    ...
    private static func errorResponse(
        ...
        code: DaisyClawNodeErrorCode,
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: DaisyClawNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: DaisyClawCanvasSnapshotFormat,
        maxWidth: Int?,
