...
enum UIStrings {
    static let welcomeTitle = "Welcome to DaisyClaw"
}
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: DaisyClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g daisyclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: DaisyClawChatViewModel(
