...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.daisyclaw", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> DaisyClawSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: DaisyClawSessionPreviewEntry,
    ...
    private static func cache(payload: DaisyClawSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: DaisyClawChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [DaisyClawKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [DaisyClawKit.AnyCodable]) -> [DaisyClawChatMessage] {
    ...
    private static func previewText(for message: DaisyClawChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: DaisyClawChatMessage) -> Bool {
    ...
    private static func toolNames(for message: DaisyClawChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: DaisyClawChatMessage) -> String? {
