...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .daisyclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? DaisyClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? DaisyClawPaths.stateDirURL.path
...
private struct SettingsTabGroup: Identifiable {
    ...
    static func defaultGroups(showDebug: Bool) -> [SettingsTabGroup] {
        var groups = [
            ...
            SettingsTabGroup(title: "DaisyClaw", tabs: [.about]),
        ]
...
extension Notification.Name {
    static let daisyclawSelectSettingsTab = Notification.Name("daisyclawSelectSettingsTab")
}
