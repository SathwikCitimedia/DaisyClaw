...
final class TalkMLXSpeechSynthesizer {
    ...
    private let logger = Logger(subsystem: "ai.daisyclaw", category: "talk.mlx")
    ...
    func synthesize(
        ...
        let tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("daisyclaw-mlx-tts-\(token.uuidString)", isDirectory: true)
    ...
    private static func helperInvocation() -> HelperInvocation {
        ...
        if let override = ProcessInfo.processInfo.environment["DAISYCLAW_MLX_TTS_BIN"], !override.isEmpty {
        ...
        if let executableDir = Bundle.main.executableURL?.deletingLastPathComponent() {
            let bundled = executableDir.appendingPathComponent("daisyclaw-mlx-tts")
        ...
        return HelperInvocation(
            ...
            argumentPrefix: ["daisyclaw-mlx-tts"],
            displayName: "daisyclaw-mlx-tts")
    }
