...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.daisyclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other DaisyClaw windows, but below the system’s pop-up menus.
