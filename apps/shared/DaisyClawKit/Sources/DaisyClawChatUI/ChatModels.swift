...
public typealias DaisyClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias DaisyClawPlatformImage = UIImage
#endif

public struct DaisyClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct DaisyClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: DaisyClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(DaisyClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct DaisyClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct DaisyClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [DaisyClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: DaisyClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [DaisyClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: DaisyClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedUsage = try container.decodeIfPresent(DaisyClawChatUsage.self, forKey: .usage)
        ...
        if let decoded = try? container.decode([DaisyClawChatMessageContent].self, forKey: .content) {
...
public struct DaisyClawChatHistoryPayload: Codable, Sendable {
...
public struct DaisyClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct DaisyClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [DaisyClawSessionPreviewItem]
}

public struct DaisyClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [DaisyClawSessionPreviewEntry]

    public init(ts: Int, previews: [DaisyClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct DaisyClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct DaisyClawChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct DaisyClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct DaisyClawSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: DaisyClawChatMessage?
...
public struct DaisyClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct DaisyClawChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct DaisyClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct DaisyClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: DaisyClawPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: DaisyClawPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct DaisyClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
