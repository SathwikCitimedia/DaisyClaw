...
public struct DaisyClawChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public struct DaisyClawChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct DaisyClawChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
    public let contextTokens: Int?
    public let thinkingLevels: [DaisyClawChatThinkingLevelOption]?
    ...
    public init(
        ...
        model: String?,
        contextTokens: Int?,
        thinkingLevels: [DaisyClawChatThinkingLevelOption]? = nil,
...
public struct DaisyClawChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
...
public struct DaisyClawChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: DaisyClawChatSessionsDefaults?
    public let sessions: [DaisyClawChatSessionEntry]
    ...
    public init(
        ...
        sessions: [DaisyClawChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
