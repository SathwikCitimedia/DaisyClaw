...
public enum DaisyClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct DaisyClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct DaisyClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
