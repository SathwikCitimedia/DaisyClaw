...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: DaisyClawProtocol.AnyCodable]?
    {
        ...
        return [
            "id": DaisyClawProtocol.AnyCodable(identity.deviceId),
            "publicKey": DaisyClawProtocol.AnyCodable(publicKey),
            "signature": DaisyClawProtocol.AnyCodable(signature),
            "signedAt": DaisyClawProtocol.AnyCodable(signedAtMs),
            "nonce": DaisyClawProtocol.AnyCodable(nonce),
        ]
    }
}
