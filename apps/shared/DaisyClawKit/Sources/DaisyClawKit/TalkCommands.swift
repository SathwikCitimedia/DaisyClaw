...
public enum DaisyClawTalkCommand: String, Codable, Sendable {
...
public struct DaisyClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct DaisyClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
