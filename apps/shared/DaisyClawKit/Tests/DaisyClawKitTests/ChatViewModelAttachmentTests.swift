...
private struct AttachmentProcessingTransport: DaisyClawChatTransport {
    func requestHistory(sessionKey _: String) async throws -> DaisyClawChatHistoryPayload {
...
final class ChatViewModelAttachmentTests: XCTestCase {
    func testImageAttachmentsAreProcessedBeforeStaging() async throws {
        ...
        let viewModel = await MainActor.run {
            DaisyClawChatViewModel(sessionKey: "main", transport: AttachmentProcessingTransport())
        }
