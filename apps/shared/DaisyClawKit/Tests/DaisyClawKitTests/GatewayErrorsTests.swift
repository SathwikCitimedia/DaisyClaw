...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "daisyclaw devices approve req-123",
            docsURLString: "https://docs.daisyclaw.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "daisyclaw devices approve req-123")
        #expect(error.docsURLString == "https://docs.daisyclaw.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "daisyclaw devices approve req-123")
    }
