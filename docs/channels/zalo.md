...
Zalo ships as a bundled plugin in current DaisyClaw releases, so normal packaged
...
- Install via CLI: `daisyclaw plugins install @daisyclaw/zalo`
- Pinned version: `daisyclaw plugins install @daisyclaw/zalo@2026.5.2`
- Or from a source checkout: `daisyclaw plugins install ./path/to/local/zalo-plugin`
...
This page reflects current DaisyClaw behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `daisyclaw pairing list zalo`
  - `daisyclaw pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in DaisyClaw.
...
- Example: `daisyclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `daisyclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `daisyclaw logs --follow`
