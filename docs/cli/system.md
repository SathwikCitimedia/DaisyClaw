---
summary: "CLI reference for `daisyclaw system` (system events, heartbeat, presence)"
read_when:
...
daisyclaw system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$DAISYCLAW_GATEWAY_TOKEN"
daisyclaw system heartbeat enable
daisyclaw system heartbeat last
daisyclaw system presence
```
