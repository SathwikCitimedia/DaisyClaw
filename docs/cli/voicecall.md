---
summary: "CLI reference for `daisyclaw voicecall` (voice-call plugin command surface)"
read_when:
...
daisyclaw voicecall smoke    [-t <phone>] [--message <text>] [--mode <m>] [--yes] [--json]
daisyclaw voicecall call     -m <text> [-t <phone>] [--mode <m>]
daisyclaw voicecall start    --to <phone> [--message <text>] [--mode <m>]
daisyclaw voicecall continue --call-id <id> --message <text>
daisyclaw voicecall speak    --call-id <id> --message <text>
daisyclaw voicecall dtmf     --call-id <id> --digits <digits>
daisyclaw voicecall end      --call-id <id>
daisyclaw voicecall status   [--call-id <id>] [--json]
daisyclaw voicecall tail     [--file <path>] [--since <n>] [--poll <ms>]
daisyclaw voicecall latency  [--file <path>] [--last <n>]
daisyclaw voicecall expose   [--mode <m>] [--path <p>] [--port <port>] [--serve-path <p>]
```
...
| `--message <text>` | `DaisyClaw voice call smoke test.` | Message to speak during the smoke call. |
...
daisyclaw voicecall smoke --to "+15555550123"        # dry run
daisyclaw voicecall smoke --to "+15555550123" --yes  # live notify call
```
...
```bash
daisyclaw voicecall call --to "+15555550123" --message "Hello"
daisyclaw voicecall call -m "Heads up" --mode notify
```
...
```bash
daisyclaw voicecall status
daisyclaw voicecall status --json
...
```bash
daisyclaw voicecall expose --mode serve
daisyclaw voicecall expose --mode funnel
daisyclaw voicecall expose --mode off
```
