...
Linux desktop, VNC rescue, Slack Web, a real DaisyClaw gateway, screenshots,
...
- Mantis artifacts: owned by the DaisyClaw run. They live under
...
- remote logs such as `slack-desktop-command.log`, `daisyclaw-gateway.log`,
...
- `crabbox.remote_run`: sync, browser launch, DaisyClaw install/build or
...
remote status after Mantis has copied metadata proving that either the DaisyClaw
