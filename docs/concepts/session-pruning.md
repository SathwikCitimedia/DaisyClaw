...
DaisyClaw also builds a separate idempotent replay view for sessions that
...
DaisyClaw auto-enables pruning for Anthropic profiles:
...
If you set explicit values, DaisyClaw does not override them.
