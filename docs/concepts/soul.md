---
summary: "Use SOUL.md to give your DaisyClaw agent an actual voice instead of generic assistant sludge"
read_when:
...
DaisyClaw injects it on normal sessions, so it has real weight. If your agent
...
For DaisyClaw, `SOUL.md` is that layer.
...
Path fixed for DaisyClaw workspaces: use `SOUL.md`, not `http://SOUL.md`.
...
<CardGroup cols={2}>
  <Card title="Agent workspace" href="/concepts/agent-workspace" icon="folder-open">
    Workspace files DaisyClaw injects into model context.
  </Card>
  <Card title="System prompt" href="/concepts/system-prompt" icon="message-lines">
    How `SOUL.md` is composed into DaisyClaw and Codex runtime context.
  </Card>
