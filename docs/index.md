---
summary: "DaisyClaw is a multi-channel gateway for AI agents that runs on any OS."
read_when:
  - Introducing DaisyClaw to newcomers
title: "DaisyClaw"
---
...
<p align="center">
    <img
        src="/assets/daisyclaw-logo-text-dark.png"
        alt="DaisyClaw"
        width="500"
        class="dark:hidden"
    />
    <img
        src="/assets/daisyclaw-logo-text.png"
        alt="DaisyClaw"
        width="500"
...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install DaisyClaw and bring up the Gateway in minutes.
  </Card>
  <Card title="Run Onboarding" href="/start/wizard" icon="sparkles">
    Guided setup with `daisyclaw onboard` and pairing flows.
  </Card>
...
DaisyClaw is a **self-hosted gateway** that connects your favorite chat apps and channel surfaces — built-in channels plus bundled or external channel plugins such as Discord, Google Chat, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo, and more — to AI coding agents. You run a single Gateway process on your own machine (or a server), and it becomes the bridge between your messaging apps and an always-available AI assistant.
...
<p align="center">
  <img src="/whatsapp-daisyclaw.jpg" alt="DaisyClaw" width="420" />
</p>

## Configuration (optional)

Config lives at `~/.daisyclaw/daisyclaw.json`.

- If you **do nothing**, DaisyClaw uses the bundled DaisyClaw agent runtime with per-sender sessions.
...
```json5
{
  ...
  messages: { groupChat: { mentionPatterns: ["@daisyclaw"] } },
}
```
