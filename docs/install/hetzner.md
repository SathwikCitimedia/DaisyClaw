---
summary: "Run DaisyClaw Gateway 24/7 on a cheap Hetzner VPS (Docker) with durable state and baked-in binaries"
read_when:
  - You want DaisyClaw running 24/7 on a cloud VPS (not your laptop)
  - You want a production-grade, always-on Gateway on your own VPS
  - You want full control over persistence, binaries, and restart behavior
  - You are running DaisyClaw in Docker on Hetzner or a similar provider
title: "Hetzner"
---

## Goal

Run a persistent DaisyClaw Gateway on a Hetzner VPS using Docker, with durable state, baked-in binaries, and safe restart behavior.

If you want "DaisyClaw 24/7 for ~$5", this is the simplest reliable setup.
...
<Steps>
  ...
  <Step title="Create persistent host directories">
    ...
    ```bash
    mkdir -p /root/.daisyclaw/workspace

    # Set ownership to the container user (uid 1000):
    chown -R 1000:1000 /root/.daisyclaw
    ```
  ...
  <Step title="Configure environment variables">
    ...
    DAISYCLAW_CONFIG_DIR=/root/.daisyclaw
    DAISYCLAW_WORKSPACE_DIR=/root/.daisyclaw/workspace
...
- Infrastructure: [daisyclaw-terraform-hetzner](https://github.com/andreesg/daisyclaw-terraform-hetzner)
- Docker config: [daisyclaw-docker-config](https://github.com/andreesg/daisyclaw-docker-config)
