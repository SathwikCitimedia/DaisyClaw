...
DaisyClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.daisyclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["daisyclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
