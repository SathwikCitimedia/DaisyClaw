---
summary: "Contributor guide for adding a new shared capability to the DaisyClaw plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for DaisyClaw core developers. If you are
...
Use this when DaisyClaw needs a new shared domain such as embeddings, image
