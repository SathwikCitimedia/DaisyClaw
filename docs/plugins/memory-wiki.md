...
If the active memory plugin exposes shared recall artifacts, DaisyClaw can search
...
currently exposing public bridge inputs yet. Run `daisyclaw wiki doctor` first,
...
`daisyclaw wiki status`, `daisyclaw wiki doctor`, and `daisyclaw wiki bridge
...
daisyclaw wiki apply synthesis "Alpha Summary" --body "..." --source-id source.alpha
