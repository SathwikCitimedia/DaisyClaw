---
summary: "Adds Google, Google Gemini CLI, Google Vertex model provider support to DaisyClaw."
read_when:
...
Adds Google, Google Gemini CLI, Google Vertex model provider support to DaisyClaw.

## Distribution

- Package: `@daisyclaw/google-plugin`
