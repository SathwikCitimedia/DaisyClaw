...
`daisyclaw/plugin-sdk/channel-message` and
`daisyclaw/plugin-sdk/channel-message-runtime` remain deprecated compatibility
subpaths for older plugins. New channel plugins should use
`daisyclaw/plugin-sdk/channel-outbound` for message lifecycle, receipt, durable
