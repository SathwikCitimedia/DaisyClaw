---
summary: "Testing utilities and patterns for DaisyClaw plugins"
...
Reference for test utilities, patterns, and lint enforcement for DaisyClaw
plugins.
...
These test-helper subpaths are repo-local source entrypoints for DaisyClaw's own
...
**Plugin API mock import:** `daisyclaw/plugin-sdk/plugin-test-api`

**Agent runtime contract import:** `daisyclaw/plugin-sdk/agent-runtime-test-contracts`

**Channel contract import:** `daisyclaw/plugin-sdk/channel-contract-testing`

**Channel test helper import:** `daisyclaw/plugin-sdk/channel-test-helpers`

**Channel target test import:** `daisyclaw/plugin-sdk/channel-target-testing`

**Plugin contract import:** `daisyclaw/plugin-sdk/plugin-test-contracts`

**Plugin runtime test import:** `daisyclaw/plugin-sdk/plugin-test-runtime`

**Provider contract import:** `daisyclaw/plugin-sdk/provider-test-contracts`

**Provider HTTP mock import:** `daisyclaw/plugin-sdk/provider-http-test-mocks`

**Environment/network test import:** `daisyclaw/plugin-sdk/test-env`

**Generic fixture import:** `daisyclaw/plugin-sdk/test-fixtures`

**Node builtin mock import:** `daisyclaw/plugin-sdk/test-node-mocks`

Inside the DaisyClaw repo, prefer the focused subpaths below for new bundled
plugin tests. The broad
`daisyclaw/plugin-sdk/testing` barrel is legacy compatibility only.
...
} from "daisyclaw/plugin-sdk/channel-feedback";
import { installCommonResolveTargetErrorCases } from "daisyclaw/plugin-sdk/channel-target-testing";
import { AUTH_PROFILE_RUNTIME_CONTRACT } from "daisyclaw/plugin-sdk/agent-runtime-test-contracts";
import { createTestPluginApi } from "daisyclaw/plugin-sdk/plugin-test-api";
import { expectChannelInboundContextContract } from "daisyclaw/plugin-sdk/channel-contract-testing";
import { createStartAccountContext } from "daisyclaw/plugin-sdk/channel-test-helpers";
import { describePluginRegistrationContract } from "daisyclaw/plugin-sdk/plugin-test-contracts";
import { registerSingleProviderPlugin } from "daisyclaw/plugin-sdk/plugin-test-runtime";
import { describeOpenAIProviderRuntimeContract } from "daisyclaw/plugin-sdk/provider-test-contracts";
import { getProviderHttpMocks } from "daisyclaw/plugin-sdk/provider-http-test-mocks";
import { withEnv, withFetchPreconnect, withServer } from "daisyclaw/plugin-sdk/test-env";
import {
  bundledPluginRoot,
  createCliRuntimeCapture,
  typedCases,
} from "daisyclaw/plugin-sdk/test-fixtures";
import { mockNodeBuiltinModule } from "daisyclaw/plugin-sdk/test-node-mocks";
```
...
suites that depend on bundled DaisyClaw inventory stay under `src/plugins/contracts`.
...
import type { MockFn, PluginRuntime, RuntimeEnv } from "daisyclaw/plugin-sdk/plugin-test-runtime";
```
...
DaisyClaw's loader acceptance gates. Add at least one loader-backed smoke test
...
Prefer the shared plugin runtime mock from `daisyclaw/plugin-sdk/channel-test-helpers`
...
1. **No monolithic root imports** -- `daisyclaw/plugin-sdk` root barrel is rejected
...
DaisyClaw uses Vitest with V8 coverage thresholds. For plugin tests:
