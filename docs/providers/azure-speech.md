---
summary: "Azure AI Speech text-to-speech for DaisyClaw replies"
read_when:
...
Azure Speech is an Azure AI Speech text-to-speech provider. In DaisyClaw it
...
DaisyClaw uses the Azure Speech REST API directly with SSML and sends the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. DaisyClaw synthesizes the audio
...
<AccordionGroup>
  <Accordion title="Authentication">
    ...
    is sent as `Ocp-Apim-Subscription-Key`; DaisyClaw derives
  ...
  <Accordion title="Audio outputs">
    ...
    `ogg-24khz-16bit-mono-opus`, and `riff-24khz-16bit-mono-pcm`. DaisyClaw
...
<CardGroup cols={2}>
  ...
  <Card title="Providers" href="/providers" icon="grid">
    All bundled DaisyClaw providers.
  </Card>
