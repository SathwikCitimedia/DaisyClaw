...
<Steps>
  ...
  <Step title="Configure DaisyClaw">
    Point DaisyClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or DaisyClaw
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native DaisyClaw integration with Claude CLI or API keys.
  </Card>
