---
summary: "Inworld streaming text-to-speech for DaisyClaw replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In DaisyClaw it
...
DaisyClaw posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. DaisyClaw synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    DaisyClaw asks Inworld for `OGG_OPUS` so the audio plays as a native
