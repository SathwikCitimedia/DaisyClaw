---
summary: "Use Qianfan's unified API to access many models in DaisyClaw"
read_when:
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    daisyclaw onboard --auth-choice qianfan-api-key
    ```
  </Step>
  <Step title="Verify the model is available">
    ```bash
    daisyclaw models list --provider qianfan
    ```
  </Step>
</Steps>
