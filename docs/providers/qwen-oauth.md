---
summary: "Use the Qwen Portal provider id with DaisyClaw"
read_when:
...
DaisyClaw has two Qwen-facing provider ids:
...
daisyclaw models set qwen/qwen3-coder-plus
```
