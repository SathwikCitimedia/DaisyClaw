...
title: "Together AI"
read_when:
  - You want to use Together AI with DaisyClaw
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    daisyclaw onboard --auth-choice together-api-key
    ```
  </Step>
...
DaisyClaw ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.daisyclaw/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `daisyclaw models list --provider together`
