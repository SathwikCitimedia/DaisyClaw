...
read_when:
  - Planning a broad DaisyClaw application modernization pass
...
modernization task. If adopting this guidance as a repo-local DaisyClaw skill,
create `.agents/skills/daisyclaw-frontend/SKILL.md` first, keep the frontmatter
