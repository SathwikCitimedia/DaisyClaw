---
summary: "Overview of DaisyClaw onboarding options and flows"
read_when:
...
DaisyClaw has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `daisyclaw onboard`                     | Launch the app            |
...
CLI command docs: [`daisyclaw onboard`](/cli/onboard)

## macOS app onboarding

Open the DaisyClaw app. The first-run wizard walks you through the same steps
