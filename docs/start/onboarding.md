---
summary: "First-run setup flow for DaisyClaw (macOS app)"
read_when:
...
- By default, DaisyClaw is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give DaisyClaw">
...
<Step title="CLI">
  ...
  The app can install the global `daisyclaw` CLI via npm, pnpm, or bun.
