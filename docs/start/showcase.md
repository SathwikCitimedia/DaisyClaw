...
OpenCode finishes the change, opens a PR, DaisyClaw reviews the diff and replies in Telegram with suggestions plus a clear merge verdict.

  <img src="/assets/showcase/pr-review-telegram.jpg" alt="DaisyClaw PR review feedback delivered in Telegram" />
</Card>

<Card title="Wine Cellar Skill in Minutes" icon="wine-glass" href="https://x.com/i/status/2010916352454791216">
  **@prades_maxime** • `skills` `local` `csv`

Asked "Robby" (@daisyclaw) for a local wine cellar skill. It requests a sample CSV export and a store path, then builds and tests the skill (962 bottles in the example).

  <img src="/assets/showcase/wine-cellar-skill.jpg" alt="DaisyClaw building a local wine cellar skill from CSV" />
</Card>
...
Desktop app to manage skills and commands across Agents, Claude, Codex, and DaisyClaw.
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Useful for remote DaisyClaw instances.
...
CLI for Linear that integrates with agentic workflows (Claude Code, DaisyClaw). Manage issues, projects, and workflows from the terminal.
</Card>
...
Claude Code discovered and confirmed the purifier controls, then DaisyClaw takes over to manage room air quality.

  <img src="/assets/showcase/winix-air-purifier.jpg" alt="Winix air purifier control via DaisyClaw" />
</Card>

<Card title="Pretty sky camera shots" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
  **@signalgaining** • `automation` `camera` `skill`

Triggered by a roof camera: ask DaisyClaw to snap a sky photo whenever it looks pretty. It designed a skill and took the shot.

  <img src="/assets/showcase/roof-camera-sky.jpg" alt="Roof camera sky snapshot captured by DaisyClaw" />
</Card>

<Card title="Visual morning briefing scene" icon="robot" href="https://x.com/buddyhadry/status/2010005331925954739">
  **@buddyhadry** • `automation` `briefing` `telegram`

A scheduled prompt generates one scene image each morning (weather, tasks, date, favorite post or quote) via an DaisyClaw persona.
</Card>
...
DaisyClaw connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>

<Card title="Todoist skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `todoist` `skill` `telegram`

Automated Todoist tasks and had DaisyClaw generate the skill directly in Telegram chat.
</Card>
...
Chinese learning engine with pronunciation feedback and study flows via DaisyClaw.
...
Vapi voice assistant to DaisyClaw HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
Packaging, deployment, and integrations that make DaisyClaw easier to run and extend.

<CardGroup cols={2}>

<Card title="Home Assistant add-on" icon="home" href="https://github.com/ngutman/daisyclaw-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`

DaisyClaw gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>
...
<Card title="Nix packaging" icon="snowflake" href="https://github.com/daisyclaw/nix-daisyclaw">
  **@daisyclaw** • `nix` `packaging` `deployment`

Batteries-included nixified DaisyClaw configuration for reproducible deployments.
</Card>
...
The physical-world side of DaisyClaw: homes, sensors, cameras, vacuums, and other devices.
...
Nix-native home automation with DaisyClaw as the interface, plus Grafana dashboards.
...
Full astronomy gear marketplace. Built with and around the DaisyClaw ecosystem.
</Card>
...
<Steps>
  <Step title="Share it">
    Post in [#self-promotion on Discord](https://discord.gg/clawd) or [tweet @daisyclaw](https://x.com/daisyclaw).
  </Step>
