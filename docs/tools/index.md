...
summary: "DaisyClaw tools, skills, and plugins overview: what agents can call and how to extend them"
read_when:
  - You want to understand what tools DaisyClaw provides
...
| Search a large DaisyClaw tool catalog        | [Tool Search](/tools/tool-search)              | [Tool Search](/tools/tool-search)                                                                               |
...
<Steps>
  ...
  <Step title="Use a skill when the agent needs instructions">
    ...
    Skills can live in a workspace, shared skill directory, managed DaisyClaw
  ...
  <Step title="Use a plugin when DaisyClaw needs a new capability">
...
| Large DaisyClaw catalogs | Search and call many eligible tools without sending every schema to the model | `tool_search_code`, `tool_search`, `tool_describe`                   | [Tool Search](/tools/tool-search)                                                           |

<Note>
Tool Search is an experimental DaisyClaw agent surface. Codex harness runs use
...
Choose the extension path by the job you need DaisyClaw to do:
...
5. For delegated runs, check per-agent restrictions in
   [Per-agent sandbox and tool restrictions](/tools/multi-agent-sandbox-tools).
6. For large DaisyClaw catalogs, confirm whether the run uses direct tool exposure or
...
- [Tool Search](/tools/tool-search) for compact DaisyClaw tool catalog discovery
