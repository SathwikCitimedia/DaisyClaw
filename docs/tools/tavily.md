...
[Tavily](https://tavily.com) is a search API designed for AI applications. DaisyClaw exposes it in two ways:
...
<Tip>
Choosing Tavily in onboarding or `daisyclaw configure --section web` enables the bundled Tavily plugin automatically.
</Tip>
