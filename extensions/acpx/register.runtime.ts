...
import type { DaisyClawPluginService, DaisyClawPluginServiceContext } from "daisyclaw/plugin-sdk/core";
...
type DeferredServiceState = {
  ctx: DaisyClawPluginServiceContext | null;
  params: CreateAcpxRuntimeServiceParams;
  realRuntime: AcpRuntime | null;
  realService: DaisyClawPluginService | null;
...
async function startRealService(state: DeferredServiceState): Promise<AcpRuntime> {
  ...
  state.startPromise ??= (async () => {
    ...
    await service.start(state.ctx as DaisyClawPluginServiceContext);
