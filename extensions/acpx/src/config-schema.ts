...
/** Zod schema for validating raw ACPX plugin config from DaisyClaw config. */
export const AcpxPluginConfigSchema = z.strictObject({
  ...
  daisyClawToolsMcpBridge: z
    .boolean({ error: "daisyClawToolsMcpBridge must be a boolean" })
    .optional(),
