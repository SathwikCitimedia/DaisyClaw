/**
 * Persistent lease store for ACPX wrapper processes. Leases let DaisyClaw attach
...
export const DAISYCLAW_ACPX_LEASE_ID_ENV = "DAISYCLAW_ACPX_LEASE_ID";
/** Environment variable carrying the owning gateway instance id. */
export const DAISYCLAW_GATEWAY_INSTANCE_ID_ENV = "DAISYCLAW_GATEWAY_INSTANCE_ID";
/** CLI argument carrying the ACPX process lease id for platforms without env wrapping. */
export const DAISYCLAW_ACPX_LEASE_ID_ARG = "--daisyclaw-acpx-lease-id";
/** CLI argument carrying the owning gateway instance id. */
export const DAISYCLAW_GATEWAY_INSTANCE_ID_ARG = "--daisyclaw-gateway-instance-id";
...
export function withAcpxLeaseEnvironment(params: {
  ...
  return [
    "env",
    `${DAISYCLAW_ACPX_LEASE_ID_ENV}=${quoteEnvValue(params.leaseId)}`,
    `${DAISYCLAW_GATEWAY_INSTANCE_ID_ENV}=${quoteEnvValue(params.gatewayInstanceId)}`,
