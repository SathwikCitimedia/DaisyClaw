 ...
 */
import { resolveAwsSdkEnvVarName } from "daisyclaw/plugin-sdk/provider-auth-runtime";
import type { ModelProviderConfig } from "daisyclaw/plugin-sdk/provider-model-shared";

/** Resolve the config auth marker that tells DaisyClaw to use AWS SDK credentials. */
