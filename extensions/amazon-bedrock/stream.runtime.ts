/**
 * Amazon Bedrock Converse streaming runtime. It maps DaisyClaw messages/tools,
...
/** Stream a Bedrock Converse request from the generic DaisyClaw stream options. */
 ...
 * Defaults to "short" and uses DAISYCLAW_CACHE_RETENTION for backward compatibility.
 */
