...
type AgentDefaultsModel = NonNullable<NonNullable<DaisyClawConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<DaisyClawConfig["agents"]>["defaults"]>["models"];
