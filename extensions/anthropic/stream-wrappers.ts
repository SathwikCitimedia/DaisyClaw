...
import { streamSimple } from "daisyclaw/plugin-sdk/llm";
...
} from "daisyclaw/plugin-sdk/provider-stream-shared";
...
const DAISYCLAW_DEFAULT_ANTHROPIC_BETAS = [
  "fine-grained-tool-streaming-2025-05-14",
  "interleaved-thinking-2025-05-14",
] as const;
const DAISYCLAW_OAUTH_ANTHROPIC_BETAS = [
  "claude-code-20250219",
  "oauth-2025-04-20",
  ...DAISYCLAW_DEFAULT_ANTHROPIC_BETAS,
] as const;
...
/** Wrap a stream function to merge DaisyClaw and configured Anthropic beta headers. */
export function createAnthropicBetaHeadersWrapper(
  ...
  return (model, context, options) => {
    ...
    const daisyClawBetas = isOauth
      ? (DAISYCLAW_OAUTH_ANTHROPIC_BETAS as readonly string[])
      : (DAISYCLAW_DEFAULT_ANTHROPIC_BETAS as readonly string[]);
    const allBetas = [...new Set([...daisyClawBetas, ...effectiveBetas])];
