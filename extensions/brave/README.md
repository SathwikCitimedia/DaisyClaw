...
Official Brave Search provider plugin for DaisyClaw.
...
```bash
daisyclaw plugins install @daisyclaw/brave-plugin
```
...
```bash
daisyclaw config set plugins.entries.brave.enabled true
daisyclaw config set tools.web.search.provider brave
```
...
- Plugin id: `brave`
- Package: `@daisyclaw/brave-plugin`
- Minimum DaisyClaw host: `2026.4.10`
