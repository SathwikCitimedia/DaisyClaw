...
// DaisyClaw operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that DaisyClaw itself navigated to a blocked URL.
...
/** Quarantine and close a tab that DaisyClaw navigated to a blocked URL. */
...
export async function createPageViaPlaywright(
  ...
  if (targetUrl !== "about:blank") {
    ...
    // DaisyClaw owns this newly-created tab: if the post-navigation safety
