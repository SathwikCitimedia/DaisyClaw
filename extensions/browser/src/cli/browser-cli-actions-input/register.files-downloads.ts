...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "<paths...>",
      "File paths to upload from DaisyClaw temp uploads or managed inbound media (e.g. /tmp/daisyclaw/uploads/file.pdf or media://inbound/<id>)",
    )
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within daisyclaw temp downloads dir (default: /tmp/daisyclaw/downloads/...; fallback: os.tmpdir()/daisyclaw/downloads/...)",
    )
    .option("--target-id <id>", BROWSER_TAB_REFERENCE_HELP)
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within daisyclaw temp downloads dir (e.g. report.pdf or /tmp/daisyclaw/downloads/report.pdf)",
    )
    .option("--target-id <id>", BROWSER_TAB_REFERENCE_HELP)
    .option(
      "--timeout-ms <ms>",
