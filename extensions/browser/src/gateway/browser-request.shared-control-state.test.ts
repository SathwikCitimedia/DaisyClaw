...
const mocks = vi.hoisted(() => ({
  runtimeConfig: {} as DaisyClawConfig,
  runtimeSourceConfig: null as DaisyClawConfig | null,
...
vi.mock("../browser/chrome.js", () => ({
  ...
  launchDaisyClawChrome: vi.fn(async () => {
    throw new Error("launch should not be needed for status");
  }),
  resolveDaisyClawUserDataDir: vi.fn(() => "/tmp/daisyclaw-browser"),
