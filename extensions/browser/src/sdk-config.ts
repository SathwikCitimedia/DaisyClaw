...
export { mutateConfigFile, replaceConfigFile } from "daisyclaw/plugin-sdk/config-mutation";
export {
  type BrowserConfig,
...
export { resolveGatewayPort } from "daisyclaw/plugin-sdk/core";
export {
  CONFIG_DIR,
  escapeRegExp,
  resolveUserPath,
  shortenHomePath,
} from "daisyclaw/plugin-sdk/text-utility-runtime";
