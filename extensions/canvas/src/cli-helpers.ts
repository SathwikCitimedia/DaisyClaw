...
import { resolvePreferredDaisyClawTmpDir } from "daisyclaw/plugin-sdk/security-runtime";
import { asRecord, readStringValue } from "daisyclaw/plugin-sdk/string-coerce-runtime";
...
function resolveTempPathParts(opts: { ext: string; tmpDir?: string; id?: string }) {
  const tmpDir = opts.tmpDir ?? resolvePreferredDaisyClawTmpDir();
  if (!opts.tmpDir) {
