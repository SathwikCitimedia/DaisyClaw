...
import { runCommandWithRuntime, theme } from "daisyclaw/plugin-sdk/cli-runtime";
...
import { defaultRuntime } from "daisyclaw/plugin-sdk/runtime";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalString,
} from "daisyclaw/plugin-sdk/string-coerce-runtime";
import { shortenHomePath } from "daisyclaw/plugin-sdk/text-utility-runtime";
...
/** Creates the default Canvas CLI dependency bundle backed by the DaisyClaw gateway CLI. */
    ...
    a2ui
      ...
      .action(async (opts: CanvasNodesRpcOpts) => {
        await deps.runNodesCommand("canvas a2ui push", async () => {
          ...
          if (version === "v0.9") {
            throw new Error(
              "Detected A2UI v0.9 JSONL (createSurface). DaisyClaw currently supports v0.8 only.",
            );
          }
