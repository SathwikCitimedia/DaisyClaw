...
import { asOptionalRecord as readRecord } from "daisyclaw/plugin-sdk/string-coerce-runtime";
...
export function migrateLegacyCanvasHostConfig(config: DaisyClawConfig): {
  ...
  const next = { ...config, plugins } as DaisyClawConfig & { canvasHost?: unknown };
