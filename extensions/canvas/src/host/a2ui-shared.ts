 ...
 */
import { lowercasePreservingWhitespace } from "daisyclaw/plugin-sdk/string-coerce-runtime";

/** Hosted path prefix for bundled A2UI assets. */
export const A2UI_PATH = "/__daisyclaw__/a2ui";

/** Hosted path prefix for Canvas document/static assets. */
export const CANVAS_HOST_PATH = "/__daisyclaw__/canvas";

/** Hosted WebSocket path for Canvas live reload. */
export const CANVAS_WS_PATH = "/__daisyclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.daisyclawCanvasA2UIAction.postMessage(...)
  // - Android: window.daisyclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["daisyclawCanvasA2UIAction"];
  ...
  globalThis.DaisyClaw = globalThis.DaisyClaw ?? {};
  globalThis.DaisyClaw.postMessage = postToNode;
  globalThis.DaisyClaw.sendUserAction = sendUserAction;
  globalThis.daisyclawPostMessage = postToNode;
  globalThis.daisyclawSendUserAction = sendUserAction;
