/**
 * Converts authorized ClickClack messages into DaisyClaw agent/model replies and
...
export async function handleClickClackInbound(params: {
  ...
  const body = runtime.channel.reply.formatAgentEnvelope({
    ...
    previousTimestamp,
    envelope: runtime.channel.reply.resolveEnvelopeFormatOptions(params.config as DaisyClawConfig),
    body: message.body,
  });
