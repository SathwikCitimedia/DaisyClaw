 ...
 * DaisyClaw agents.
 */
import { buildJsonPluginConfigSchema, definePluginEntry } from "daisyclaw/plugin-sdk/plugin-entry";
import {
...
export default definePluginEntry({
  ...
  description: "Supervise Codex app-server sessions from DaisyClaw.",
