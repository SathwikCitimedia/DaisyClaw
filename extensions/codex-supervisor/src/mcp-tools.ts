...
export const RAW_TRANSCRIPTS_ENV = "DAISYCLAW_CODEX_SUPERVISOR_ALLOW_RAW_TRANSCRIPTS";
/** Env gate for mutating/steering Codex sessions through standalone MCP. */
export const WRITE_CONTROLS_ENV = "DAISYCLAW_CODEX_SUPERVISOR_ALLOW_WRITE_CONTROLS";
...
export function registerCodexSupervisorMcpTools(
  ...
  server.tool(
    "codex_sessions_list",
    "List Codex sessions visible to the DaisyClaw supervisor.",
    {
