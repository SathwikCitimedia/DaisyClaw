/**
 * DaisyClaw agent-tool definitions for Codex Supervisor endpoint and session
 * controls.
 */
import { jsonResult, readStringParam, type AnyAgentTool } from "daisyclaw/plugin-sdk/core";
...
/** Dependencies needed to build DaisyClaw agent tools. */
...
/**
 * Creates the DaisyClaw tools that expose Codex endpoint health and session
 * controls.
 */
export function createCodexSupervisorTools({
  ...
  return [
    ...
    },
    {
      ...
      description: "List Codex sessions visible to the DaisyClaw supervisor.",
