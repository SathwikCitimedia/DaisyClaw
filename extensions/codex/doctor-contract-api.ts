...
import type { DoctorSessionRouteStateOwner } from "daisyclaw/plugin-sdk/runtime-doctor";
...
export const legacyConfigRules: LegacyConfigRule[] = [
  {
    ...
    message:
      'plugins.entries.codex.config.codexDynamicToolsProfile is retired; Codex app-server always keeps Codex-native workspace tools native. Run "daisyclaw doctor --fix".',
...
export function normalizeCompatibilityConfig({ cfg }: { cfg: DaisyClawConfig }): {
  ...
  const nextConfig = structuredClone(cfg) as DaisyClawConfig & {
