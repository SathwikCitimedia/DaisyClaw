...
import {
  ...
  resolveCodexExternalSandboxPolicyForDaisyClawSandbox,
          ...
          try {
            ...
            try {
              ...
              if (
                ...
                throw new Error(
                  "Codex app-server did not register an DaisyClaw sandbox exec-server environment.",
                );
              }
            } catch (error) {
              await releaseStartupSandboxEnvironment();
            ...
            const startupSandboxPolicy = startupSandboxEnvironment
              ? resolveCodexExternalSandboxPolicyForDaisyClawSandbox(params.sandbox)
              : undefined;
