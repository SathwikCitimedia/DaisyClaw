/**
 * Native Codex app-server compaction bridge for bound DaisyClaw sessions.
 */
import {
  embeddedAgentLog,
...
export async function maybeCompactCodexAppServerSession(
  ...
  warnIfIgnoringDaisyClawCompactionOverrides(params);
...
function warnIfIgnoringDaisyClawCompactionOverrides(
  params: CompactEmbeddedAgentSessionParams,
): void {
