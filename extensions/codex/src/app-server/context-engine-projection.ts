/**
 * Projects DaisyClaw context-engine assemblies into Codex prompt text while
...
import { redactSensitiveFieldValue, redactToolPayloadText } from "daisyclaw/plugin-sdk/logging-core";
...
const CONTEXT_HEADER = "DaisyClaw assembled context for this turn:";
...
/** Projects assembled DaisyClaw context-engine messages into Codex prompt inputs. */
