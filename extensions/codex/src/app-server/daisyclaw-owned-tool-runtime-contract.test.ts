// Codex tests cover daisyclaw owned tool runtime contract plugin behavior.
import type { AnyAgentTool } from "daisyclaw/plugin-sdk/agent-harness";
import { wrapToolWithBeforeToolCallHook } from "daisyclaw/plugin-sdk/agent-harness-runtime";
import {
...
describe("DaisyClaw-owned tool runtime contract — Codex app-server adapter", () => {
  afterEach(() => {
    resetDaisyClawOwnedToolHooks();
  });
