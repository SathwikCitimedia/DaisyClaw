...
import { generatedImageAssetFromBase64 } from "daisyclaw/plugin-sdk/image-generation";
import type { AssistantMessage, Usage } from "daisyclaw/plugin-sdk/llm";
import { saveMediaBuffer } from "daisyclaw/plugin-sdk/media-store";
import { asDateTimestampMs } from "daisyclaw/plugin-sdk/number-runtime";
...
const MISSING_TOOL_RESULT_ERROR =
  "DaisyClaw recorded a native Codex tool.call without a matching tool.result before the turn completed.";
const GENERATED_IMAGE_MEDIA_SUBDIR = "tool-image-generation";
const BYTES_PER_MB = 1024 * 1024;
// Match DaisyClaw's default image media cap for generated image tool outputs.
...
export class CodexAppServerEventProjector {
  ...
  buildResult(
    ...
    // context for DaisyClaw history, search, and future harness switching.
    if (reasoningText) {
...
function shouldSuppressChannelProgressForItem(item: CodexThreadItem): boolean {
  ...
  // Dynamic DaisyClaw tool requests are emitted at the item/tool/call request
