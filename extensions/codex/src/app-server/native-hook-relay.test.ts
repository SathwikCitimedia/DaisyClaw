...
import type { NativeHookRelayRegistrationHandle } from "daisyclaw/plugin-sdk/agent-harness-runtime";
          ...
          hooks: [
            {
              type: "command",
              command:
                "daisyclaw hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event pre_tool_use --timeout 6000",
              timeout: 7,
              async: false,
              statusMessage: "DaisyClaw native hook relay",
            },
          ],
        },
      ],
          ...
          hooks: [
            {
              type: "command",
              command:
                "daisyclaw hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event post_tool_use --timeout 6000",
              timeout: 7,
              async: false,
              statusMessage: "DaisyClaw native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "daisyclaw hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event permission_request --timeout 6000",
              timeout: 7,
              async: false,
              statusMessage: "DaisyClaw native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "daisyclaw hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event before_agent_finalize --timeout 6000",
              timeout: 7,
              async: false,
              statusMessage: "DaisyClaw native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "daisyclaw hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event permission_request --timeout 4000",
              timeout: 5,
              async: false,
              statusMessage: "DaisyClaw native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "daisyclaw hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event pre_tool_use --timeout 4000",
              timeout: 5,
              async: false,
              statusMessage: "DaisyClaw native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "daisyclaw hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event pre_tool_use --pre-tool-use-unavailable noop --timeout 4000",
              timeout: 5,
              async: false,
              statusMessage: "DaisyClaw native hook relay",
            },
...
function createRelay(options?: {
  ...
  return {
    ...
    commandForEvent: (event, commandOptions) =>
      `daisyclaw hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event ${event}${
