 ...
 * into DaisyClaw task runtime records for parent sessions.
 */
import { createHash } from "node:crypto";
import fs from "node:fs/promises";
import path from "node:path";
import { embeddedAgentLog, formatErrorMessage } from "daisyclaw/plugin-sdk/agent-harness-runtime";
import {
...
} from "daisyclaw/plugin-sdk/agent-harness-task-runtime";
import { asFiniteNumber, normalizeOptionalString } from "daisyclaw/plugin-sdk/string-coerce-runtime";
