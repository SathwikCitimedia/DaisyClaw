/**
 * Mirrors Codex native subagent thread lifecycle events into DaisyClaw task
 * runtime rows so parent sessions can observe child progress.
 */
import type { AgentHarnessTaskRuntime } from "daisyclaw/plugin-sdk/agent-harness-task-runtime";
...
/** Converts a Codex child thread id into the DaisyClaw task-runtime run id. */
