/**
 * Resolves Codex filesystem sandbox policy payloads into DaisyClaw path/glob
...
function readFsSandboxCwd(execServer: DaisyClawExecServer, sandbox: JsonObject): string {
