...
import type { ManagedProcess, DaisyClawExecServer, ProcessChunk } from "./types.js";
...
async function runProcess(
  ...
  if (!backend) {
    throw new Error("DaisyClaw sandbox backend is unavailable.");
  }
  ...
  if (!command) {
    throw new Error("DaisyClaw sandbox exec spec did not provide a command.");
  }
