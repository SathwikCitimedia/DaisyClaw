...
import { type FileLockOptions, withFileLock } from "daisyclaw/plugin-sdk/file-lock";
import {
...
/** Durable sidecar binding connecting an DaisyClaw session file to a Codex thread. */
