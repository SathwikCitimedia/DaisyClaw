    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaPath: "file:///tmp/DaisyClaw%20QA/photo.png",
            mediaType: "image/png",
          },
        },
      }),
      ...
      { type: "text", text: "look", text_elements: [] },
      { type: "localImage", path: "/tmp/DaisyClaw QA/photo.png" },
    ]);
  });
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaUrls: ["/tmp/staged-photo.png", "file:///tmp/DaisyClaw%20QA/second.jpg"],
      ...
      { type: "localImage", path: "/tmp/DaisyClaw QA/second.jpg" },
    ]);
  });
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaUrl: "C:\\DaisyClaw QA\\photo.png",
            mediaType: "image/png",
          },
        },
      }),
      ...
      { type: "text", text: "look", text_elements: [] },
      { type: "localImage", path: "C:\\DaisyClaw QA\\photo.png" },
    ]);
  });
});
