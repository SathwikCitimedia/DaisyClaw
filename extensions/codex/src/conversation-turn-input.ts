...
import type { PluginHookInboundClaimEvent } from "daisyclaw/plugin-sdk/plugin-entry";
import { normalizeSingleOrTrimmedStringList } from "daisyclaw/plugin-sdk/string-coerce-runtime";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // DaisyClaw channels expose either local staged files or remote URLs. Keep
