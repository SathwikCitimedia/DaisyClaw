# GitHub Copilot agent runtime (DaisyClaw plugin)

External DaisyClaw plugin that registers a `copilot` agent harness backed by `@github/copilot-sdk` and the GitHub Copilot CLI.
