...
vi.mock("daisyclaw/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<typeof import("daisyclaw/plugin-sdk/media-understanding")>(
    "daisyclaw/plugin-sdk/media-understanding",
  );
  return {
    ...actual,
...
afterAll(() => {
  vi.doUnmock("daisyclaw/plugin-sdk/media-understanding");
  vi.resetModules();
});
