// Deepseek plugin entrypoint registers its DaisyClaw integration.
import { readConfiguredProviderCatalogEntries } from "daisyclaw/plugin-sdk/provider-catalog-shared";
...
import { fetchDeepSeekUsage } from "daisyclaw/plugin-sdk/provider-usage";
