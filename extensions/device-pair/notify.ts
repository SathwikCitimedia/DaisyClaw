...
import type { DaisyClawPluginService } from "daisyclaw/plugin-sdk/core";
import { listDevicePairing } from "daisyclaw/plugin-sdk/device-bootstrap";
...
import type { PluginStateKeyedStore } from "daisyclaw/plugin-sdk/plugin-state-runtime";
...
async function readNotifyState(api: DaisyClawPluginApi): Promise<NotifyStateFile> {
...
async function writeNotifyState(api: DaisyClawPluginApi, state: NotifyStateFile): Promise<void> {
  const subscriberStore = openNotifySubscriberStore(api);
...
async function notifyPendingPairingRequests(params: { api: DaisyClawPluginApi }): Promise<void> {
...
export function createPairingNotifierService(api: DaisyClawPluginApi): DaisyClawPluginService {
...
export function registerPairingNotifierService(api: DaisyClawPluginApi): void {
