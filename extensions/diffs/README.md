...
Read-only diff viewer plugin for **DaisyClaw** agents.

## Install

```bash
daisyclaw plugins install @daisyclaw/diffs
```
...
- Plugin id: `diffs`
- Package: `@daisyclaw/diffs`
- Minimum DaisyClaw host: `2026.4.30`
...
Before:
DaisyClaw supports plugins.

After:
DaisyClaw supports plugins and hosted diff views.
```
...
- Artifacts are ephemeral and stored in the plugin temp subfolder (`$TMPDIR/daisyclaw-diffs`).
