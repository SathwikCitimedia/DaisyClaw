...
import { optionalFiniteNumberSchema, stringEnum } from "daisyclaw/plugin-sdk/channel-actions";
...
import type { AnyAgentTool, DaisyClawPluginApi, DaisyClawPluginToolContext } from "../api.js";
...
export function createDiffsTool(params: {
  ...
  context?: DaisyClawPluginToolContext;
}): AnyAgentTool {
  return {
    name: "diffs",
    label: "Diffs",
...
function buildArtifactContext(
  context: DaisyClawPluginToolContext | undefined,
