...
// Deprecated compatibility surface for existing @daisyclaw/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "daisyclaw/plugin-sdk/runtime-group-policy";
