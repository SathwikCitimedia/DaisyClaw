...
import type { DiscordActionConfig } from "daisyclaw/plugin-sdk/config-contracts";
...
function handleMessagingAction(
  ...
  cfg: DaisyClawConfig = DISCORD_TEST_CFG,
  options?: {
    mediaAccess?: {
