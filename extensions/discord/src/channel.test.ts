...
function createCfg(): DaisyClawConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: DaisyClawConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: DaisyClawConfig, accountId = "default") {
