...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("daisyclaw.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("daisyclaw.discord.modalEntries");
