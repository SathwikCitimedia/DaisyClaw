...
import { collectProviderDangerousNameMatchingScopes } from "daisyclaw/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: DaisyClawConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: DaisyClawConfig,
  doctorFixCommand: string,
): { config: DaisyClawConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: DaisyClawConfig): string[] {
