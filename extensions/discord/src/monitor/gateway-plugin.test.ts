...
describe("createDiscordGatewayPlugin", () => {
  ...
  it("resolves gateway metadata timeout from config, env, then default", () => {
    ...
    expect(
      resolveDiscordGatewayInfoTimeoutMs({
        env: { DAISYCLAW_DISCORD_GATEWAY_INFO_TIMEOUT_MS: "25000" },
      }),
    ).toBe(25_000);
  ...
  it("leaves autoInteractions disabled so DaisyClaw owns interaction handoff", () => {
  ...
  it("keeps DaisyClaw metadata timeout out of gateway options", () => {
