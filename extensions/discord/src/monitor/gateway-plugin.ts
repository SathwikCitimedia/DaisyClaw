...
import type { DiscordAccountConfig } from "daisyclaw/plugin-sdk/config-contracts";
import { createNodeProxyAgent } from "daisyclaw/plugin-sdk/fetch-runtime";
import {
  captureWsEvent,
  resolveEffectiveDebugProxyUrl,
  resolveDebugProxySettings,
} from "daisyclaw/plugin-sdk/proxy-capture";
import { danger, warn } from "daisyclaw/plugin-sdk/runtime-env";
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("daisyclaw/plugin-sdk/config-contracts").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class DaisyClawGatewayPlugin extends discordGateway.GatewayPlugin {
  ...
  return new DaisyClawGatewayPlugin();
}
...
export function createDiscordGatewayPlugin(params: {
  ...
  return createGatewayPlugin({
    options: {
      ...
      intents,
      // DaisyClaw registers its own async interaction listener.
