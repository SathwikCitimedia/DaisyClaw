...
import { createSubsystemLogger, formatDurationSeconds } from "daisyclaw/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("daisyclaw/plugin-sdk/runtime-env").createSubsystemLogger
>;
