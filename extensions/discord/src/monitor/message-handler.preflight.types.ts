...
import type { InboundEventKind } from "daisyclaw/plugin-sdk/channel-inbound";
...
import type { SessionBindingRecord } from "daisyclaw/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "daisyclaw/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "daisyclaw/plugin-sdk/routing";
...
type LoadedConfig = DaisyClawConfig;
export type RuntimeEnv = import("daisyclaw/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("daisyclaw/plugin-sdk/config-contracts").DaisyClawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
