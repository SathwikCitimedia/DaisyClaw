...
let conversationRuntimePromise:
  | Promise<typeof import("daisyclaw/plugin-sdk/conversation-binding-runtime")>
  | undefined;

async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("daisyclaw/plugin-sdk/conversation-binding-runtime");
