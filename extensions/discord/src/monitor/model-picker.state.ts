...
import type { ModelsProviderData } from "daisyclaw/plugin-sdk/models-provider-runtime";
import { parseStrictInteger, parseStrictPositiveInteger } from "daisyclaw/plugin-sdk/number-runtime";
...
let modelsProviderRuntimePromise:
  | Promise<typeof import("daisyclaw/plugin-sdk/models-provider-runtime")>
  | undefined;

async function loadModelsProviderRuntime() {
  modelsProviderRuntimePromise ??= import("daisyclaw/plugin-sdk/models-provider-runtime");
