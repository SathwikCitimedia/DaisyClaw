...
import { peekSystemEvents, resetSystemEventsForTest } from "daisyclaw/plugin-sdk/test-fixtures";
...
describe("agent components", () => {
  ...
  const createCfg = (): DaisyClawConfig => ({}) as DaisyClawConfig;
  ...
  it("sends pairing reply when DM sender is not allowlisted", async () => {
    ...
    expect(pairingText).toContain(`daisyclaw pairing approve discord ${code}`);
