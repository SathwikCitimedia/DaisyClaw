...
import { resolveCommandAuthorizedFromAuthorizers } from "daisyclaw/plugin-sdk/command-auth-native";
...
export function resolveDiscordCommandOwnerAllowFrom(cfg: DaisyClawConfig): string[] | undefined {
