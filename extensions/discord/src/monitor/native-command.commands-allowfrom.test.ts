...
import * as pluginCommandsModule from "daisyclaw/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "daisyclaw/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: DaisyClawConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: DaisyClawConfig) => void;
