...
import { danger, warn, type RuntimeEnv } from "daisyclaw/plugin-sdk/runtime-env";
import {
...
export type GetPluginCommandSpecs =
  typeof import("daisyclaw/plugin-sdk/plugin-runtime").getPluginCommandSpecs;

let pluginRuntimePromise: Promise<typeof import("daisyclaw/plugin-sdk/plugin-runtime")> | undefined;

async function loadPluginRuntime() {
  const promise = pluginRuntimePromise ?? import("daisyclaw/plugin-sdk/plugin-runtime");
