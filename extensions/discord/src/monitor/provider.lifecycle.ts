...
import { asDateTimestampMs, parseStrictPositiveInteger } from "daisyclaw/plugin-sdk/number-runtime";
...
const DISCORD_GATEWAY_READY_TIMEOUT_ENV = "DAISYCLAW_DISCORD_READY_TIMEOUT_MS";
const DISCORD_GATEWAY_RUNTIME_READY_TIMEOUT_ENV = "DAISYCLAW_DISCORD_RUNTIME_READY_TIMEOUT_MS";
