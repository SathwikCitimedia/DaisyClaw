...
import type { DaisyClawConfig, ReplyToMode } from "daisyclaw/plugin-sdk/config-contracts";
import { createConnectedChannelStatusPatch } from "daisyclaw/plugin-sdk/gateway-runtime";
import {
  resolveNativeCommandsEnabled,
  resolveNativeSkillsEnabled,
} from "daisyclaw/plugin-sdk/native-command-config-runtime";
...
import { isVerbose, logVerbose, shouldLogVerbose, warn } from "daisyclaw/plugin-sdk/runtime-env";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("daisyclaw/plugin-sdk/reply-history").HistoryEntry[]
    >();
