...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "daisyclaw/plugin-sdk/routing";
import {
...
// registry.
const THREAD_BINDINGS_STATE_KEY = Symbol.for("daisyclaw.discordThreadBindingsState");
