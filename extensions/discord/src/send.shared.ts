...
import { buildOutboundMediaLoadOptions } from "daisyclaw/plugin-sdk/media-runtime";
import { extensionForMime } from "daisyclaw/plugin-sdk/media-runtime";
import {
...
import type { ChunkMode } from "daisyclaw/plugin-sdk/reply-chunking";
...
async function resolveDiscordTargetChannelId(
  raw: string,
  opts: DiscordClientOpts & { cfg: DaisyClawConfig },
): Promise<{ channelId: string; dm?: boolean }> {
