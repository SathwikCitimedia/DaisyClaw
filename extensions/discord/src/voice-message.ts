...
import { unlinkIfExists } from "daisyclaw/plugin-sdk/media-runtime";
import { parseStrictFiniteNumber } from "daisyclaw/plugin-sdk/number-runtime";
import type { RetryRunner } from "daisyclaw/plugin-sdk/retry-runtime";
...
async function generateWaveformFromPcm(filePath: string): Promise<string> {
  const tempDir = resolvePreferredDaisyClawTmpDir();
