...
import type { DaisyClawConfig, TtsConfig } from "daisyclaw/plugin-sdk/config-contracts";
import { parseTtsDirectives } from "daisyclaw/plugin-sdk/speech";
...
function resolveVoiceTtsConfig(params: { cfg: DaisyClawConfig; override?: TtsConfig }): {
  cfg: DaisyClawConfig;
