...
import { describeAccountSnapshot } from "daisyclaw/plugin-sdk/account-helpers";
...
import { createChatChannelPlugin } from "daisyclaw/plugin-sdk/channel-core";
import {
...
import { getSessionBindingService } from "daisyclaw/plugin-sdk/conversation-runtime";
import {
...
import { createLazyRuntimeNamedExport } from "daisyclaw/plugin-sdk/lazy-runtime";
import { parseStrictPositiveInteger } from "daisyclaw/plugin-sdk/number-runtime";
import { createComputedAccountStatusAdapter } from "daisyclaw/plugin-sdk/status-helpers";
...
export const feishuPlugin: ChannelPlugin<ResolvedFeishuAccount, FeishuProbeResult> =
  createChatChannelPlugin({
    base: {
      ...
      auth: {
        login: async ({ cfg }) => {
          const { createClackPrompter } = await import("daisyclaw/plugin-sdk/setup-runtime");
          const { replaceConfigFile } = await import("daisyclaw/plugin-sdk/config-mutation");
