// File Transfer plugin entrypoint registers its DaisyClaw integration.
import {
  definePluginEntry,
  type AnyAgentTool,
  type DaisyClawPluginNodeHostCommand,
...
const fileTransferNodeHostCommands: DaisyClawPluginNodeHostCommand[] = [
  {
    command: "file.fetch",
    cap: "file",
    dangerous: true,
