...
// without touching ~/.daisyclaw/daisyclaw.json.
...
vi.mock("daisyclaw/plugin-sdk/config-mutation", () => ({
...
afterAll(() => {
  vi.doUnmock("daisyclaw/plugin-sdk/runtime-config-snapshot");
  vi.doUnmock("daisyclaw/plugin-sdk/config-mutation");
  vi.resetModules();
});
