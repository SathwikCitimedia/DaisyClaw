...
import type { WebFetchProviderPlugin } from "daisyclaw/plugin-sdk/provider-web-fetch";
import { enablePluginInConfig } from "daisyclaw/plugin-sdk/provider-web-fetch";
