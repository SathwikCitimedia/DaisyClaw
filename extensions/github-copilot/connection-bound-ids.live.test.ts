...
import { stream as streamModel, type AssistantMessage, type Model } from "daisyclaw/plugin-sdk/llm";
...
const ENV_GITHUB_TOKEN =
  process.env.DAISYCLAW_LIVE_GITHUB_COPILOT_TOKEN ??
  process.env.COPILOT_GITHUB_TOKEN ??
  process.env.GH_TOKEN ??
  process.env.GITHUB_TOKEN ??
  "";
const LIVE_MODEL_ID = process.env.DAISYCLAW_LIVE_GITHUB_COPILOT_MODEL?.trim() || "gpt-5.4";
