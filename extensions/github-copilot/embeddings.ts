...
import { buildCopilotIdeHeaders } from "daisyclaw/plugin-sdk/provider-auth";
import { resolveConfiguredSecretInputString } from "daisyclaw/plugin-sdk/secret-input-runtime";
