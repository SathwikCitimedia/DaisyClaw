// Github Copilot plugin entrypoint registers its DaisyClaw integration.
...
import { getCachedLiveCatalogValue } from "daisyclaw/plugin-sdk/provider-catalog-shared";
...
function applyCopilotDefaultModel(cfg: DaisyClawConfig): DaisyClawConfig {
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    function resolveCurrentPluginConfig(config?: DaisyClawConfig): GithubCopilotPluginConfig {
