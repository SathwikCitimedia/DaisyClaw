...
import { buildCopilotIdeHeaders, COPILOT_INTEGRATION_ID } from "daisyclaw/plugin-sdk/provider-auth";
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in daisyclaw.json — no
