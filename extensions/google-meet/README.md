# @daisyclaw/google-meet

Official Google Meet participant plugin for DaisyClaw.
...
```bash
daisyclaw plugins install @daisyclaw/google-meet
```
...
- https://docs.daisyclaw.ai/plugins/google-meet

## Package

- Plugin id: `google-meet`
- Tool: `google_meet`
- Package: `@daisyclaw/google-meet`
- Minimum DaisyClaw host: `2026.4.20`
