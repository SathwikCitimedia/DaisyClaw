// Google Meet plugin entrypoint registers its DaisyClaw integration.
import {
...
} from "daisyclaw/plugin-sdk/gateway-runtime";
...
const googleMeetConfigSchema = {
  ...
  uiHints: {
    ...
    defaultMode: {
      label: "Default Mode",
      help: "Agent uses realtime transcription plus regular DaisyClaw TTS. Bidi uses the realtime voice model directly. Transcribe observes only.",
    },
    "chrome.audioBackend": {
    ...
    "chrome.autoJoin": {
      ...
      help: "Best-effort guest-name fill and Join Now click through DaisyClaw browser automation.",
    },
    ...
    "realtime.transcriptionProvider": {
      ...
      help: "Agent mode uses this provider to transcribe meeting audio before regular DaisyClaw TTS answers.",
    },
    ...
    "realtime.model": {
      ...
      help: "Only used by mode=bidi. Agent mode answers with the configured DaisyClaw agent and regular TTS.",
      advanced: true,
    },
    ...
    "realtime.agentId": {
      ...
      help: 'DaisyClaw agent id used by daisyclaw_agent_consult. Defaults to "main".',
      advanced: true,
    },
    "realtime.toolPolicy": {
