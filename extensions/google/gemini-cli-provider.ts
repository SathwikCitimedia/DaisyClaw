...
import { buildOauthProviderAuthResult } from "daisyclaw/plugin-sdk/provider-auth-result";
import type { ProviderPlugin } from "daisyclaw/plugin-sdk/provider-model-shared";
import { fetchGeminiUsage } from "daisyclaw/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: DaisyClawPluginApi) {
