...
import { createProviderHttpError } from "daisyclaw/plugin-sdk/provider-http";
import {
...
} from "daisyclaw/plugin-sdk/provider-transport-runtime";
import {
...
type GoogleTransportApi = CanonicalGoogleTransportApi | "daisyclaw-google-generative-ai-transport";
...
const GOOGLE_GEMINI3_FIRST_RESPONSE_RETRY_ENV = "DAISYCLAW_GOOGLE_GEMINI_FIRST_RESPONSE_RETRY_MS";
...
function normalizeGoogleTransportRouteApi(
  ...
  switch (api) {
    ...
    case "daisyclaw-google-generative-ai-transport":
