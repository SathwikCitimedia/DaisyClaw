...
import { safeParseJsonWithSchema, safeParseWithSchema } from "daisyclaw/plugin-sdk/extension-shared";
import { mergePairLoopGuardConfig } from "daisyclaw/plugin-sdk/pair-loop-guard-runtime";
import { isSecretRef } from "daisyclaw/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: DaisyClawConfig): ResolvedGoogleChatAccount[] {
