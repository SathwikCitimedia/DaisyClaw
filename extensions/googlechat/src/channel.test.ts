...
function resolveGoogleChatAccountImpl(params: { cfg: DaisyClawConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: DaisyClawConfig) => {
...
function createGoogleChatCfg(): DaisyClawConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
