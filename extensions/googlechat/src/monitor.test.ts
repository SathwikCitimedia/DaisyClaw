...
import { recordChannelBotPairLoopAndCheckSuppression } from "daisyclaw/plugin-sdk/channel-inbound";
  ...
  it("creates typing messages by default", async () => {
    ...
    const core = {
      ...
      channel: {
        ...
        session: {
          resolveStorePath: () => "/tmp/daisyclaw-googlechat-test",
