...
} from "daisyclaw/plugin-sdk/account-resolution";
import { resolveAccountEntry } from "daisyclaw/plugin-sdk/routing";
...
function mergeIMessageAccountConfig(cfg: DaisyClawConfig, accountId: string): IMessageAccountConfig {
...
// caused duplicate inbound handling in daisyclaw/daisyclaw#65141.
...
function resolveIMessageAccountSourceOwner(params: {
  ...
  // bindings tied to the named account keep working (daisyclaw/daisyclaw#65141).
 ...
 * watchers (daisyclaw/daisyclaw#65141) without otherwise marking the duplicate
...
export function listEnabledIMessageAccounts(cfg: DaisyClawConfig): ResolvedIMessageAccount[] {
