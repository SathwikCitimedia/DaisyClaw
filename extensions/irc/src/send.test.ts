...
import { verifyChannelMessageAdapterCapabilityProofs } from "daisyclaw/plugin-sdk/channel-outbound";
import { createSendCfgThreadingRuntime } from "daisyclaw/plugin-sdk/channel-test-helpers";
...
vi.mock("daisyclaw/plugin-sdk/plugin-config-runtime", async () => {
  const original = (await vi.importActual("daisyclaw/plugin-sdk/plugin-config-runtime")) as Record<
    string,
    unknown
  >;
  return {
...
vi.mock("daisyclaw/plugin-sdk/text-chunking", async () => {
  const original = (await vi.importActual("daisyclaw/plugin-sdk/text-chunking")) as Record<
    string,
    unknown
  >;
  return {
...
afterAll(() => {
  ...
  vi.doUnmock("daisyclaw/plugin-sdk/plugin-config-runtime");
  vi.doUnmock("daisyclaw/plugin-sdk/text-chunking");
  vi.resetModules();
});
