...
export function applyKimiCodeProviderConfig(cfg: DaisyClawConfig): DaisyClawConfig {
  return kimiCodingPresetAppliers.applyProviderConfig(cfg);
}

export function applyKimiCodeConfig(cfg: DaisyClawConfig): DaisyClawConfig {
