// Line plugin entrypoint registers its DaisyClaw integration.
import {
...
type RegisteredLineCardCommand = DaisyClawPluginCommandDefinition;

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: DaisyClawPluginApi): Promise<RegisteredLineCardCommand> {
