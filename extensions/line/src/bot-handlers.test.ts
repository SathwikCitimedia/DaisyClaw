...
vi.mock("daisyclaw/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
  matchesMentionPatterns: () => false,
}));
vi.mock("daisyclaw/plugin-sdk/channel-pairing", () => ({
...
vi.mock("daisyclaw/plugin-sdk/command-auth-native", () => ({
...
vi.mock("daisyclaw/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("daisyclaw/plugin-sdk/reply-history", () => ({
...
vi.mock("daisyclaw/plugin-sdk/routing", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("daisyclaw/plugin-sdk/channel-inbound");
    vi.doUnmock("daisyclaw/plugin-sdk/channel-pairing");
    vi.doUnmock("daisyclaw/plugin-sdk/command-auth-native");
    vi.doUnmock("daisyclaw/plugin-sdk/runtime-group-policy");
    vi.doUnmock("daisyclaw/plugin-sdk/runtime-env");
    vi.doUnmock("daisyclaw/plugin-sdk/reply-history");
    vi.doUnmock("daisyclaw/plugin-sdk/routing");
    vi.doUnmock("daisyclaw/plugin-sdk/conversation-runtime");
