...
vi.mock("daisyclaw/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("daisyclaw/plugin-sdk/channel-activity-runtime", () => ({
...
describe("LINE send helpers", () => {
  ...
  afterAll(() => {
    ...
    vi.doUnmock("daisyclaw/plugin-sdk/channel-activity-runtime");
