...
import type { ChannelSetupAdapter, DaisyClawConfig } from "daisyclaw/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "daisyclaw/plugin-sdk/setup";
...
export function isLineConfigured(cfg: DaisyClawConfig, accountId: string): boolean {
