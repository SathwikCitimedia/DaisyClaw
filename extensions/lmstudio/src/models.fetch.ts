...
import { readProviderJsonArrayFieldResponse } from "daisyclaw/plugin-sdk/provider-http";
import type { ModelDefinitionConfig } from "daisyclaw/plugin-sdk/provider-model-shared";
import { SELF_HOSTED_DEFAULT_COST } from "daisyclaw/plugin-sdk/provider-setup";
import { fetchWithSsrFGuard, type SsrFPolicy } from "daisyclaw/plugin-sdk/ssrf-runtime";
...
/** Discovers LLM models from LM Studio and maps them to DaisyClaw model definitions. */
