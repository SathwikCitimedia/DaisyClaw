...
const installedSymbol = Symbol.for("daisyclaw.lobster.ajv-compile-cache.installed");
const cacheSymbol = Symbol.for("daisyclaw.lobster.ajv-compile-cache.entries");
