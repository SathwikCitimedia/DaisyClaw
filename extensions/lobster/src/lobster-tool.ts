...
} from "daisyclaw/plugin-sdk/param-readers";
...
type BoundTaskFlow = ReturnType<
  NonNullable<DaisyClawPluginApi["runtime"]>["tasks"]["managedFlows"]["bindSession"]
>;
...
export function createLobsterTool(api: DaisyClawPluginApi, options?: LobsterToolOptions) {
