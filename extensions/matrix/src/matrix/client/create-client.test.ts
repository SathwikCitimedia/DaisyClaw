...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/daisyclaw-matrix-create-client-test",
    storagePath: "/tmp/daisyclaw-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/daisyclaw-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/daisyclaw-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/daisyclaw-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "daisyclaw-matrix-default-token-hash",
