...
import { hasFinalInboundReplyDispatch } from "daisyclaw/plugin-sdk/channel-inbound";
import type { ChannelBotLoopProtectionFacts } from "daisyclaw/plugin-sdk/channel-inbound";
import {
...
import { isDangerousNameMatchingEnabled } from "daisyclaw/plugin-sdk/dangerous-name-runtime";
import {
  isFutureDateTimestampMs,
  resolveExpiresAtMsFromDurationMs,
} from "daisyclaw/plugin-sdk/number-runtime";
import { mergePairLoopGuardConfig } from "daisyclaw/plugin-sdk/pair-loop-guard-runtime";
import { buildInboundHistoryFromEntries } from "daisyclaw/plugin-sdk/reply-history";
import {
  buildTtsSupplementMediaPayload,
  getReplyPayloadTtsSupplement,
} from "daisyclaw/plugin-sdk/reply-payload";
import type { GetReplyOptions } from "daisyclaw/plugin-sdk/reply-runtime";
...
import { MATRIX_DAISYCLAW_FINALIZED_PREVIEW_KEY } from "../send/types.js";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("daisyclaw/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("daisyclaw/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<
  typeof import("daisyclaw/plugin-sdk/acp-binding-runtime")
> {
  acpBindingRuntimePromise ??= import("daisyclaw/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("daisyclaw/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("daisyclaw/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_DAISYCLAW_FINALIZED_PREVIEW_KEY]: true };
}
