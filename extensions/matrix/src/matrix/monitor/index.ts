// Matrix plugin entrypoint registers its DaisyClaw integration.
...
import { resolveOptionalIntegerOption } from "daisyclaw/plugin-sdk/number-runtime";
import {
...
export type MonitorMatrixOpts = {
  ...
  setStatus?: (next: import("daisyclaw/plugin-sdk/channel-contract").ChannelAccountSnapshot) => void;
};
