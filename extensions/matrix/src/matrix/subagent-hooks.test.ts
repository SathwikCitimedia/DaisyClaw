...
import type { DaisyClawPluginApi as MatrixEntryPluginApi } from "daisyclaw/plugin-sdk/channel-entry-contract";
import {
...
vi.mock("daisyclaw/plugin-sdk/conversation-binding-runtime", () => ({
