...
import type { OutputRuntimeEnv } from "daisyclaw/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "daisyclaw/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "DaisyClaw Gateway",
    },
    confirm: {
