...
export type MatrixStreamingConfig = {
  ...
  progress?: import("daisyclaw/plugin-sdk/channel-outbound").ChannelStreamingProgressConfig;
  preview?: {
...
export type CoreConfig = {
  ...
  session?: {
    store?: string;
    dmScope?: NonNullable<DaisyClawConfig["session"]>["dmScope"];
  };
  messages?: {
    ackReaction?: string;
    ackReactionScope?: "group-mentions" | "group-all" | "direct" | "all" | "none" | "off";
  };
  secrets?: DaisyClawConfig["secrets"];
  [key: string]: unknown;
};
