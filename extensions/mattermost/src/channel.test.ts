...
vi.mock("daisyclaw/plugin-sdk/ssrf-runtime", async () => {
  const original = (await vi.importActual("daisyclaw/plugin-sdk/ssrf-runtime")) as Record<
    string,
    unknown
  >;
...
function getDescribedActions(cfg: DaisyClawConfig, accountId?: string): string[] {
