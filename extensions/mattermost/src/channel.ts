...
import { createLoggedPairingApprovalNotifier } from "daisyclaw/plugin-sdk/channel-pairing";
import { createRestrictSendersChannelSecurity } from "daisyclaw/plugin-sdk/channel-policy";
import {
...
import { buildPassiveProbedChannelStatusSummary } from "daisyclaw/plugin-sdk/extension-shared";
import {
  type MessagePresentation,
  normalizeMessagePresentation,
  renderMessagePresentationFallbackText,
  resolveMessagePresentationControlValue,
} from "daisyclaw/plugin-sdk/interactive-runtime";
import { createLazyRuntimeModule } from "daisyclaw/plugin-sdk/lazy-runtime";
import { resolvePayloadMediaUrls, sendTextMediaPayload } from "daisyclaw/plugin-sdk/reply-payload";
import { isPrivateNetworkOptInEnabled } from "daisyclaw/plugin-sdk/ssrf-runtime";
import {
...
export const mattermostPlugin: ChannelPlugin<ResolvedMattermostAccount> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      ...
      message: "DaisyClaw: your access has been approved.",
