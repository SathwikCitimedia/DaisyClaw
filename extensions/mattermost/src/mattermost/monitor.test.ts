...
import { createClaimableDedupe } from "daisyclaw/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: DaisyClawConfig; threadRootId?: string }) {
...
describe("shouldUpdateMattermostDraftToolProgress", () => {
  type MattermostConfig = NonNullable<NonNullable<DaisyClawConfig["channels"]>["mattermost"]>;
