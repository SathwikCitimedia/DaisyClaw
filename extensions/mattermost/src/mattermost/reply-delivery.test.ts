...
import type { ChunkMode } from "daisyclaw/plugin-sdk/reply-runtime";
import { describe, expect, it, vi } from "vitest";
import type { DaisyClawConfig, PluginRuntime } from "../../runtime-api.js";
...
describe("deliverMattermostReplyPayload", () => {
  it("suppresses payloads flagged as reasoning", async () => {
    ...
    const cfg = {} satisfies DaisyClawConfig;
  ...
  it("passes agent-scoped mediaLocalRoots when sending media paths", async () => {
    ...
    const stateDir = await fs.mkdtemp(path.join(os.tmpdir(), "daisyclaw-mm-state-"));
