 ...
 */
const ACCOUNT_STATES_KEY = Symbol.for("daisyclaw.mattermost.slash-account-states");
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("./runtime-api.js").DaisyClawConfig;
 ...
 */
export function registerSlashCommandRoute(api: DaisyClawPluginApi) {
