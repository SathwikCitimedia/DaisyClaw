// Memory Core plugin entrypoint registers its DaisyClaw integration.
import {
  jsonResult,
...
import { resolveMemoryBackendConfig } from "daisyclaw/plugin-sdk/memory-core-host-runtime-files";
import {
  definePluginEntry,
  type AnyAgentTool,
...
function getToolConfig(options: MemoryToolOptions): DaisyClawConfig | undefined {
...
function resolveMemoryToolOptions(ctx: DaisyClawPluginToolContext): MemoryToolOptions {
