...
import { createAsyncLock } from "daisyclaw/plugin-sdk/async-lock-runtime";
import { extractErrorCode } from "daisyclaw/plugin-sdk/error-runtime";
import { resolveGlobalMap } from "daisyclaw/plugin-sdk/global-singleton";
import { replaceManagedMarkdownBlock } from "daisyclaw/plugin-sdk/memory-host-markdown";
import { replaceFileAtomic } from "daisyclaw/plugin-sdk/security-runtime";

const DREAMS_FILENAMES = ["DREAMS.md", "dreams.md"] as const;
const DEEP_START_MARKER = "<!-- daisyclaw:dreaming:deep:start -->";
const DEEP_END_MARKER = "<!-- daisyclaw:dreaming:deep:end -->";
