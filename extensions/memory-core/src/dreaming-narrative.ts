...
import { resolveStateDir } from "daisyclaw/plugin-sdk/memory-core-host-runtime-core";
...
const DIARY_START_MARKER = "<!-- daisyclaw:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- daisyclaw:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "daisyclaw:dreaming:backfill-entry";
