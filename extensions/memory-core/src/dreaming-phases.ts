...
import type { MemorySearchResult } from "daisyclaw/plugin-sdk/memory-core-host-runtime-files";
import {
...
type Logger = Pick<DaisyClawPluginApi["logger"], "info" | "warn" | "error">;
...
const LIGHT_SLEEP_EVENT_TEXT = "__daisyclaw_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__daisyclaw_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- daisyclaw:dreaming:light:start -->",
    endMarker: "<!-- daisyclaw:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- daisyclaw:dreaming:rem:start -->",
    endMarker: "<!-- daisyclaw:dreaming:rem:end -->",
  },
] as const;
