...
import type { EmbeddingProviderAdapter } from "daisyclaw/plugin-sdk/embedding-providers";
import type { MemoryEmbeddingProviderAdapter } from "daisyclaw/plugin-sdk/memory-core-host-engine-embeddings";
...
const mockEmbeddingRegistry = vi.hoisted(() => ({
  ...
  genericLookupConfigs: [] as Array<DaisyClawConfig | undefined>,
}));

vi.mock("daisyclaw/plugin-sdk/embedding-providers", () => ({
  getEmbeddingProvider: (id: string, config?: DaisyClawConfig) => {
...
vi.mock("daisyclaw/plugin-sdk/memory-core-host-engine-embeddings", () => ({
