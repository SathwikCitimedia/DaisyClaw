...
class SessionSyncYieldHarness extends MemoryManagerSyncOps {
  protected readonly cfg = {} as DaisyClawConfig;
  protected readonly agentId = "main";
  protected readonly workspaceDir = "/tmp/daisyclaw-test-workspace";
...
describe("session sync responsiveness", () => {
  beforeEach(() => {
    vi.stubEnv("DAISYCLAW_STATE_DIR", path.join(os.tmpdir(), "daisyclaw-session-sync-yield"));
