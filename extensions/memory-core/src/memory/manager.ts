...
import { listRegisteredMemoryEmbeddingProviderAdapters } from "daisyclaw/plugin-sdk/memory-core-host-embedding-registry";
import {
...
import { extractKeywords } from "daisyclaw/plugin-sdk/memory-core-host-engine-qmd";
import {
  readMemoryFile,
...
import { uniqueValues } from "daisyclaw/plugin-sdk/string-coerce-runtime";
import {
...
const MEMORY_INDEX_MANAGER_CACHE_KEY = Symbol.for("daisyclaw.memoryIndexManagerCache");
...
export class MemoryIndexManager extends MemoryManagerEmbeddingOps implements MemorySearchManager {
  ...
  protected readonly cfg: DaisyClawConfig;
