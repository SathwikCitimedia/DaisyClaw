...
import type { DaisyClawConfig } from "daisyclaw/plugin-sdk/memory-core-host-runtime-core";
import type { MemorySearchResult } from "daisyclaw/plugin-sdk/memory-core-host-runtime-files";
import { resolveSessionAgentId } from "daisyclaw/plugin-sdk/memory-host-core";
import {
...
function isGlobalSessionKeyForSharedScope(cfg: DaisyClawConfig, key: string): boolean {
