...
import type { MemorySource } from "daisyclaw/plugin-sdk/memory-core-host-engine-storage";
import {
  asToolParamsRecord,
  jsonResult,
...
} from "daisyclaw/plugin-sdk/memory-core-host-runtime-core";
import type {
  MemorySearchResult,
  MemorySearchRuntimeDebug,
} from "daisyclaw/plugin-sdk/memory-core-host-runtime-files";
import {
...
const PAUSED_MEMORY_INDEX_ACTION =
  "Tell the user to run: daisyclaw memory status --index or daisyclaw memory index --force.";
...
export function createMemorySearchTool(options: {
  ...
  getConfig?: () => DaisyClawConfig | undefined;
  agentId?: string;
  agentSessionKey?: string;
  sandboxed?: boolean;
}) {
