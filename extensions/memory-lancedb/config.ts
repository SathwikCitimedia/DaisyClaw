...
import { parseFiniteNumber } from "daisyclaw/plugin-sdk/number-runtime";
...
function resolveDefaultDbPath(): string {
  const home = homedir();
  const preferred = join(home, ".daisyclaw", "memory", "lancedb");
  try {
...
export const memoryConfigSchema = {
  ...
  uiHints: {
    ...
    dbPath: {
      label: "Database Path",
      placeholder: "~/.daisyclaw/memory/lancedb",
      advanced: true,
