...
import type { PluginDoctorStateMigration } from "daisyclaw/plugin-sdk/runtime-doctor";
...
function readConfiguredPluginConfig(config: DaisyClawConfig): MemoryWikiPluginConfig | undefined {
