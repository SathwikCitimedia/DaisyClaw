...
import { readFiniteNumberParam } from "daisyclaw/plugin-sdk/param-readers";
...
const GENERATED_START = "<!-- daisyclaw:wiki:generated:start -->";
const GENERATED_END = "<!-- daisyclaw:wiki:generated:end -->";
const HUMAN_START = "<!-- daisyclaw:human:start -->";
const HUMAN_END = "<!-- daisyclaw:human:end -->";
