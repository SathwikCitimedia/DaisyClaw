...
import { mapPluginConfigIssues } from "daisyclaw/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type DaisyClawPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: DaisyClawPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".daisyclaw", "wiki", "main");
}
