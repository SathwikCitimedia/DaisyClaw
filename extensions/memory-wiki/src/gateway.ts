...
import { resolveDefaultAgentId } from "daisyclaw/plugin-sdk/memory-host-core";
import { readPositiveIntegerParam } from "daisyclaw/plugin-sdk/param-readers";
import type { DaisyClawConfig, DaisyClawPluginApi } from "../api.js";
...
type GatewayMethodContext = Parameters<
  Parameters<DaisyClawPluginApi["registerGatewayMethod"]>[1]
>[0];
...
function resolveGatewayAgentId(
  ...
  appConfig: DaisyClawConfig | undefined,
): string | undefined {
  return (
