...
import type { ProviderRuntimeModel } from "daisyclaw/plugin-sdk/core";
import type {
...
type ModelProviderConfig = NonNullable<NonNullable<DaisyClawConfig["models"]>["providers"]>[string];
