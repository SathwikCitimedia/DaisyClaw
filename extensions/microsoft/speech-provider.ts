...
import { isVoiceCompatibleAudio } from "daisyclaw/plugin-sdk/media-runtime";
...
import type {
  ...
  SpeechVoiceOption,
} from "daisyclaw/plugin-sdk/speech";
import { asBoolean, asFiniteNumber, asObject, trimToUndefined } from "daisyclaw/plugin-sdk/speech";
import {
  fetchWithSsrFGuard,
