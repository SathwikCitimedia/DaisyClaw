  ...
  if (params.hasMemoryFiles || memoryProvider) {
    items.push(
      createMigrationConfigPatchItem({
        ...
        message: "Use DaisyClaw built-in file memory for imported Hermes memory files.",
        conflict:
    ...
    items.push(
      createMigrationConfigPatchItem({
        ...
        message: "Select the default DaisyClaw memory plugin for imported file memory.",
        conflict:
          !params.ctx.overwrite &&
  ...
  if (memoryProvider === "honcho") {
    ...
    items.push(
      createMigrationManualItem({
        ...
        message:
          "Hermes used Honcho memory. DaisyClaw keeps built-in memory selected until the matching plugin is installed and reviewed.",
        recommendation:
    ...
    items.push(
      createMigrationManualItem({
        ...
        source: "config.yaml:memory.provider",
        message: `Hermes memory provider "${memoryProvider}" does not have a known DaisyClaw mapping.`,
        recommendation: "Install or configure an equivalent DaisyClaw memory plugin manually.",
      }),
    );
  }
