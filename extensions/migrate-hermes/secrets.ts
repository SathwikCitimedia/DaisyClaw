...
import { updateAuthProfileStoreWithLock } from "daisyclaw/plugin-sdk/provider-auth";
import {
...
async function buildOpenCodeSecretCandidates(
  ...
  // DaisyClaw's Copilot token profile cannot preserve OpenCode enterprise routing yet.
