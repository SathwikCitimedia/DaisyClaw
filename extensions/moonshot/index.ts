// Moonshot plugin entrypoint registers its DaisyClaw integration.
...
import { MOONSHOT_THINKING_STREAM_HOOKS } from "daisyclaw/plugin-sdk/provider-stream-family";
...
export default defineSingleProviderPluginEntry({
  ...
  provider: {
    ...
    // multi-turn replay. See daisyclaw/daisyclaw#62319.
