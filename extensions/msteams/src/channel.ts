...
import { createTopLevelChannelConfigAdapter } from "daisyclaw/plugin-sdk/channel-config-helpers";
import type {
...
const resolveMSTeamsChannelConfig = (cfg: DaisyClawConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: DaisyClawConfig }>(
