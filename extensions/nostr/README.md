...
Nostr DM channel plugin for DaisyClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to DaisyClaw. It enables your bot to:
...
# Configure daisyclaw to use local relay
