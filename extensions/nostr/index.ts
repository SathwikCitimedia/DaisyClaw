// Nostr plugin entrypoint registers its DaisyClaw integration.
import {
  defineBundledChannelEntry,
  loadBundledEntryExportSync,
} from "daisyclaw/plugin-sdk/channel-entry-contract";
import type { DaisyClawConfig, PluginRuntime, ResolvedNostrAccount } from "./api.js";
  ...
  registerFull(api) {
    const httpHandler = createNostrProfileHttpHandler()({
      getConfigProfile: (accountId: string) => {
        ...
        const cfg = runtime.config.current() as DaisyClawConfig;
