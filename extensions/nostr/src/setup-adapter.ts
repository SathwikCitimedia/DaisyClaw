...
import type { ChannelSetupAdapter } from "daisyclaw/plugin-sdk/channel-setup";
...
import { patchTopLevelChannelConfigSection, splitSetupEntries } from "daisyclaw/plugin-sdk/setup";
...
export function createNostrSetupAdapter(params: {
  resolveAccountId: (cfg: DaisyClawConfig, accountId?: string | null) => string;
