...
import { normalizeSecretInputString, type SecretInput } from "daisyclaw/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: DaisyClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: DaisyClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: DaisyClawConfig): string {
