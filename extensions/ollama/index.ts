// Ollama plugin entrypoint registers its DaisyClaw integration.
import { collectConfiguredModelRefValues } from "@daisyclaw/model-catalog-core/configured-model-refs";
...
export default definePluginEntry({
  ...
  register(api: DaisyClawPluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: DaisyClawConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY or run "daisyclaw onboard --auth-choice ollama-cloud". ' +
        "See: https://docs.daisyclaw.ai/providers/ollama",
    });
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "daisyclaw configure". ' +
        "See: https://docs.daisyclaw.ai/providers/ollama",
    });
  },
});
