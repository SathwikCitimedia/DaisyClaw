...
import { resolveEnvApiKey } from "daisyclaw/plugin-sdk/provider-auth-runtime";
import {
...
function resolveConfiguredOllamaWebSearchApiKey(config?: DaisyClawConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: DaisyClawConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: DaisyClawConfig): string {
