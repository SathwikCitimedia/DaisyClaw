...
import type { Context, Model, SimpleStreamOptions } from "daisyclaw/plugin-sdk/llm";
import {
...
vi.mock("daisyclaw/plugin-sdk/provider-stream-family", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("daisyclaw/plugin-sdk/provider-stream-family")>();
