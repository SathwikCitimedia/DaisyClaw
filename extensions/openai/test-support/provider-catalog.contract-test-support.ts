...
import type { ProviderPlugin } from "daisyclaw/plugin-sdk/provider-test-contracts";
...
vi.mock("daisyclaw/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("daisyclaw/plugin-sdk/provider-catalog-runtime")
  >("daisyclaw/plugin-sdk/provider-catalog-runtime");
