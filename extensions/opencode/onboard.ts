...
export function applyOpencodeZenProviderConfig(cfg: DaisyClawConfig): DaisyClawConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeZenConfig(cfg: DaisyClawConfig): DaisyClawConfig {
