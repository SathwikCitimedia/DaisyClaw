...
function readManifest(): OpenRouterManifest {
  return JSON.parse(readFileSync(new URL("./daisyclaw.plugin.json", import.meta.url), "utf8"));
}
...
describe("openrouter provider hooks", () => {
  ...
  it("injects provider routing into compat before applying stream wrappers", async () => {
    ...
    const baseStreamFn = vi.fn(
      (
        ...args: Parameters<import("daisyclaw/plugin-sdk/agent-core").StreamFn>
      ): ReturnType<import("daisyclaw/plugin-sdk/agent-core").StreamFn> => {
