...
import { expectExplicitMusicGenerationCapabilities } from "daisyclaw/plugin-sdk/provider-test-contracts";
...
vi.mock("daisyclaw/plugin-sdk/provider-http", async (importOriginal) => {
  const original = await importOriginal<typeof import("daisyclaw/plugin-sdk/provider-http")>();
  return {
    ...original,
