...
import { clearLiveCatalogCacheForTests } from "daisyclaw/plugin-sdk/provider-catalog-shared";
import {
...
vi.mock("daisyclaw/plugin-sdk/provider-http", async () => {
  const actual = await vi.importActual<typeof import("daisyclaw/plugin-sdk/provider-http")>(
    "daisyclaw/plugin-sdk/provider-http",
  );
  return {
    ...actual,
