...
import { isRecord, normalizeOptionalString } from "daisyclaw/plugin-sdk/string-coerce-runtime";
import type {
  GeneratedVideoAsset,
  VideoGenerationProvider,
  VideoGenerationRequest,
  VideoGenerationSourceAsset,
} from "daisyclaw/plugin-sdk/video-generation";
...
const SUPPORTED_DURATIONS_HINT = Symbol.for("daisyclaw.videoGeneration.supportedDurations");
