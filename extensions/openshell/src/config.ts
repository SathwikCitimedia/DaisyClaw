...
import { buildPluginConfigSchema, type DaisyClawPluginConfigSchema } from "daisyclaw/plugin-sdk/core";
import {
  formatPluginConfigIssue,
  mapPluginConfigIssues,
} from "daisyclaw/plugin-sdk/extension-shared";
import { MAX_TIMER_TIMEOUT_SECONDS } from "daisyclaw/plugin-sdk/number-runtime";
import { z } from "zod";
...
const DEFAULT_SOURCE = "daisyclaw";
...
export function createOpenShellPluginConfigSchema(): DaisyClawPluginConfigSchema {
