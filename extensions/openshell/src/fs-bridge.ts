...
import { root as fsRoot } from "daisyclaw/plugin-sdk/file-access-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "daisyclaw/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "daisyclaw/plugin-sdk/sandbox";
...
const MATERIALIZED_SKILLS_CONTAINER_PARTS = [".daisyclaw", "sandbox-skills", "skills"] as const;
