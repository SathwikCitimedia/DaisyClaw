  ...
  it(
    ...
    async () => {
      ...
      const result = (await tool.execute({
        objective:
          "Find the DaisyClaw GitHub repository and recent project activity for a quick smoke test.",
        search_queries: ["daisyclaw github repository", "daisyclaw release notes"],
        count: 3,
