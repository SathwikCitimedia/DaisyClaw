import { createWebSearchProviderContractFields } from "daisyclaw/plugin-sdk/provider-web-search-contract";
...
export function createParallelFreeWebSearchProviderBase() {
  return {
    ...
    docsUrl: "https://docs.daisyclaw.ai/tools/parallel-search",
    autoDetectOrder: 76,
    credentialPath: "",
