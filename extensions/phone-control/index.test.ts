...
const PHONE_CONTROL_STATE_PREFIX = "daisyclaw-phone-control-test-";
...
function createApi(params: {
  ...
  openKeyedStore?: DaisyClawPluginApi["runtime"]["state"]["openKeyedStore"];
}): DaisyClawPluginApi {
...
}): DaisyClawPluginApi["runtime"]["state"]["openKeyedStore"] {
  return <T>() => {
...
describe("phone-control plugin", () => {
  ...
  it("does not block service startup on the initial expiry check", async () => {
    ...
    try {
      ...
      let service: DaisyClawPluginService | undefined;
