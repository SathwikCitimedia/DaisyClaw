...
describe("qa tool coverage report", () => {
  ...
  it("keeps searchable DaisyClaw dynamic tool rows report-only by default", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-searchable-web-search", "web-search", {
          toolName: "web_search",
          toolCoverage: {
            bucket: "daisyclaw-dynamic-integration",
            expectedLayer: "daisyclaw-dynamic",
            capabilityLayer: "daisyclaw-dynamic-searchable",
          },
        }),
      ],
      summary: {
  ...
  it("passes required DaisyClaw dynamic tool coverage when both runtimes exercise the tool", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          ...
          toolCoverage: {
            bucket: "daisyclaw-dynamic-integration",
            expectedLayer: "daisyclaw-dynamic",
            capabilityLayer: "daisyclaw-dynamic-direct",
            required: true,
          },
        }),
      ],
  ...
  it("passes required DaisyClaw dynamic tool coverage when Codex reports a soft tool error", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          toolName: "web_search",
  ...
  it("fails required DaisyClaw dynamic tool coverage when a runtime skips the tool", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          toolName: "web_search",
  ...
  it("fails required DaisyClaw dynamic tool coverage when the fixture failure mode is preserved", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          toolName: "web_search",
