...
function registerCommands(): DaisyClawPluginCommandDefinition[] {
  ensurePlatformAdapter();
  const commands: DaisyClawPluginCommandDefinition[] = [];
  const api = {
    logger: {},
    registerCommand: (command: DaisyClawPluginCommandDefinition) => {
...
function findCommand(
  commands: DaisyClawPluginCommandDefinition[],
  name: string,
): DaisyClawPluginCommandDefinition {
