...
import { parseAccessGroupAllowFromEntry } from "daisyclaw/plugin-sdk/access-groups";
import {
  createChannelIngressResolver,
  defineStableChannelIngressIdentity,
} from "daisyclaw/plugin-sdk/channel-ingress-runtime";
import { resolveInboundMentionDecision } from "daisyclaw/plugin-sdk/channel-mention-gating";
  ...
  return {
    async resolveInboundAccess(input) {
      ...
      const resolved = await createChannelIngressResolver({
        ...
        cfg: input.cfg as DaisyClawConfig,
      }).message({
