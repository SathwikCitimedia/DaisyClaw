...
function makeRestrictedCfg(approvers: string[]): DaisyClawConfig {
  return {
    channels: {
      qqbot: {
        appId: "app",
...
function makeCommandAuthorizedFallbackCfg(): DaisyClawConfig {
  return {
    channels: {
      qqbot: {
        appId: "app",
...
describe("createInteractionHandler approval buttons", () => {
  ...
  ] satisfies Array<[string, DaisyClawConfig]>)(
