...
function mergeSignalAccountConfig(cfg: DaisyClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: DaisyClawConfig): ResolvedSignalAccount[] {
