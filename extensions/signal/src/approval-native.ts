...
import { createLazyChannelApprovalNativeRuntimeAdapter } from "daisyclaw/plugin-sdk/approval-handler-adapter-runtime";
import type { ChannelApprovalNativeRuntimeAdapter } from "daisyclaw/plugin-sdk/approval-handler-runtime";
import {
...
import { buildApprovalReactionPendingContentForRequest } from "daisyclaw/plugin-sdk/approval-reaction-runtime";
import type {
  ExecApprovalRequest,
...
import { parseAgentSessionKey } from "daisyclaw/plugin-sdk/routing";
import {
...
type ApprovalForwardingConfig = NonNullable<NonNullable<DaisyClawConfig["approvals"]>["exec"]>;
