...
import { buildApprovalPresentationFromActionDescriptors } from "daisyclaw/plugin-sdk/approval-reply-runtime";
import type { DaisyClawConfig } from "daisyclaw/plugin-sdk/config-contracts";
import { logError } from "daisyclaw/plugin-sdk/logging-core";
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<DaisyClawConfig["channels"]>["slack"]>["execApprovals"]
>;
