...
} from "daisyclaw/plugin-sdk/channel-route";
import type { DaisyClawConfig } from "daisyclaw/plugin-sdk/config-contracts";
import { normalizeMessageChannel } from "daisyclaw/plugin-sdk/routing";
import {
...
type ApprovalForwardingConfig = NonNullable<NonNullable<DaisyClawConfig["approvals"]>["plugin"]>;
...
function resolvePluginApprovalForwardingConfig(cfg: DaisyClawConfig) {
