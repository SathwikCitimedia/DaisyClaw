...
function buildConfig(
  overrides?: Partial<NonNullable<NonNullable<DaisyClawConfig["channels"]>["slack"]>>,
): DaisyClawConfig {
  return {
    channels: {
      slack: {
...
const STORE_PATH = path.join(os.tmpdir(), "daisyclaw-slack-approval-native-test.json");
