...
} from "daisyclaw/plugin-sdk/allowlist-config-edit";
import { adaptScopedAccountAccessor } from "daisyclaw/plugin-sdk/channel-config-helpers";
import {
  buildThreadAwareOutboundSessionRoute,
  createChatChannelPlugin,
} from "daisyclaw/plugin-sdk/channel-core";
import { createChannelMessageAdapterFromOutbound } from "daisyclaw/plugin-sdk/channel-outbound";
import { resolveOutboundSendDep } from "daisyclaw/plugin-sdk/channel-outbound";
import { createPairingPrefixStripper } from "daisyclaw/plugin-sdk/channel-pairing";
import {
  createAttachedChannelResultAdapter,
  type ChannelOutboundAdapter,
} from "daisyclaw/plugin-sdk/channel-send-result";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "daisyclaw/plugin-sdk/directory-runtime";
import { createLazyRuntimeModule } from "daisyclaw/plugin-sdk/lazy-runtime";
import { buildOutboundBaseSessionKey, type RoutePeer } from "daisyclaw/plugin-sdk/routing";
import {
...
//
// `daisyclaw/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "daisyclaw/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "daisyclaw/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as DaisyClawConfig, toolContext as SlackActionContext | undefined),
    }),
