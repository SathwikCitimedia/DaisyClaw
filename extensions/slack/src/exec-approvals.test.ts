...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<DaisyClawConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<DaisyClawConfig["channels"]>["slack"]>>,
): DaisyClawConfig {
  return {
    channels: {
      slack: {
