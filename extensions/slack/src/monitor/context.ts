...
import { resolveDefaultAgentId } from "daisyclaw/plugin-sdk/agent-runtime";
import { formatAllowlistMatchMeta } from "daisyclaw/plugin-sdk/allow-from";
import type {
  DaisyClawConfig,
  SlackReactionNotificationMode,
} from "daisyclaw/plugin-sdk/config-contracts";
import type { SessionScope } from "daisyclaw/plugin-sdk/config-contracts";
import type { DmPolicy, GroupPolicy } from "daisyclaw/plugin-sdk/config-contracts";
import { resolveRuntimeConversationBindingRoute } from "daisyclaw/plugin-sdk/conversation-runtime";
import { createDedupeCache } from "daisyclaw/plugin-sdk/dedupe-runtime";
import type { HistoryEntry } from "daisyclaw/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("daisyclaw/plugin-sdk/config-contracts").SlackSlashCommandConfig>;
  textLimit: number;
