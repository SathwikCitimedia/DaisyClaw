...
vi.mock("daisyclaw/plugin-sdk/system-event-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("daisyclaw/plugin-sdk/system-event-runtime")>();
  return {
    ...actual,
...
vi.mock("daisyclaw/plugin-sdk/heartbeat-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("daisyclaw/plugin-sdk/heartbeat-runtime")>();
  return {
    ...actual,
...
vi.mock("daisyclaw/plugin-sdk/approval-gateway-runtime", () => ({
...
describe("registerSlackInteractionEvents", () => {
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "daisyclaw:verify" }],
            },
          ],
        },
      },
  ...
  it("registers a matcher that accepts plugin action ids beyond the DaisyClaw prefix", () => {
    const { ctx, getActionMatcher } = createContext();
    registerSlackInteractionEvents({ ctx: ctx as never });

    const matcher = getActionMatcher();
    expect(matcher.test("daisyclaw:verify")).toBe(true);
  ...
  it("treats Slack reply buttons as plain interaction events instead of plugin dispatch", async () => {
    ...
    await handler({
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "daisyclaw:reply_button" }],
            },
          ],
        },
      },
      action: {
        type: "button",
        action_id: "daisyclaw:reply_button",
        block_id: "reply_actions",
        value: "codex",
    ...
    const eventText = mockCallArg(enqueueSystemEventMock, 0, "enqueueSystemEvent");
    expect(eventText).toContain('"actionId":"daisyclaw:reply_button"');
    expectRecordFields(
      requireRecord(
      ...
      {
        contextKey: "slack:interaction:C1:100.200:daisyclaw:reply_button",
        deliveryContext: {
          accountId: "default",
          channel: "slack",
          threadId: "100.100",
  ...
  it("drops modal lifecycle payloads when mismatch guard triggers", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V123",
          callback_id: "daisyclaw:deploy_form",
          ...
          blocks: [
            {
              ...
              elements: [{ type: "multi_static_select", action_id: "daisyclaw:multi" }],
            },
          ],
        },
      },
          ...
          blocks: [
            {
              type: "actions",
              block_id: "date_block",
              elements: [{ type: "datepicker", action_id: "daisyclaw:date" }],
            },
            {
              type: "actions",
              block_id: "time_block",
              elements: [{ type: "timepicker", action_id: "daisyclaw:time" }],
            },
            {
              type: "actions",
              block_id: "datetime_block",
              elements: [{ type: "datetimepicker", action_id: "daisyclaw:datetime" }],
            },
          ],
        },
      },
      ...
      blocks: [
        {
          ...
          elements: [
            {
              type: "mrkdwn",
              text: ":white_check_mark: *daisyclaw:datetime* selected by <@U333>",
            },
          ],
        },
      ],
  ...
  it("captures modal submissions and enqueues view submission event", async () => {
    ...
    expectRecordFields(payload as unknown as Record<string, unknown>, {
      ...
      actionId: "view:daisyclaw:deploy_form",
      callbackId: "daisyclaw:deploy_form",
      viewId: "V123",
      userId: "U777",
  ...
  it("dispatches plugin-owned modal submissions with full view state before compacting events", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V777",
          callback_id: "daisyclaw:contract_confirm_hearing",
          private_metadata: JSON.stringify({
            channelId: "D777",
            channelType: "im",
            userId: "U777",
    ...
    expectRecordFields(requireRecord(dispatchCall, "dispatch call"), {
      ...
      dedupeId: "view_submission:daisyclaw:contract_confirm_hearing:V777:U777",
    });
    ...
    expectRecordFields(interaction, {
      ...
      namespace: "dean.contract",
      payload: "confirm_hearing",
      callbackId: "daisyclaw:contract_confirm_hearing",
      viewId: "V777",
  ...
  it("dispatches callback-id-only plugin modal submissions without agent routing metadata", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V778",
          callback_id: "daisyclaw:dean.contract:confirm_hearing",
          state: {
            values: {
              contract: {
    ...
    expectRecordFields(requireRecord(dispatchCall, "dispatch call"), {
      channel: "slack",
      data: "dean.contract:confirm_hearing",
      dedupeId: "view_submission:daisyclaw:dean.contract:confirm_hearing:V778:U777",
    });
    ...
    expectRecordFields(requireRecord(registrationCtx.interaction, "registration interaction"), {
      ...
      namespace: "dean.contract",
      payload: "confirm_hearing",
      callbackId: "daisyclaw:dean.contract:confirm_hearing",
      viewId: "V778",
    });
    expect(enqueueSystemEventMock).not.toHaveBeenCalled();
  });

  it("dispatches metadata-routed plugin modal submissions with non-daisyclaw callback ids", async () => {
    enqueueSystemEventMock.mockClear();
    dispatchPluginInteractiveHandlerMock.mockResolvedValueOnce({
      matched: true,
      handled: true,
  ...
  it("keeps no-channel modal events open when allowFrom is unset", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V444",
          callback_id: "daisyclaw:routing_form",
  ...
  it("captures modal input labels and picker values across block types", async () => {
            ...
            values: {
              ...
              email_block: {
                email_input: {
                  ...
                  value: "team@daisyclaw.ai",
                },
              },
              url_block: {
                url_input: {
                  type: "url_text_input",
                  value: "https://docs.daisyclaw.ai",
                },
              },
              richtext_block: {
                richtext_input: {
    ...
    expectRecordFields(inputByActionId(inputs, "email_input"), {
      inputKind: "email",
      inputEmail: "team@daisyclaw.ai",
    });
    expectRecordFields(inputByActionId(inputs, "url_input"), {
      inputKind: "url",
      inputUrl: "https://docs.daisyclaw.ai/",
    });
  ...
  it("truncates rich text preview to keep payload summaries compact", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V555",
          callback_id: "daisyclaw:long_richtext",
  ...
  it("caps oversized interaction payloads with compact summaries", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V915",
          callback_id: "daisyclaw:oversize",
          private_metadata: JSON.stringify({
            channelId: "D915",
            channelType: "im",
            userId: "U915",
