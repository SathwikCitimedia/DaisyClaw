...
vi.mock("daisyclaw/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("daisyclaw/plugin-sdk/channel-inbound")>(
    "daisyclaw/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
