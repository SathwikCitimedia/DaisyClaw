...
import { formatInboundEnvelope } from "daisyclaw/plugin-sdk/channel-inbound";
import { runTasksWithConcurrency } from "daisyclaw/plugin-sdk/concurrency-runtime";
import type { ContextVisibilityMode } from "daisyclaw/plugin-sdk/config-contracts";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("daisyclaw/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
