...
type BuildCommandTextFromArgs =
  typeof import("daisyclaw/plugin-sdk/command-auth-native").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("daisyclaw/plugin-sdk/command-auth-native").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("daisyclaw/plugin-sdk/command-auth-native").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("daisyclaw/plugin-sdk/command-auth-native").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("daisyclaw/plugin-sdk/command-auth-native").resolveCommandArgMenu;
