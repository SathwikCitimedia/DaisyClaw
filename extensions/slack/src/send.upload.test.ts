...
vi.mock("daisyclaw/plugin-sdk/fetch-runtime", async () => {
  const actual = await vi.importActual<typeof import("daisyclaw/plugin-sdk/fetch-runtime")>(
    "daisyclaw/plugin-sdk/fetch-runtime",
  );
  return {
    ...actual,
