...
import { patchChannelConfigForAccount } from "daisyclaw/plugin-sdk/setup-runtime";
import { formatDocsLink } from "daisyclaw/plugin-sdk/setup-tools";
import type { ResolvedSlackAccount } from "./accounts.js";
import type { DaisyClawConfig } from "./channel-api.js";

export const SLACK_CHANNEL = "slack" as const;

export function buildSlackManifest(botName = "DaisyClaw") {
  const safeName = botName.trim() || "DaisyClaw";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for DaisyClaw`,
    },
    features: {
      bot_user: {
      ...
      assistant_view: {
        assistant_description: `${safeName} connects Slack assistant threads to DaisyClaw agents.`,
        suggested_prompts: [
          {
