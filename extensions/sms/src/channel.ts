...
import { createConditionalWarningCollector } from "daisyclaw/plugin-sdk/channel-policy";
...
const resolveSmsDmPolicy = createScopedDmSecurityResolver<ResolvedSmsAccount>({
  ...
  approveHint: "daisyclaw pairing approve sms <code>",
...
export const smsPlugin: ChannelPlugin<ResolvedSmsAccount, SmsProbe> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      idLabel: "phoneNumber",
      message: "DaisyClaw: your SMS access has been approved.",
