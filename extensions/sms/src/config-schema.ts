...
} from "daisyclaw/plugin-sdk/channel-config-primitives";
import { requireChannelOpenAllowFrom } from "daisyclaw/plugin-sdk/extension-shared";
import { buildSecretInputSchema } from "daisyclaw/plugin-sdk/secret-input";
import { z } from "zod";
...
export const SmsChannelConfigSchema = buildChannelConfigSchema(SmsConfigSchema, {
  uiHints: {
    ...
    textChunkLimit: {
      ...
      help: "Maximum characters per outbound SMS chunk before DaisyClaw splits long replies.",
    },
  },
});
