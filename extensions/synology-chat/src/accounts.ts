...
import { resolveDangerousNameMatchingEnabled } from "daisyclaw/plugin-sdk/dangerous-name-runtime";
...
/** Extract the channel config from the full DaisyClaw config object. */
function getChannelConfig(cfg: DaisyClawConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: DaisyClawConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.DAISYCLAW_BOT_NAME ?? "DaisyClaw";
