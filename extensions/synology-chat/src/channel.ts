/**
 * Synology Chat Channel Plugin for DaisyClaw.
 *
 * Implements the ChannelPlugin interface following the LINE pattern.
 */

import { DEFAULT_ACCOUNT_ID } from "daisyclaw/plugin-sdk/account-id";
import type { DaisyClawConfig } from "daisyclaw/plugin-sdk/account-resolution";
import {
  createHybridChannelConfigAdapter,
  createScopedDmSecurityResolver,
} from "daisyclaw/plugin-sdk/channel-config-helpers";
import { createChatChannelPlugin, type ChannelPlugin } from "daisyclaw/plugin-sdk/channel-core";
import { waitUntilAbort } from "daisyclaw/plugin-sdk/channel-outbound";
import {
...
import { createEmptyChannelDirectoryAdapter } from "daisyclaw/plugin-sdk/directory-runtime";
import {
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "daisyclaw pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: DaisyClawConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: DaisyClawConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to DaisyClaw",
        order: 90,
      },
      capabilities: {
