...
function getChannelConfig(cfg: DaisyClawConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: DaisyClawConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: DaisyClawConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: DaisyClawConfig, accountId: string): string[] {
