// Talk Voice plugin entrypoint registers its DaisyClaw integration.
...
import type { SpeechVoiceOption } from "daisyclaw/plugin-sdk/speech";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalLowercaseString,
} from "daisyclaw/plugin-sdk/string-coerce-runtime";
import { resolveActiveTalkProviderConfig } from "daisyclaw/plugin-sdk/talk-config-runtime";
  ...
  register(api: DaisyClawPluginApi) {
    api.registerCommand({
      ...
      handler: async (ctx) => {
        ...
        const cfg = api.runtime.config.current() as DaisyClawConfig;
