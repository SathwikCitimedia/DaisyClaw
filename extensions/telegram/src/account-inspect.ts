...
import { resolveAccountWithDefaultFallback } from "daisyclaw/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "daisyclaw/plugin-sdk/channel-core";
import type { DaisyClawConfig } from "daisyclaw/plugin-sdk/config-contracts";
import type { TelegramAccountConfig } from "daisyclaw/plugin-sdk/config-contracts";
import { resolveDefaultSecretProviderAlias } from "daisyclaw/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "daisyclaw/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "daisyclaw/plugin-sdk/secret-input";
import { coerceSecretRef } from "daisyclaw/plugin-sdk/secret-input-runtime";
import { FsSafeError } from "daisyclaw/plugin-sdk/security-runtime";
...
function inspectTokenValue(params: { cfg: DaisyClawConfig; value: unknown }): {
  token: string;
...
function hasConfiguredTelegramAccounts(cfg: DaisyClawConfig): boolean {
