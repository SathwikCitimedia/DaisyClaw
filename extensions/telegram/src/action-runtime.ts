...
import type { MessagePresentation } from "daisyclaw/plugin-sdk/interactive-runtime";
...
function resolveActionTopicNameCacheScope(cfg: DaisyClawConfig, accountId?: string | null): string {
