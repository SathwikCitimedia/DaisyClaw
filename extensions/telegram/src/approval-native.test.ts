...
function buildConfig(
  overrides?: Partial<NonNullable<NonNullable<DaisyClawConfig["channels"]>["telegram"]>>,
): DaisyClawConfig {
  return {
    channels: {
      telegram: {
...
const STORE_PATH = path.join(os.tmpdir(), "daisyclaw-telegram-approval-native-test.json");
