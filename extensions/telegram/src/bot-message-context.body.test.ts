...
vi.mock("daisyclaw/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("daisyclaw/plugin-sdk/hook-runtime")>(
    "daisyclaw/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
