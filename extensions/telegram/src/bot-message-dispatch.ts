...
import { CURRENT_MESSAGE_MARKER } from "daisyclaw/plugin-sdk/channel-mention-gating";
import {
...
import { chunkMarkdownTextWithMode } from "daisyclaw/plugin-sdk/reply-chunking";
...
import type { BlockReplyContext } from "daisyclaw/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: DaisyClawConfig, agentId: string) {
  try {
