...
import { resolveChannelStreamingBlockEnabled } from "daisyclaw/plugin-sdk/channel-outbound";
import { resolveNativeCommandSessionTargets } from "daisyclaw/plugin-sdk/command-auth-native";
import {
...
import type { ChannelGroupPolicy } from "daisyclaw/plugin-sdk/config-contracts";
import type {
  ReplyToMode,
...
import { resolveMarkdownTableMode } from "daisyclaw/plugin-sdk/markdown-table-runtime";
import { resolveSendableOutboundReplyParts } from "daisyclaw/plugin-sdk/reply-payload";
import { resolveAgentRoute } from "daisyclaw/plugin-sdk/routing";
import { getRuntimeConfigSnapshot } from "daisyclaw/plugin-sdk/runtime-config-snapshot";
import { danger, logVerbose } from "daisyclaw/plugin-sdk/runtime-env";
...
type TelegramChunkMode = ReturnType<
  typeof import("daisyclaw/plugin-sdk/reply-dispatch-runtime").resolveChunkMode
>;
type TelegramNativeReplyPayload = import("daisyclaw/plugin-sdk/reply-dispatch-runtime").ReplyPayload;
...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): DaisyClawConfig => telegramDeps.getRuntimeConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: DaisyClawConfig): TelegramAccountConfig => {
    try {
