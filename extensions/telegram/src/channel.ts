...
import type { ChannelMessageActionAdapter } from "daisyclaw/plugin-sdk/channel-contract";
import {
...
import { createAccountStatusSink } from "daisyclaw/plugin-sdk/channel-outbound";
...
import type { RoutePeer } from "daisyclaw/plugin-sdk/routing";
import {
...
const telegramMessageAdapter = createChannelMessageAdapterFromOutbound<DaisyClawConfig>({
  id: "telegram",
  live: {
    capabilities: {
      draftPreview: true,
...
function resolveTelegramNativeTopicThreadId(
  ...
  // Keep the chat-scoped canonical id inside DaisyClaw state; translate it back
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as DaisyClawConfig;
