...
import { resolveApprovalApprovers } from "daisyclaw/plugin-sdk/approval-auth-runtime";
import {
...
import { resolveApprovalRequestChannelAccountId } from "daisyclaw/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "daisyclaw/plugin-sdk/approval-runtime";
import type { DaisyClawConfig } from "daisyclaw/plugin-sdk/config-contracts";
import type { TelegramExecApprovalConfig } from "daisyclaw/plugin-sdk/config-contracts";
...
function resolveTelegramOwnerApprovers(cfg: DaisyClawConfig): Array<string | number> {
