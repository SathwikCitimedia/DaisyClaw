...
import { resolveAgentMaxConcurrent } from "daisyclaw/plugin-sdk/model-session-runtime";
...
export function createTelegramRunnerOptions(cfg: DaisyClawConfig): RunOptions<unknown> {
  return {
    sink: {
