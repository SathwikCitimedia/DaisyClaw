...
import { isTruthyEnvValue, isWSL2Sync } from "daisyclaw/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "daisyclaw/plugin-sdk/string-coerce-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "DAISYCLAW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "DAISYCLAW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "DAISYCLAW_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable DAISYCLAW_TELEGRAM_DNS_RESULT_ORDER
