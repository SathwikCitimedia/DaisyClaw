...
const TELEGRAM_GET_UPDATES_CONFLICT_HINT =
  " Another DaisyClaw gateway, script, or Telegram poller may be using this bot token; stop the duplicate poller or switch this account to webhook mode.";
...
const TELEGRAM_SPOOLED_HANDLER_TIMEOUT_ENV = "DAISYCLAW_TELEGRAM_SPOOLED_HANDLER_TIMEOUT_MS";
...
export class TelegramPollingSession {
  ...
  async runUntilAbort(): Promise<void> {
    ...
    try {
      ...
      // leak to api.telegram.org; see daisyclaw#68128.
