...
import type { ChannelSetupAdapter } from "daisyclaw/plugin-sdk/setup-runtime";
import {
...
export function getTelegramTokenHelpLines(): string[] {
  return [
    ...
    t("wizard.telegram.website", { url: "https://daisyclaw.ai" }),
  ];
}
...
export function getTelegramUserIdHelpLines(): string[] {
  return [
    t("wizard.telegram.userIdHelpLogs", {
      command: formatCliCommand("daisyclaw logs --follow"),
    }),
