...
import { resolveNormalizedAccountEntry } from "daisyclaw/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "daisyclaw/plugin-sdk/channel-core";
import { getChatChannelMeta } from "daisyclaw/plugin-sdk/channel-plugin-common";
import type { DaisyClawConfig, TelegramAccountConfig } from "daisyclaw/plugin-sdk/config-contracts";
 ...
 *
 * See: https://github.com/daisyclaw/daisyclaw/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: DaisyClawConfig, accountId: string): boolean {
