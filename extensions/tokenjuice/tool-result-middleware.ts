...
} from "daisyclaw/plugin-sdk/agent-harness";
import { createTokenjuiceDaisyClawEmbeddedExtension } from "./runtime-api.js";

type TokenjuiceToolResultHandler = (
  event: {
    toolName: string;
    input: Record<string, unknown>;
    content: DaisyClawAgentToolResult["content"];
    details: unknown;
    isError?: boolean;
  },
  ctx: { cwd: string },
) => Promise<Partial<DaisyClawAgentToolResult> | void> | Partial<DaisyClawAgentToolResult> | void;
