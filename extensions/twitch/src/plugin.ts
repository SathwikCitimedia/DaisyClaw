/**
 * Twitch channel plugin for DaisyClaw.
 *
...
} from "daisyclaw/plugin-sdk/channel-pairing";
...
} from "daisyclaw/plugin-sdk/extension-shared";
import {
 ...
 * for DaisyClaw. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<ResolvedTwitchAccount> =
  createChatChannelPlugin<ResolvedTwitchAccount>({
    ...
    base: {
      ...
      config: {
        listAccountIds: (cfg: DaisyClawConfig): string[] => listAccountIds(cfg),
        resolveAccount: (cfg: DaisyClawConfig, accountId?: string | null): ResolvedTwitchAccount => {
        ...
        defaultAccountId: (cfg: DaisyClawConfig): string => resolveDefaultTwitchAccountId(cfg),
        isConfigured: (_account: unknown, cfg: DaisyClawConfig): boolean =>
      ...
      resolver: {
        resolveTargets: async ({
          ...
          runtime: import("daisyclaw/plugin-sdk/runtime-env").RuntimeEnv;
