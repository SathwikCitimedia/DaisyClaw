...
function applyVercelAiGatewayProviderConfig(cfg: DaisyClawConfig): DaisyClawConfig {
...
export function applyVercelAiGatewayConfig(cfg: DaisyClawConfig): DaisyClawConfig {
