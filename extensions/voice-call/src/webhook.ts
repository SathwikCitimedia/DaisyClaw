...
import { resolveConfiguredCapabilityProvider } from "daisyclaw/plugin-sdk/provider-selection-runtime";
import type { TalkEvent } from "daisyclaw/plugin-sdk/realtime-voice";
import {
...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: DaisyClawConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as DaisyClawConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as DaisyClawConfig),
    ...
    const streamConfig: MediaStreamConfig = {
      ...
      providerConfig,
      cfg: this.fullConfig ?? (this.coreConfig as DaisyClawConfig | null) ?? undefined,
