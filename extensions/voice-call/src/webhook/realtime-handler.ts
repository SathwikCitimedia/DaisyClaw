...
const FORCED_CONSULT_REASON = "provider_final_transcript_without_daisyclaw_agent_consult";
...
function buildForcedConsultSpeechPrompt(result: string): string {
  ...
  return [
    "Internal DaisyClaw consult result is ready.",
...
export class RealtimeCallHandler {
  ...
  constructor(
    ...
    private readonly coreConfig?: DaisyClawConfig,
  ) {}
