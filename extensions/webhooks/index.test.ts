...
function createApi(params?: {
  pluginConfig?: DaisyClawPluginApi["pluginConfig"];
  registerHttpRoute?: DaisyClawPluginApi["registerHttpRoute"];
  logger?: DaisyClawPluginApi["logger"];
}): DaisyClawPluginApi {
...
function requireFirstRouteRegistration(mock: ReturnType<typeof vi.fn>) {
  ...
  return call[0] as Parameters<DaisyClawPluginApi["registerHttpRoute"]>[0];
}
