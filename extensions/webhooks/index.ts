// Webhooks plugin entrypoint registers its DaisyClaw integration.
...
function registerWebhookRoutes(api: DaisyClawPluginApi): void {
...
export default definePluginEntry({
  ...
  name: "Webhooks",
  description:
    "Authenticated inbound webhooks that bind external automation to DaisyClaw TaskFlows.",
