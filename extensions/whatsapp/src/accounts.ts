...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "daisyclaw/plugin-sdk/config-contracts";
import { resolveOAuthDir } from "daisyclaw/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: DaisyClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: DaisyClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: DaisyClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: DaisyClawConfig): ResolvedWhatsAppAccount[] {
