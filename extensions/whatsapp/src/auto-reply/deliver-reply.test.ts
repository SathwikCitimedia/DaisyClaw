...
import { sleep } from "daisyclaw/plugin-sdk/text-utility-runtime";
...
vi.mock("daisyclaw/plugin-sdk/text-utility-runtime", async () => {
  const actual = await vi.importActual<typeof import("daisyclaw/plugin-sdk/text-utility-runtime")>(
    "daisyclaw/plugin-sdk/text-utility-runtime",
  );
  return {
    ...actual,
    sleep: vi.fn(async () => {}),
