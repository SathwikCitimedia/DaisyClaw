...
vi.mock("daisyclaw/plugin-sdk/gateway-runtime", async () => {
  const actual = await vi.importActual<typeof import("daisyclaw/plugin-sdk/gateway-runtime")>(
    "daisyclaw/plugin-sdk/gateway-runtime",
  );
  return {
    ...actual,
...
vi.mock("daisyclaw/plugin-sdk/runtime-config-snapshot", () => ({
