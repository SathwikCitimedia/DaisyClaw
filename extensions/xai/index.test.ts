...
vi.mock("daisyclaw/plugin-sdk/provider-auth-runtime", () => providerAuthRuntimeMocks);
...
type XaiAutoEnableProbe = Parameters<DaisyClawPluginApi["registerAutoEnableProbe"]>[0];
