// Xai plugin entrypoint registers its DaisyClaw integration.
import { defineSingleProviderPluginEntry } from "daisyclaw/plugin-sdk/provider-entry";
import { OPENAI_COMPATIBLE_REPLAY_HOOKS } from "daisyclaw/plugin-sdk/provider-model-shared";
import { defaultToolStreamExtraParams } from "daisyclaw/plugin-sdk/provider-stream-shared";
import { jsonResult } from "daisyclaw/plugin-sdk/provider-web-search";
import {
      ...
      run: async (ctx) => {
        ...
        try {
          const { resolveApiKeyForProvider } =
            await import("daisyclaw/plugin-sdk/provider-auth-runtime");
