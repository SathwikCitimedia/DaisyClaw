...
async function resolveXaiAudioApiKey(
  ...
  throw new Error(
    "xAI credentials missing for TTS. Sign in with `daisyclaw onboard --auth-choice xai-oauth`, or run `daisyclaw onboard --auth-choice xai-api-key`, or set XAI_API_KEY.",
  );
}
