...
function readLegacyGrokFallbackAuth(cfg?: DaisyClawConfig): XaiFallbackAuth | undefined {
...
function readLegacyGrokApiKeyResult(cfg?: DaisyClawConfig): ConfiguredRuntimeApiKeyResolution {
  const search = cfg?.tools?.web?.search;
  if (!search || typeof search !== "object") {
    return { status: "missing" };
  }
...
export function resolveFallbackXaiAuth(cfg?: DaisyClawConfig): XaiFallbackAuth | undefined {
...
export function resolveFallbackXaiApiKey(cfg?: DaisyClawConfig): string | undefined {
