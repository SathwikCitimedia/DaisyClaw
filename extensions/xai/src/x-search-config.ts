...
function resolveLegacyXSearchConfig(config?: DaisyClawConfig): JsonRecord | undefined {
...
function resolvePluginXSearchConfig(config?: DaisyClawConfig): JsonRecord | undefined {
...
function resolveLegacyGrokWebSearchConfig(config?: DaisyClawConfig): JsonRecord | undefined {
  const web = config?.tools?.web as Record<string, unknown> | undefined;
...
function resolvePluginWebSearchConfig(config?: DaisyClawConfig): JsonRecord | undefined {
  const pluginConfig = config?.plugins?.entries?.xai?.config;
...
export function resolveEffectiveXSearchConfig(config?: DaisyClawConfig): JsonRecord | undefined {
