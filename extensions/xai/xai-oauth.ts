...
import type { ProviderAuthContext, ProviderAuthMethod } from "daisyclaw/plugin-sdk/plugin-entry";
import {
...
import { waitForLocalOAuthCallback } from "daisyclaw/plugin-sdk/provider-auth-runtime";
...
export function buildXaiOAuthAuthorizeUrl(params: {
  ...
  url.searchParams.set("referrer", "daisyclaw");
  return url.toString();
}
  ...
  try {
    ...
    return buildOauthProviderAuthResult({
      ...
      notes: [
        ...
        "xAI may label the consent app as Grok Build because DaisyClaw uses xAI's shared OAuth client.",
      ],
    });
  } catch (err) {
