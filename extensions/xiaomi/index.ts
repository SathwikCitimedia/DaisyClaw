// Xiaomi plugin entrypoint registers its DaisyClaw integration.
...
import {
  ...
  validateApiKeyInput,
} from "daisyclaw/plugin-sdk/provider-auth-api-key";
import {
  applyModelCompatPatch,
  buildProviderReplayFamilyHooks,
} from "daisyclaw/plugin-sdk/provider-model-shared";
import { PROVIDER_LABELS } from "daisyclaw/plugin-sdk/provider-usage";
import {
  applyXiaomiConfig,
...
async function runXiaomiApiKeyAuth(
  ...
  params: {
    ...
    expectedKind: "payg" | "token-plan";
    defaultModel: string;
    applyConfig: (cfg: DaisyClawConfig) => DaisyClawConfig;
  },
