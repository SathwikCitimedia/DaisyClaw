...
function mergeZaloAccountConfig(cfg: DaisyClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: DaisyClawConfig): ResolvedZaloAccount[] {
