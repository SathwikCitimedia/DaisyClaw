...
function mergeZalouserAccountConfig(cfg: DaisyClawConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: DaisyClawConfig; accountId?: string | null }) {
