...
function ensureZalouserPluginEnabled(cfg: DaisyClawConfig): DaisyClawConfig {
      ...
      await prompter.note(
        [
          ...
          t("wizard.zalouser.peersLookupTip", {
            command: formatCliCommand("daisyclaw directory peers list --channel zalouser"),
          }),
        ].join("\n"),
        ...
        await prompter.note(
          [
            ...
            t("wizard.zalouser.groupsLookupTip", {
              command: formatCliCommand("daisyclaw directory groups list --channel zalouser"),
            }),
