...
import { stringEnum } from "daisyclaw/plugin-sdk/channel-actions";
import type { AnyAgentTool, DaisyClawPluginToolContext } from "daisyclaw/plugin-sdk/core";
...
type ZalouserToolContext = Pick<DaisyClawPluginToolContext, "deliveryContext">;
