...
/** Provider API families with first-class request/stream adapters in DaisyClaw. */
...
/** Image-generation API families with first-class adapters in DaisyClaw. */
...
/** Image provider ids with first-class adapters in DaisyClaw. */
...
export interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps DaisyClaw thinking levels to provider/model-specific values.
