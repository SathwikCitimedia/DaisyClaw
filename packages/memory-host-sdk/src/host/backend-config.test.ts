...
import type { DaisyClawConfig } from "./config-utils.js";
...
const rootMemoryConfig = (workspaceDir: string): DaisyClawConfig =>
  ({
    agents: {
...
describe("resolveMemoryBackendConfig", () => {
  it("defaults to builtin backend when config missing", () => {
    const cfg = { agents: { defaults: { workspace: "/tmp/memory-test" } } } as DaisyClawConfig;
