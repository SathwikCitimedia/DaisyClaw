...
const debugEmbeddings = isTruthyEnvValue(process.env.DAISYCLAW_DEBUG_MEMORY_EMBEDDINGS);

/** Write embedding debug metadata when DAISYCLAW_DEBUG_MEMORY_EMBEDDINGS is enabled. */
