...
import { createSubsystemLogger, redactSensitiveText } from "./daisyclaw-runtime-io.js";
import {
  HEARTBEAT_PROMPT,
  HEARTBEAT_TOKEN,
...
} from "./daisyclaw-runtime-session.js";
...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "daisyclaw:bootstrap-context:full" ||
    !candidate.data ||
...
/**
 * Strip DaisyClaw-injected inbound metadata envelopes from a raw text block.
 *
 ...
 * impossible.
 *
 * See: https://github.com/daisyclaw/daisyclaw/issues/63921
 */
