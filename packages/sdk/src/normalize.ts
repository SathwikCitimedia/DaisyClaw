// DaisyClaw SDK helper module supports normalize behavior.
import type { GatewayEvent, JsonObject, DaisyClawEvent, DaisyClawEventType } from "./types.js";
...
function normalizeLifecycleEndEventType(data: JsonObject): DaisyClawEventType {
...
function normalizeAgentEventType(payload: JsonObject): DaisyClawEventType {
...
function normalizeNamedEventType(event: GatewayEvent): DaisyClawEventType {
...
export function normalizeGatewayEvent(event: GatewayEvent): DaisyClawEvent {
  const payload = asRecord(event.payload);
