// DaisyClaw SDK module implements transport behavior.
import { GatewayClient } from "@daisyclaw/gateway-client";
...
/** Connectable SDK transport backed by @daisyclaw/gateway-client. */
export class GatewayClientTransport implements ConnectableDaisyClawTransport {
...
): transport is ConnectableDaisyClawTransport {
