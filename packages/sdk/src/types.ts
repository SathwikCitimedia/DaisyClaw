...
/** Minimal transport interface consumed by the DaisyClaw SDK client. */
export type DaisyClawTransport = {
  request<T = unknown>(
    method: string,
    params?: unknown,
...
export type ConnectableDaisyClawTransport = DaisyClawTransport & {
...
export type RuntimeSelection =
  | "auto"
  | { type: "embedded"; id: "daisyclaw" | "codex" | (string & {}) }
...
export type DaisyClawEventType =
  | "run.created"
  | "run.queued"
  | "run.started"
  | "run.completed"
...
export type DaisyClawEvent<TData = unknown> = {
  version: 1;
  id: string;
  ts: number;
  type: DaisyClawEventType;
  runId?: string;
  sessionId?: string;
  sessionKey?: string;
  taskId?: string;
