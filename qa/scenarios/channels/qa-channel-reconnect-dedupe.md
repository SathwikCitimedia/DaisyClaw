...
execution:
  ...
  config:
    firstPrompt: "@daisyclaw Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@daisyclaw Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
