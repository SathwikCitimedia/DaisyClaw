...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as DAISYCLAW_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                DAISYCLAW_OAUTH_DIR: path.join(stateDir, "credentials"),
                DAISYCLAW_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
