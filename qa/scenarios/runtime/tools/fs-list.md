...
successCriteria:
  - DaisyClaw may expose DaisyClaw read while Codex app-server mode may omit duplicate DaisyClaw dynamic read.
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: Codex app-server intentionally owns read natively; current DaisyClaw coding surface has no separate list tool.
    knownHarnessGap:
      issue: "#80312"
