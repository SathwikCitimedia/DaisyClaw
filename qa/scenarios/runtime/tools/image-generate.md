...
objective: Verify image_generate preserves arguments and result shape across DaisyClaw and Codex.
successCriteria:
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: image_generate is an DaisyClaw integration tool whose happy path yields for async completion, so standard direct call/result parity would compare different lifecycle phases.
