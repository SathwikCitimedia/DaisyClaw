...
objective: Verify sessions_spawn preserves arguments and result shape across DaisyClaw and Codex.
successCriteria:
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: sessions_spawn is an DaisyClaw integration tool and must stay visible and callable under DaisyClaw and Codex direct runtime parity.
