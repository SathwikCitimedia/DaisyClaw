...
coverage:
  primary:
    - tools.web-fetch
objective: Verify web_fetch preserves arguments and result shape across DaisyClaw and Codex.
successCriteria:
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: web_fetch is an DaisyClaw integration tool and must stay visible and callable under DaisyClaw and Codex direct runtime parity.
