...
coverage:
  primary:
    - tools.web-search
objective: Verify web_search preserves arguments and result shape across DaisyClaw and Codex.
successCriteria:
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: web_search is an DaisyClaw integration tool and must stay visible and callable under DaisyClaw and Codex direct runtime parity.
