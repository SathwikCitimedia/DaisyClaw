...
const pierreDiffsEmptySideEffectNamespace = "daisyclaw-diffs-empty-side-effect";
...
export function createPierreDiffsSideEffectImportPlugin() {
  return {
    name: "daisyclaw-diffs-pierre-side-effect-imports",
    setup(buildContext) {
  ...
  const result = await build({
    ...
    plugins: [
      ...
      ...(target.shikiAlias
        ? [
            {
              name: "daisyclaw-diffs-curated-shiki",
              setup(buildContext) {
