...
if [[ -z "$version_content" ]]; then
  echo "<h2>DaisyClaw $VERSION</h2>"
  echo "<p>Latest DaisyClaw update.</p>"
  echo "<p><a href=\"https://github.com/daisyclaw/daisyclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
