// Check Codex App Server Protocol script supports DaisyClaw repository automation.
...
async function main(): Promise<void> {
  ...
  console.log(
    `Codex app-server generated protocol matches DaisyClaw bridge assumptions: ${source.codexRepo}`,
  );
}
