  ...
  return {
    ...
    ...(qaState
      ? {
          ...
          DAISYCLAW_HOME: qaState.home,
          DAISYCLAW_STATE_DIR: qaState.stateDir,
          DAISYCLAW_CONFIG_PATH: qaState.configPath,
        }
      : {}),
    DAISYCLAW_BUILD_PRIVATE_QA: "1",
    DAISYCLAW_ENABLE_PRIVATE_QA_CLI: "1",
    DAISYCLAW_RUN_NODE_SKIP_DTS_BUILD: env.DAISYCLAW_RUN_NODE_SKIP_DTS_BUILD ?? "1",
    DAISYCLAW_TEST_DISABLE_UPDATE_CHECK: env.DAISYCLAW_TEST_DISABLE_UPDATE_CHECK ?? "1",
  };
}
