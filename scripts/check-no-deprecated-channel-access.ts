// Check No Deprecated Channel Access script supports DaisyClaw repository automation.
...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    pattern: /from\s+["']daisyclaw\/plugin-sdk\/group-access["']/u,
  },
  {
  ...
  },
  {
    ...
    pattern: /from\s+["']daisyclaw\/plugin-sdk\/command-auth["']/u,
  },
  {
