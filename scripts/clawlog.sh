...
show_usage() {
    cat << EOF
clawlog - DaisyClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View DaisyClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    DaisyClaw logs flow through the macOS unified log (subsystem: ai.daisyclaw).
