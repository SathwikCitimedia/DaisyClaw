// Control Ui I18N script supports DaisyClaw repository automation.
...
import { completeSimple, type AssistantMessage, type Model } from "daisyclaw/plugin-sdk/llm";
...
const ENV_PROVIDER = "DAISYCLAW_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "DAISYCLAW_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "DAISYCLAW_CONTROL_UI_I18N_THINKING";
const ENV_BATCH_CHAR_BUDGET = "DAISYCLAW_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "DAISYCLAW_CONTROL_UI_I18N_PROMPT_TIMEOUT";
const ENV_AUTH_OPTIONAL = "DAISYCLAW_CONTROL_UI_I18N_AUTH_OPTIONAL";
...
const DEFAULT_GLOSSARY: readonly GlossaryEntry[] = [
  { source: "DaisyClaw", target: "DaisyClaw" },
