...
// Summarizes DaisyClaw performance source fixtures for reports.
...
function printHelp() {
  console.log(`Usage: node scripts/daisyclaw-performance-source-summary.mjs --source-dir <dir> [--baseline-source-dir <dir>] [--output <summary.md>]

Summarizes DaisyClaw-native performance probe artifacts for CI reports.`);
}
