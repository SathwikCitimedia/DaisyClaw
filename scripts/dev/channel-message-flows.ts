...
// Channel Message Flows script supports DaisyClaw repository automation.
...
function createTelegramFlowApi(params: { accountId?: string; cfg: DaisyClawConfig }): Bot["api"] {
  return {
