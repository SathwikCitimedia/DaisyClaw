// Test Device Pair Telegram script supports DaisyClaw repository automation.
...
import { loadDaisyClawPlugins } from "../../src/plugins/loader.js";
...
type DevicePairTelegramDeps = {
  ...
  loadDaisyClawPlugins: typeof loadDaisyClawPlugins;
...
async function runDevicePairTelegram(
  ...
  deps.loadDaisyClawPlugins({ config: cfg });
