...
const (
	...
	envDocsI18nProvider      = "DAISYCLAW_DOCS_I18N_PROVIDER"
	envDocsI18nModel         = "DAISYCLAW_DOCS_I18N_MODEL"
...
func validateNoTranslationTranscriptArtifacts(source, translated string) error {
	...
	for _, token := range []string{"<daisyclaw_docs_i18n_input>", "</daisyclaw_docs_i18n_input>"} {
