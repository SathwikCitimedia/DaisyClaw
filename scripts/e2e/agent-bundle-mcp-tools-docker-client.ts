// DaisyClaw bundle MCP tools Docker harness.
...
server.tool("docker_probe", "Docker DaisyClaw MCP tool availability probe", async () => ({
...
async function main() {
  const tempState = await createE2eStateDir("daisyclaw-agent-bundle-mcp-");
