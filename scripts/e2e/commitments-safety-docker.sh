...
IMAGE_NAME="$(docker_e2e_resolve_image "daisyclaw-commitments-safety-e2e" DAISYCLAW_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="daisyclaw-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t daisyclaw-commitments-safety-log.XXXXXX)"
