...
IMAGE_NAME="$(docker_e2e_resolve_image "daisyclaw-crestodian-first-run-e2e" DAISYCLAW_CRESTODIAN_FIRST_RUN_E2E_IMAGE)"
CONTAINER_NAME="daisyclaw-crestodian-first-run-e2e-$$"
RUN_LOG="$(mktemp -t daisyclaw-crestodian-first-run-log.XXXXXX)"
...
DAISYCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-first-run empty)"
