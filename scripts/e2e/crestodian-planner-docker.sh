...
IMAGE_NAME="$(docker_e2e_resolve_image "daisyclaw-crestodian-planner-e2e" DAISYCLAW_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="daisyclaw-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t daisyclaw-crestodian-planner-log.XXXXXX)"
...
DAISYCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-planner empty)"
