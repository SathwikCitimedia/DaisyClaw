...
IMAGE_NAME="$(docker_e2e_resolve_image "daisyclaw-crestodian-rescue-e2e" DAISYCLAW_CRESTODIAN_RESCUE_E2E_IMAGE)"
CONTAINER_NAME="daisyclaw-crestodian-rescue-e2e-$$"
RUN_LOG="$(mktemp -t daisyclaw-crestodian-rescue-log.XXXXXX)"
...
DAISYCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-rescue empty)"
