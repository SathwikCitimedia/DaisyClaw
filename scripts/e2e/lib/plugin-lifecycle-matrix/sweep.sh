...
daisyclaw_e2e_install_package /tmp/daisyclaw-plugin-lifecycle-install.log "mounted DaisyClaw package" /tmp/npm-prefix
...
package_name="@daisyclaw/lifecycle-claw"
