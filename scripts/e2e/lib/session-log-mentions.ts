// Session Log Mentions script supports DaisyClaw repository automation.
...
export function readSessionLogMentionLimits(
  ...
  return {
    fileMaxBytes: readPositiveIntEnv(
      "DAISYCLAW_SESSION_LOG_MENTION_FILE_MAX_BYTES",
      DEFAULT_FILE_MAX_BYTES,
      env,
    ),
    totalMaxBytes: readPositiveIntEnv(
      "DAISYCLAW_SESSION_LOG_MENTION_TOTAL_MAX_BYTES",
