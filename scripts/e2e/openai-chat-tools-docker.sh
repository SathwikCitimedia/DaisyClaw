...
IMAGE_NAME="$(docker_e2e_resolve_image "daisyclaw-openai-chat-tools-e2e" DAISYCLAW_OPENAI_CHAT_TOOLS_E2E_IMAGE)"
SKIP_BUILD="${DAISYCLAW_OPENAI_CHAT_TOOLS_E2E_SKIP_BUILD:-0}"
PORT="${DAISYCLAW_OPENAI_CHAT_TOOLS_PORT:-18789}"
TOKEN="openai-chat-tools-e2e-$$"
PROFILE_FILE="${DAISYCLAW_OPENAI_CHAT_TOOLS_PROFILE_FILE:-${DAISYCLAW_TESTBOX_PROFILE_FILE:-$HOME/.daisyclaw-testbox-live.profile}}"
...
DAISYCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 openai-chat-tools empty)"
...
docker_e2e_run_logged_with_harness openai-chat-tools \
  ...
  -e "DAISYCLAW_OPENAI_CHAT_TOOLS_MODEL=${DAISYCLAW_OPENAI_CHAT_TOOLS_MODEL:-openai/gpt-5.4-mini}" \
  -e "DAISYCLAW_OPENAI_CHAT_TOOLS_TIMEOUT_SECONDS=${DAISYCLAW_OPENAI_CHAT_TOOLS_TIMEOUT_SECONDS:-180}" \
