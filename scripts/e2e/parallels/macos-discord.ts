// Macos Discord script supports DaisyClaw repository automation.
...
export class MacosDiscordSmoke {
  constructor(
    private input: {
      ...
      guest: MacosGuest;
      guestNode: string;
      guestDaisyClaw: string;
      guestDaisyClawEntry: string;
      runDir: string;
      vmName: string;
    },
  ) {}
...
${this.input.guestNode} ${this.input.guestDaisyClawEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestDaisyClawEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestDaisyClawEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestDaisyClawEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestDaisyClawEntry} doctor --fix --yes --non-interactive
...
JS
${this.input.guestNode} ${this.input.guestDaisyClawEntry} plugins enable discord
${this.input.guestNode} ${this.input.guestDaisyClawEntry} gateway restart
${this.input.guestNode} ${this.input.guestDaisyClawEntry} channels status --probe --json`);
  }
