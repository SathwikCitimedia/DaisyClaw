...
IMAGE_NAME="$(docker_e2e_resolve_image "daisyclaw-session-runtime-context-e2e" DAISYCLAW_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="daisyclaw-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t daisyclaw-session-runtime-context-log.XXXXXX)"
