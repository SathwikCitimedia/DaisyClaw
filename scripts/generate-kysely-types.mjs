...
const SCHEMAS = [
  {
    name: "daisyclaw-state",
    schema: "src/state/daisyclaw-state-schema.sql",
    outFile: "src/state/daisyclaw-state-db.generated.d.ts",
    schemaOutFile: "src/state/daisyclaw-state-schema.generated.ts",
    schemaExport: "DAISYCLAW_STATE_SCHEMA_SQL",
  },
  {
    name: "daisyclaw-agent",
    schema: "src/state/daisyclaw-agent-schema.sql",
    outFile: "src/state/daisyclaw-agent-db.generated.d.ts",
    schemaOutFile: "src/state/daisyclaw-agent-schema.generated.ts",
    schemaExport: "DAISYCLAW_AGENT_SCHEMA_SQL",
  },
];
