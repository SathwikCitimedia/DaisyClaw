...
const CLAWSWEEPER_BOT_LOGINS = new Set(["clawsweeper[bot]", "daisyclaw-clawsweeper[bot]"]);
...
const liveCommandRegex =
  /\b(?:daisyclaw|node|docker|curl|gh|ssh|adb|xcrun|xcodebuild|open|npm\s+run|pnpm\s+daisyclaw)\b/i;
