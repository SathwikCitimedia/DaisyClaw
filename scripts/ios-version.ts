// Ios Version script supports DaisyClaw repository automation.
...
if (options.format === "shell") {
  process.stdout.write(
    [
      `DAISYCLAW_IOS_VERSION=${version.canonicalVersion}`,
      `DAISYCLAW_MARKETING_VERSION=${version.marketingVersion}`,
      `DAISYCLAW_BUILD_VERSION=${version.buildVersion}`,
    ].join("\n") + "\n",
  );
} else {
