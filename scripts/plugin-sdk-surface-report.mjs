...
try {
  budgets = {
    publicEntrypoints: readBudgetEnv("DAISYCLAW_PLUGIN_SDK_MAX_PUBLIC_ENTRYPOINTS", 308),
    publicExports: readBudgetEnv("DAISYCLAW_PLUGIN_SDK_MAX_PUBLIC_EXPORTS", 9920),
    publicFunctionExports: readBudgetEnv("DAISYCLAW_PLUGIN_SDK_MAX_PUBLIC_FUNCTION_EXPORTS", 5031),
    publicDeprecatedExports: readBudgetEnv(
      "DAISYCLAW_PLUGIN_SDK_MAX_PUBLIC_DEPRECATED_EXPORTS",
      3143,
    ),
    publicWildcardReexports: readBudgetEnv(
      "DAISYCLAW_PLUGIN_SDK_MAX_PUBLIC_WILDCARD_REEXPORTS",
      215,
    ),
  };
} catch (error) {
