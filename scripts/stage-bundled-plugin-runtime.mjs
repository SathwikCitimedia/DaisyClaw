...
function ensureDaisyClawExtensionAlias(params) {
  ...
  const aliasDir = path.join(params.distExtensionsRoot, "node_modules", "daisyclaw");
...
function shouldCopyRuntimeFile(relativePath) {
  return (
    ...
    isPathOrNestedPath(relativePath, "daisyclaw.plugin.json") ||
...
export function stageBundledPluginRuntime(params = {}) {
  ...
  ensureDaisyClawExtensionAlias({ repoRoot, distExtensionsRoot });
