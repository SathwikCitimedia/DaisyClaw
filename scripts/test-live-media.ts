...
// Test Live Media script supports DaisyClaw repository automation.
...
export const MEDIA_SUITES: Record<MediaSuiteId, MediaSuiteConfig> = {
  image: {
    ...
    providerEnvVar: "DAISYCLAW_LIVE_IMAGE_GENERATION_PROVIDERS",
  ...
  music: {
    ...
    providerEnvVar: "DAISYCLAW_LIVE_MUSIC_GENERATION_PROVIDERS",
    providers: ["fal", "google", "minimax", "openrouter"],
  },
  video: {
    id: "video",
    testFile: "extensions/video-generation-providers.live.test.ts",
    providerEnvVar: "DAISYCLAW_LIVE_VIDEO_GENERATION_PROVIDERS",
    providers: [
      "alibaba",
      "byteplus",
      "deepinfra",
