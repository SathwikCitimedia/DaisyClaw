...
`precise.yml` is DaisyClaw's shipped precise OpenGrep rulepack. Each rule is tied
...
Some DaisyClaw paths are excluded by `.gitignore` for build reasons even though
