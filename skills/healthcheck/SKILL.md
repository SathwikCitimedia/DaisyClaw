---
name: healthcheck
description: "Audit/harden DaisyClaw hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# DaisyClaw host healthcheck
...
- Never claim DaisyClaw manages OS firewall, SSH, or updates.
...
- DaisyClaw gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `daisyclaw security audit --deep`.
