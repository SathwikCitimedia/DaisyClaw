...
metadata: { "daisyclaw": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- DaisyClaw CLI path: `node --inspect-brk daisyclaw.mjs ...`
- DaisyClaw test path: `DAISYCLAW_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
