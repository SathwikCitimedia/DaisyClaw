...
Set `OPENAI_API_KEY`, or configure it in the active DaisyClaw config file (`$DAISYCLAW_CONFIG_PATH`, default `~/.daisyclaw/daisyclaw.json`). Optionally set `OPENAI_BASE_URL`:
