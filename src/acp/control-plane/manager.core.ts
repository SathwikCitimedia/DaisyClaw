...
import type {
  ...
  AcpRuntimeHandle,
  AcpRuntimeStatus,
} from "@daisyclaw/acp-core/runtime/types";
...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: DaisyClawConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: DaisyClawConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: DaisyClawConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(cfg: DaisyClawConfig): Promise<void> {
