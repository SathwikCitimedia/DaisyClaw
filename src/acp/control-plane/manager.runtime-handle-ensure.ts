...
import type { AcpRuntime, AcpRuntimeHandle } from "@daisyclaw/acp-core/runtime/types";
...
export async function ensureManagerRuntimeHandle(params: {
  ...
  enforceConcurrentSessionLimit: (params: { cfg: DaisyClawConfig; sessionKey: string }) => void;
