...
import { normalizeText } from "@daisyclaw/acp-core/normalize-text";
...
export { normalizeText } from "@daisyclaw/acp-core/normalize-text";
...
export type ConfiguredAcpBindingSpec = {
  ...
  /** Owning DaisyClaw agent id (used for session identity/storage). */
  agentId: string;
