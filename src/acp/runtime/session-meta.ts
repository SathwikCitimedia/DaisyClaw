...
type AcpSessionsTable = DaisyClawStateKyselyDatabase["acp_sessions"];
type AcpSessionMetaDatabase = Pick<DaisyClawStateKyselyDatabase, "acp_sessions">;
...
}): { cfg: DaisyClawConfig; storePath: string } {
...
function selectAcpSessionRows(options: DaisyClawStateDatabaseOptions = {}): AcpSessionRow[] {
