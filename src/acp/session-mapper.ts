/** Resolves ACP request metadata into DaisyClaw Gateway session keys and reset behavior. */
import { readBool, readString } from "@daisyclaw/acp-core/meta";
import type { AcpServerOptions } from "@daisyclaw/acp-core/types";
...
/** Parses ACP request metadata into DaisyClaw session routing hints. */
