...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("daisyclaw.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: DaisyClawConfig): number {
