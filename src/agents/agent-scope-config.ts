...
export function listAgentEntries(cfg: DaisyClawConfig): AgentEntry[] {
...
export function listAgentIds(cfg: DaisyClawConfig): string[] {
...
export function resolveDefaultAgentId(cfg: DaisyClawConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: DaisyClawConfig, agentId: string): AgentEntry | undefined {
