...
function findMutableAgentEntry(cfg: DaisyClawConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: DaisyClawConfig, agentId: string): string | undefined {
