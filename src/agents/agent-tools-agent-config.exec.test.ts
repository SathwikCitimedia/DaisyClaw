...
function requireExecTool(tools: ReturnType<typeof createDaisyClawCodingTools>) {
...
describe("Agent-specific exec tool defaults", () => {
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const mainTools = createDaisyClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const helperTools = createDaisyClawCodingTools({
      config: cfg,
