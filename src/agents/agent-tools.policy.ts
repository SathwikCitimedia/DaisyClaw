...
export function resolveSubagentToolPolicy(cfg?: DaisyClawConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: DaisyClawConfig["tools"]): string[] | undefined {
...
function detectImplicitProfileGrants(params: {
  globalTools?: DaisyClawConfig["tools"];
