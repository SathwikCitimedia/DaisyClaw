...
function readCodeModeRawConfig(config?: DaisyClawConfig, agentId?: string): Record<string, unknown> {
...
export function resolveCodeModeConfig(config?: DaisyClawConfig, agentId?: string): CodeModeConfig {
...
export function createCodeModeTools(ctx: CodeModeToolContext): AnyAgentTool[] {
  ...
  const waitTool = markCodeModeControlTool({
    ...
    label: "wait",
    description: "Resume a suspended DaisyClaw code mode run returned by exec.",
    parameters: Type.Object({
