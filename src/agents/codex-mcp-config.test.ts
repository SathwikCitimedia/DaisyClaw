// Covers conversion from DaisyClaw bundle-MCP config into Codex app-server
...
describe("buildCodexMcpServersConfig", () => {
  it("normalizes DaisyClaw MCP servers into Codex app-server mcp_servers shape", () => {
    ...
    expect(
      ...
      daisyclaw: {
        ...
        bearer_token_env_var: "DAISYCLAW_MCP_TOKEN",
        http_headers: {
          "x-static": "static-value",
        },
        env_http_headers: {
