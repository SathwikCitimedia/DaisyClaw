 ...
 */
import type { AcpRuntimeEvent } from "@daisyclaw/acp-core/runtime/types";
...
export function runAgentAttempt(params: {
  ...
  const requestedAgentHarnessId = isRawModelRun ? "daisyclaw" : undefined;
  ...
  const agentHarnessPolicy = isRawModelRun
    ? ({ runtime: "daisyclaw", runtimeSource: "model" } as const)
  ...
  const embeddedAgentHarnessOverride =
    ...
    (agentHarnessPolicy.runtime === "daisyclaw" && agentHarnessPolicy.runtimeSource !== "implicit"
      ? "daisyclaw"
      : undefined);
