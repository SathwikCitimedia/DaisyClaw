...
import { DAISYCLAW_AGENT_RUNTIME_ID } from "../agent-runtime-id.js";
...
type CliCompactionDeps = {
  ...
  resolveContextEngine: (cfg: DaisyClawConfig) => Promise<ContextEngine>;
...
function isNativeHarnessCompactionSession(
  ...
  if (!harnessId || normalizeOptionalAgentRuntimeId(harnessId) === DAISYCLAW_AGENT_RUNTIME_ID) {
    return false;
  }
