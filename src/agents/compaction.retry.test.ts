...
import * as agentSessions from "daisyclaw/plugin-sdk/agent-sessions";
import type { AssistantMessage, UserMessage } from "daisyclaw/plugin-sdk/llm";
import { afterEach, beforeEach, describe, expect, it, vi } from "vitest";
import { retryAsync } from "../infra/retry.js";

vi.mock("daisyclaw/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof agentSessions>("daisyclaw/plugin-sdk/agent-sessions");
  return {
    ...actual,
