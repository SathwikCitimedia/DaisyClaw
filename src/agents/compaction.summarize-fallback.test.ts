...
import type { UserMessage } from "daisyclaw/plugin-sdk/llm";
...
vi.mock("daisyclaw/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof import("daisyclaw/plugin-sdk/agent-sessions")>(
    "daisyclaw/plugin-sdk/agent-sessions",
  );
  return {
    ...actual,
