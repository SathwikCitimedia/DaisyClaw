...
export function getPackageDir(): string {
  ...
  const envDir = process.env.DAISYCLAW_PACKAGE_DIR;
  if (envDir) {
    if (envDir === "~") {
      return homedir();
    }
...
// =============================================================================
// App Config (from package.json daisyclawConfig)
// =============================================================================
...
const daisyClawConfigName: string | undefined = pkg.daisyclawConfig?.name;
export const APP_NAME: string = daisyClawConfigName || "daisyclaw";
export const CONFIG_DIR_NAME: string = pkg.daisyclawConfig?.configDir || ".daisyclaw";
...
// =============================================================================
// User Config Paths (~/.daisyclaw/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.daisyclaw/agent/) */
