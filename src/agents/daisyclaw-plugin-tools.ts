/**
 * DaisyClaw plugin tool resolver.
 *
...
import {
  resolveDaisyClawPluginToolInputs,
  type DaisyClawPluginToolOptions,
} from "./daisyclaw-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveDaisyClawPluginToolsOptions = DaisyClawPluginToolOptions & {
...
export function resolveDaisyClawPluginToolsForOptions(params: {
  options?: ResolveDaisyClawPluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveDaisyClawPluginToolInputs({
