/**
 * Runtime context resolver for DaisyClaw plugin tools.
 *
...
/** Options provided by agent runtime callers when invoking DaisyClaw plugin tools. */
...
export function resolveDaisyClawPluginToolInputs(params: {
  options?: DaisyClawPluginToolOptions;
