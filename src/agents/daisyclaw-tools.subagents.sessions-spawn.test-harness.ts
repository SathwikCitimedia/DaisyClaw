...
type CreateDaisyClawToolsOpts = Parameters<CreateSessionsSpawnTool>[0];
...
export async function getSessionsSpawnTool(opts: CreateDaisyClawToolsOpts) {
...
vi.mock("../config/sessions.js", () => ({
  ...
  resolveStorePath: () => "/tmp/daisyclaw-sessions-spawn-test-store.json",
