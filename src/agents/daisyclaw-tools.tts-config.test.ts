// Verifies createDaisyClawTools wires shared config and context into the TTS tool.
import { beforeEach, describe, expect, it, vi } from "vitest";
import type { DaisyClawConfig } from "../config/types.daisyclaw.js";
import { testing, createDaisyClawTools } from "./daisyclaw-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/daisyclaw/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./daisyclaw-plugin-tools.js", () => ({
  resolveDaisyClawPluginToolsForOptions: () => [],
}));

vi.mock("./daisyclaw-tools.nodes-workspace-guard.js", () => ({
...
describe("createDaisyClawTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createDaisyClawTools media generation session wiring", () => {
  beforeEach(() => {
    mocks.createImageGenerateToolOptions.mockClear();
    mocks.createMusicGenerateToolOptions.mockClear();
    mocks.createVideoGenerateToolOptions.mockClear();
...
describe("createDaisyClawTools session status route context wiring", () => {
  beforeEach(() => {
...
describe("createDaisyClawTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
