 ...
 * pairs directly into the provider payload, so DaisyClaw must normalize here.
 */
 ...
 *
 * DaisyClaw persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata
