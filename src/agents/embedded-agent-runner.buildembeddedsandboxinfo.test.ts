...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  ...
  const base = {
    ...
    workspaceDir: "/tmp/daisyclaw-sandbox",
    agentWorkspaceDir: "/tmp/daisyclaw-workspace",
    workspaceAccess: "none",
    runtimeId: "daisyclaw-sbx-test",
    runtimeLabel: "daisyclaw-sbx-test",
    containerName: "daisyclaw-sbx-test",
    ...
    browser: {
      ...
      containerName: "daisyclaw-sbx-browser-test",
    },
