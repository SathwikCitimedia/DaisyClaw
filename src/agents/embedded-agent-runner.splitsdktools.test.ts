...
describe("splitSdkTools", () => {
  ...
  it("keeps DaisyClaw-managed custom tools in DaisyClaw runtime's session allowlist", () => {
    // Session tools are DaisyClaw-managed custom tools; dropping them from the
