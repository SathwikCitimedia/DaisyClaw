...
export const resolveAgentHarnessPolicyMock = vi.fn(() => ({ runtime: "daisyclaw" }));
...
export const createDaisyClawCodingToolsMock = vi.fn(() => []);
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureDaisyClawModelsJson: vi.fn(async () => {}),
  }));
