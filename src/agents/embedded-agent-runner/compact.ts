...
import { createDaisyClawCodingTools, resolveProcessToolScopeKey } from "../agent-tools.js";
...
async function compactEmbeddedAgentSessionDirectOnce(
  ...
  try {
    ...
    const toolsRaw = createDaisyClawCodingTools({
      exec: {
    ...
    const filteredBundledTools = applyFinalEffectiveToolPolicy({
      ...
      // createDaisyClawCodingTools(...) also omit it, so both paths resolve
    ...
    try {
      ...
      // exact DaisyClaw-managed registrations so custom tools survive startup.
