...
import { resolveTimestampMsToIsoString } from "@daisyclaw/normalization-core/number-coercion";
...
export function shouldRotateCompactionTranscript(config?: DaisyClawConfig): boolean {
