...
describe("extra-params: provider runtime handoff", () => {
  it("keeps unsupported upstream transport values out of DaisyClaw runtime hooks", () => {
    // Upstream transports can name modes DaisyClaw does not own; unresolved values
