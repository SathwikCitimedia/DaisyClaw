...
import { lowercasePreservingWhitespace } from "@daisyclaw/normalization-core/string-coerce";
      ...
      switch (params.provider) {
        ...
        case "vllm":
          return (
            ...
            'Set VLLM_API_KEY (any value works) or run "daisyclaw configure". ' +
            "See: https://docs.daisyclaw.ai/providers/vllm"
          );
        default:
          return undefined;
      }
