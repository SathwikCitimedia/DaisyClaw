...
vi.mock("../../plugins/manifest-metadata-scan.js", () => ({
  listDaisyClawPluginManifestMetadata: manifestMocks.listDaisyClawPluginManifestMetadata,
}));
...
function setManifestPlugins(plugins: unknown[]) {
  ...
  manifestMocks.listDaisyClawPluginManifestMetadata.mockReturnValue(
  ...
  manifestMocks.loadPluginManifest.mockImplementation((pluginDir: string) => {
    ...
    return plugin
      ...
      : { ok: false, error: "missing manifest", manifestPath: `${pluginDir}/daisyclaw.plugin.json` };
  });
}
...
beforeEach(() => {
  manifestMocks.listDaisyClawPluginManifestMetadata.mockReset();
