...
import { isTranscriptOnlyDaisyClawAssistantMessage } from "../../shared/transcript-only-daisyclaw-assistant.js";
import {
...
export function normalizeAssistantReplayContent(messages: AgentMessage[]): AgentMessage[] {
  ...
  for (const message of messages) {
    ...
    if (isTranscriptOnlyDaisyClawAssistantMessage(message)) {
