...
type AbortSettleTimeoutEnv = Partial<
  Pick<NodeJS.ProcessEnv, "DAISYCLAW_EMBEDDED_ABORT_SETTLE_TIMEOUT_MS" | "DAISYCLAW_TEST_FAST">
>;
...
export function resolveEmbeddedAbortSettleTimeoutMs(
  ...
  const override = parseStrictPositiveInteger(env.DAISYCLAW_EMBEDDED_ABORT_SETTLE_TIMEOUT_MS);
  if (override !== undefined) {
    return override;
  }
  return env.DAISYCLAW_TEST_FAST === "1" ? 250 : 2_000;
}
