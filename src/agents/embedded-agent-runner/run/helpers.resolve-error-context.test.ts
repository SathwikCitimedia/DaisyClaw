...
describe("resolveActiveErrorContext", () => {
  ...
  it("ignores the embedded DaisyClaw harness provider when the model provider is known", () => {
    // The DaisyClaw harness id is a transport wrapper, not the provider users
