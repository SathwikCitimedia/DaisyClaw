...
import {
  ...
  DAISYCLAW_RUNTIME_CONTEXT_CUSTOM_TYPE,
  DAISYCLAW_RUNTIME_CONTEXT_NOTICE,
  DAISYCLAW_RUNTIME_EVENT_HEADER,
} from "../../internal-runtime-context.js";
import type { CurrentInboundPromptContext } from "./params.js";
export { DAISYCLAW_RUNTIME_CONTEXT_CUSTOM_TYPE };

const DAISYCLAW_RUNTIME_EVENT_USER_PROMPT = "Continue the DaisyClaw runtime event.";
...
export function resolveRuntimeContextPromptParts(params: {
  ...
  if (!prompt.trim()) {
    return runtimeContext
      ? {
          prompt: DAISYCLAW_RUNTIME_EVENT_USER_PROMPT,
          ...(modelPromptText.trim() && modelPromptText !== DAISYCLAW_RUNTIME_EVENT_USER_PROMPT
            ? { modelPrompt: modelPromptText }
            : {}),
          runtimeContext,
          runtimeOnly: true,
...
export function buildRuntimeContextCustomMessage(
  ...
  return {
    role: "custom",
    customType: DAISYCLAW_RUNTIME_CONTEXT_CUSTOM_TYPE,
