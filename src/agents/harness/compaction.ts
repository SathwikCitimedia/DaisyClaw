 ...
 *
 * CLI runtimes and DaisyClaw-native compaction stay on the embedded runner path; plugin harnesses
  ...
  try {
    ...
    if (agentHarnessRuntimeOverride) {
      ...
      if (message.includes("does not support")) {
        ...
        // to native compaction preserves existing DaisyClaw behavior instead of failing rotation.
        return undefined;
      }
    }
    throw err;
