...
import { isDefaultAgentRuntimeId, DAISYCLAW_AGENT_RUNTIME_ID } from "../agent-runtime-id.js";
 ...
 *
 * Only cold-loadable runtimes live here; always-loaded core/daisyclaw runtimes should not trigger
...
function restrictiveAllowlistOmitsPlugin(config: DaisyClawConfig | undefined, pluginId: string) {
...
export async function ensureSelectedAgentHarnessPlugin(params: {
  ...
  if (
    ...
    runtime === DAISYCLAW_AGENT_RUNTIME_ID ||
