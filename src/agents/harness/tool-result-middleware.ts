...
type MiddlewareContentBlock = DaisyClawAgentToolResult["content"][number];
...
function isValidMiddlewareToolResult(value: unknown): value is DaisyClawAgentToolResult {
...
function coerceMiddlewareToolResult(
...
): DaisyClawAgentToolResult | undefined {
  ...
  const content: DaisyClawAgentToolResult["content"] = [];
 ...
 */
function sanitizeToolResultForMiddleware(result: DaisyClawAgentToolResult): DaisyClawAgentToolResult {
...
function buildMiddlewareFailureResult(): DaisyClawAgentToolResult {
  return {
    content: [
      {
        type: "text",
...
export function createAgentToolResultMiddlewareRunner(
  ...
  return {
    ...
    ): Promise<DaisyClawAgentToolResult> {
