 ...
 * streamable-HTTP SDK transports with DaisyClaw auth, redirect, and logging rules.
 */
import {
  SSEClientTransport,
...
import { DaisyClawStdioClientTransport } from "./mcp-stdio-transport.js";
...
function attachStderrLogging(serverName: string, transport: DaisyClawStdioClientTransport) {
...
export function resolveMcpTransport(
  ...
  if (resolved.kind === "stdio") {
    const transport = new DaisyClawStdioClientTransport({
