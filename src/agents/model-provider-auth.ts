...
const configFingerprintCache = new WeakMap<DaisyClawConfig, string>();
...
function resolveProviderAuthConfigFingerprint(cfg: DaisyClawConfig | undefined): string | null {
  if (!cfg) {
    return null;
  }
...
function collectProviderAuthWarmRuntimeAuthLookups(cfg: DaisyClawConfig): {
