...
function listModelAliasCandidates(cfg: DaisyClawConfig): ModelAliasCandidate[] {
...
export function hasConfiguredProviderModelRows(cfg: DaisyClawConfig): boolean {
...
export function parseConfiguredModelVisibilityEntries(params: { cfg?: DaisyClawConfig }): {
