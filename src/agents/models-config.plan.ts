...
type ModelsConfig = NonNullable<DaisyClawConfig["models"]>;
...
export async function planDaisyClawModelsJsonWithDeps(
  params: {
    cfg: DaisyClawConfig;
...
export async function planDaisyClawModelsJson(
  params: Parameters<typeof planDaisyClawModelsJsonWithDeps>[0],
): Promise<ModelsJsonPlan> {
  return planDaisyClawModelsJsonWithDeps(params);
}
