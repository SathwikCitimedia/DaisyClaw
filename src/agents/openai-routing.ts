...
function resolveOpenAIProviderConfig(config: DaisyClawConfig | undefined) {
...
function openAIProviderUsesCustomBaseUrl(config: DaisyClawConfig | undefined): boolean {
