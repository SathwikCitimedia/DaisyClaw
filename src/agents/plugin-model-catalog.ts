...
export const PLUGIN_MODEL_CATALOG_GENERATED_BY = "daisyclaw-plugin-model-catalog-v1";
...
/** Detects model catalogs generated by DaisyClaw rather than user-authored JSON. */
