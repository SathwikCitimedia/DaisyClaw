...
describe("provider attribution", () => {
  it("resolves the canonical DaisyClaw product and runtime version", () => {
  ...
  it("returns a documented NVIDIA attribution policy", () => {
    ...
    expect(policy).toEqual({
      ...
      version: "2026.3.22",
      headers: {
        "X-BILLING-INVOKE-ORIGIN": "DaisyClaw",
      },
    });
    expect(resolveProviderAttributionHeaders("NVIDIA", { DAISYCLAW_VERSION: "2026.3.22" })).toEqual({
      "X-BILLING-INVOKE-ORIGIN": "DaisyClaw",
    });
  });
  ...
  it("returns a hidden-spec OpenAI attribution policy", () => {
    expect(resolveProviderAttributionPolicy("openai", { DAISYCLAW_VERSION: "2026.3.22" })).toEqual({
      provider: "openai",
      enabledByDefault: true,
    ...
    expect(resolveProviderAttributionHeaders("openai", { DAISYCLAW_VERSION: "2026.3.22" })).toEqual({
      originator: "daisyclaw",
      version: "2026.3.22",
      "User-Agent": "daisyclaw/2026.3.22",
    });
  ...
  it("returns a hidden-spec xAI attribution policy", () => {
    expect(resolveProviderAttributionPolicy("xai", { DAISYCLAW_VERSION: "2026.3.22" })).toEqual({
      provider: "xai",
      enabledByDefault: true,
      verification: "vendor-hidden-api-spec",
      hook: "request-headers",
    ...
    expect(resolveProviderAttributionHeaders("xai", { DAISYCLAW_VERSION: "2026.3.22" })).toEqual({
      originator: "daisyclaw",
      version: "2026.3.22",
      "User-Agent": "daisyclaw/2026.3.22",
    });
  ...
  it("lists the current attribution support matrix", () => {
    ...
    expect(
      listProviderAttributionPolicies({ DAISYCLAW_VERSION: "2026.3.22" }).map((policy) => [
        policy.provider,
