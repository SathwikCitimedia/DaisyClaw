...
export const AGENT_CLEANUP_STEP_TIMEOUT_ENV = "DAISYCLAW_AGENT_CLEANUP_TIMEOUT_MS";
export const TRAJECTORY_FLUSH_TIMEOUT_ENV = "DAISYCLAW_TRAJECTORY_FLUSH_TIMEOUT_MS";
...
export function resolveAgentCleanupStepTimeoutMs(params: {
  ...
  if (params.step === "daisyclaw-trajectory-flush") {
