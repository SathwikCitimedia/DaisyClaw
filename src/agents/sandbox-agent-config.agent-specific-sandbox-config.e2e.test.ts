...
async function resolveContext(config: DaisyClawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): DaisyClawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
