...
export const DEFAULT_SANDBOX_IMAGE = "daisyclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "daisyclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "daisyclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "daisyclaw-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "daisyclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "daisyclaw-sandbox-browser";
