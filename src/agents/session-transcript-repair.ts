...
const DEFAULT_MISSING_TOOL_RESULT_TEXT =
  "[daisyclaw] missing tool result in session history; inserted synthetic error result for transcript repair.";
const SYNTHETIC_MISSING_TOOL_RESULT_DETAIL_KEY = "daisyclawSyntheticMissingToolResult";
...
function makeMissingToolResult(params: {
  ...
  // explicit DaisyClaw diagnostic text unless the caller opts in.
  text?: string;
