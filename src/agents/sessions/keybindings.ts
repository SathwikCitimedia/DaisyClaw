 ...
 *
 * Wraps pi-tui keybindings with DaisyClaw-specific actions and per-agent overrides.
 */
...
/** DaisyClaw-specific key ids added to the shared pi-tui keybinding registry. */
...
/** Union of DaisyClaw-specific app key ids. */
...
/** Keybinding manager that loads DaisyClaw defaults plus optional user overrides. */
