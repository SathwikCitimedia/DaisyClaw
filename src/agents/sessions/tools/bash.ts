...
/**
 * Create bash operations using DaisyClaw runtime's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want DaisyClaw runtime's
...
export function createBashToolDefinition(
  ...
  return {
    ...
    async execute(
      ...
      const output = new OutputAccumulator({ tempFilePrefix: "daisyclaw-bash" });
