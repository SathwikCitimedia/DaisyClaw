...
let configOverride: DaisyClawConfig = {
  session: {
    mainKey: "main",
    scope: "per-sender",
  },
...
function setConfigOverride(next: DaisyClawConfig): void {
  configOverride = next;
...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/daisyclaw/daisyclaw/issues/31298
    previousFastTestEnv = process.env.DAISYCLAW_TEST_FAST;
  ...
  afterAll(() => {
    ...
    process.env.DAISYCLAW_TEST_FAST = previousFastTestEnv;
  });
  ...
  beforeEach(() => {
    vi.useRealTimers();
    // DAISYCLAW_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("DaisyClaw runtime context (internal):");
