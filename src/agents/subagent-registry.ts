...
const STALE_ACTIVE_SUBAGENT_GRACE_MS = process.env.DAISYCLAW_TEST_FAST === "1" ? 1_000 : 60_000;
...
function resolveSubagentWaitTimeoutMs(cfg: DaisyClawConfig, runTimeoutSeconds?: number) {
