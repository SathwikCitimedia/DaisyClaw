...
export function createAgentToolsSandboxContext(
  ...
  return {
    ...
    runtimeId: params.containerName ?? "daisyclaw-sbx-test",
    runtimeLabel: params.containerName ?? "daisyclaw-sbx-test",
    containerName: params.containerName ?? "daisyclaw-sbx-test",
