/**
 * Fast DaisyClaw tool-bundle mock.
 *
...
const createDaisyClawToolsMock = vi.fn(
  (options?: { enableHeartbeatTool?: boolean; recordToolPrepStage?: (name: string) => void }) => {
    options?.recordToolPrepStage?.("daisyclaw-tools:test-helper");
    return coreTools
...
vi.mock("../daisyclaw-tools.js", () => ({
  createDaisyClawTools: createDaisyClawToolsMock,
  testing: {
    setDepsForTest: () => {},
  },
}));
