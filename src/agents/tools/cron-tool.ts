...
Main cron => system events for heartbeat. Isolated cron => background task in \`daisyclaw tasks\`.
    ...
    execute: async (_toolCallId, args) => {
      ...
      switch (action) {
        ...
        case "add": {
          ...
          // See: https://github.com/daisyclaw/daisyclaw/issues/11310
        ...
        case "wake": {
          ...
          // upstream half of daisyclaw/daisyclaw#46886 (#64556 — agentId/
