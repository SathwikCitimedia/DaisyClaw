...
export function coerceImageModelConfig(cfg?: DaisyClawConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: DaisyClawConfig; ref: string }): string[] {
