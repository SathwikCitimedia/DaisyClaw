...
function hasExplicitDefaultPrimaryModel(cfg?: DaisyClawConfig): boolean {
...
function pickMaxBytes(cfg?: DaisyClawConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const providerCfg: DaisyClawConfig = effectiveCfg ?? {};
