...
type CreateDaisyClawTools = typeof import("../daisyclaw-tools.js").createDaisyClawTools;
...
let createDaisyClawTools: CreateDaisyClawTools;
...
const daisyClawToolsFactoryMocks = vi.hoisted(() => {
...
vi.mock("./agents-list-tool.js", () => ({
  createAgentsListTool: () => daisyClawToolsFactoryMocks.tool("agents"),
}));
vi.mock("./cron-tool.js", () => ({
  createCronTool: () => daisyClawToolsFactoryMocks.tool("cron"),
}));
vi.mock("./gateway-tool.js", () => ({
  createGatewayTool: () => daisyClawToolsFactoryMocks.tool("gateway"),
}));
vi.mock("./heartbeat-response-tool.js", () => ({
  createHeartbeatResponseTool: () => daisyClawToolsFactoryMocks.tool("heartbeat_response"),
}));
...
vi.mock("./nodes-tool.js", () => ({
  createNodesTool: () => daisyClawToolsFactoryMocks.tool("nodes"),
}));
vi.mock("./pdf-tool.js", () => ({
  createPdfTool: () => null,
}));
vi.mock("./session-status-tool.js", () => ({
  createSessionStatusTool: () => daisyClawToolsFactoryMocks.tool("session_status"),
}));
vi.mock("./sessions-history-tool.js", () => ({
  createSessionsHistoryTool: () => daisyClawToolsFactoryMocks.tool("sessions_history"),
}));
vi.mock("./sessions-list-tool.js", () => ({
  createSessionsListTool: () => daisyClawToolsFactoryMocks.tool("sessions_list"),
}));
vi.mock("./sessions-send-tool.js", () => ({
  createSessionsSendTool: () => daisyClawToolsFactoryMocks.tool("sessions_send"),
}));
vi.mock("./sessions-spawn-tool.js", () => ({
  createSessionsSpawnTool: () => daisyClawToolsFactoryMocks.tool("sessions_spawn"),
}));
vi.mock("./sessions-yield-tool.js", () => ({
  createSessionsYieldTool: () => daisyClawToolsFactoryMocks.tool("sessions_yield"),
}));
vi.mock("./subagents-tool.js", () => ({
  createSubagentsTool: () => daisyClawToolsFactoryMocks.tool("subagents"),
}));
vi.mock("./tts-tool.js", () => ({
  createTtsTool: () => daisyClawToolsFactoryMocks.tool("tts"),
}));
vi.mock("./update-plan-tool.js", () => ({
  createUpdatePlanTool: () => daisyClawToolsFactoryMocks.tool("update_plan"),
}));
vi.mock("./video-generate-tool.js", () => ({
  createVideoGenerateTool: () => null,
}));
vi.mock("./web-tools.js", () => ({
  createWebFetchTool: () => daisyClawToolsFactoryMocks.tool("web_fetch"),
  createWebSearchTool: () => daisyClawToolsFactoryMocks.tool("web_search"),
}));
...
beforeAll(async () => {
  ...
  ({ createDaisyClawTools } = await import("../daisyclaw-tools.js"));
});
...
describe("message tool secret scoping", () => {
  ...
  it("forwards source reply delivery mode through createDaisyClawTools", () => {
    const tool = createDaisyClawTools({
      config: {} as never,
      sourceReplyDeliveryMode: "message_tool_only",
...
describe("message tool agent routing", () => {
  ...
  it("forwards agentThreadId through createDaisyClawTools to the message tool", async () => {
    mockSendResult({ channel: "slack", to: "channel:C123" });
    const plugin = createChannelPlugin({
      id: "slack",
      label: "Slack",
