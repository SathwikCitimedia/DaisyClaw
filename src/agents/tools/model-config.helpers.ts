...
/** Resolves the configured default model ref, falling back to DaisyClaw defaults. */
export function resolveDefaultModelRef(cfg?: DaisyClawConfig): { provider: string; model: string } {
  if (cfg) {
