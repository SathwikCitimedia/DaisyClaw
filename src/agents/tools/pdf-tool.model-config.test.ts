...
const TEST_AGENT_DIR = "/tmp/daisyclaw-pdf-model-config";
...
vi.mock("./model-config.helpers.js", () => ({
  ...
  hasProviderAuthForTool: ({ provider, cfg }: { provider: string; cfg?: DaisyClawConfig }) => {
  ...
  resolveDefaultModelRef: (cfg?: DaisyClawConfig) => {
