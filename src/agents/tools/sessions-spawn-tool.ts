...
// Keep the schema local to avoid a circular import through acp-spawn/daisyclaw-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: DaisyClawConfig }) {
