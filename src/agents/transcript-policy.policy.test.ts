...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.DAISYCLAW_BUNDLED_PLUGINS_DIR;
  delete env.DAISYCLAW_SKIP_PROVIDERS;
  delete env.DAISYCLAW_SKIP_CHANNELS;
  delete env.DAISYCLAW_SKIP_CRON;
  delete env.DAISYCLAW_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
