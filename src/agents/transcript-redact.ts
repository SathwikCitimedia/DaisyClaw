...
} from "@daisyclaw/media-core/inline-image-data-url";
...
function redactTranscriptOptions(cfg?: DaisyClawConfig) {
...
function redactTranscriptText(value: string, cfg?: DaisyClawConfig): string {
...
export function redactTranscriptMessage(message: AgentMessage, cfg?: DaisyClawConfig): AgentMessage {
  if (cfg?.logging?.redactSensitive === "off") {
    return message;
  }
