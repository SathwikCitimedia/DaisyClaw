...
const WORKSPACE_STATE_DIRNAME = ".daisyclaw";
...
const WORKSPACE_ATTESTATION_HEADER = "daisyclaw-workspace-attestation:v1";
...
export class WorkspaceVanishedError extends Error {
  ...
  constructor(params: { workspaceDir: string; attestationPath: string }) {
    super(
      `DaisyClaw workspace appears to have disappeared after a recent initialization: ${params.workspaceDir}. ` +
