...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@daisyclaw", { botUsername: "daisyclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@daisyclaw args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "daisyclaw" })).toBe(
      "/help@otherbot",
    );
  });
