...
import { normalizeOptionalString as readString } from "@daisyclaw/normalization-core/string-coerce";
...
const HEARTBEAT_RESPONSE_CHANNEL_DATA_KEY = "daisyclawHeartbeatResponse";
