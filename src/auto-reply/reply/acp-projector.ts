// Projects ACP runtime events into DaisyClaw-visible session update records.
import type { AcpRuntimeEvent, AcpSessionUpdateTag } from "@daisyclaw/acp-core/runtime/types";
import {
