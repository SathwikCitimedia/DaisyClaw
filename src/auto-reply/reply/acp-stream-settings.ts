...
import type { AcpSessionUpdateTag } from "@daisyclaw/acp-core/runtime/types";
...
function resolveAcpStreamCoalesceIdleMs(cfg: DaisyClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: DaisyClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: DaisyClawConfig): AcpProjectionSettings {
