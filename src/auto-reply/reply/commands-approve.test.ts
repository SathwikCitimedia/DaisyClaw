...
function getDiscordExecApprovalApproversForTests(params: { cfg: DaisyClawConfig }): string[] {
...
function listConfiguredTelegramAccountIds(cfg: DaisyClawConfig): string[] {
