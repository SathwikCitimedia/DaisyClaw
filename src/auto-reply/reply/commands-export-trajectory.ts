...
import {
  buildCurrentDaisyClawCliArgv,
  buildCurrentDaisyClawCliCommand,
} from "./commands-daisyclaw-cli.js";
import {
...
const EXPORT_TRAJECTORY_DOCS_URL = "https://docs.daisyclaw.ai/tools/trajectory";
...
function buildTrajectoryExportExecRequest(
  ...
  return {
    argv: buildCurrentDaisyClawCliArgv(args),
    command: buildCurrentDaisyClawCliCommand(args),
    displayCommand: ["daisyclaw", ...args].join(" "),
    encodedRequest,
    request,
  };
}
