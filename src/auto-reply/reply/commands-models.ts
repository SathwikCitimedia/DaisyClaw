...
import { parseStrictPositiveInteger } from "@daisyclaw/normalization-core/number-coercion";
import {
...
function buildRuntimeChoice(params: {
  ...
  return {
    ...
    description:
      id === "daisyclaw"
        ? "Use the built-in DaisyClaw runtime."
        : params.cli
...
export async function buildModelsProviderData(
  ...
  for (const binding of runtimeBindings) {
    ...
    addRuntimeChoice(choices, buildRuntimeChoice({ cfg, provider, runtime: "daisyclaw" }));
    addRuntimeChoice(
      choices,
      buildRuntimeChoice({
        cfg,
