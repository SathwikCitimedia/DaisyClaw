// Bridges ACP transcript events into persisted DaisyClaw session transcripts.
import { resolveAcpSessionCwd } from "@daisyclaw/acp-core/runtime/session-identifiers";
