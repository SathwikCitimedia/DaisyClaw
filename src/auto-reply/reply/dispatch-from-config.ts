...
import { isParentOwnedBackgroundAcpSession } from "@daisyclaw/acp-core/session-interaction-mode";
import {
...
export async function dispatchReplyFromConfig(
  ...
  try {
    ...
    const replyConfig = withFullRuntimeReplyConfig(
      params.configOverride ? (applyMergePatch(cfg, params.configOverride) as DaisyClawConfig) : cfg,
    );
