...
import { type DaisyClawConfig, getRuntimeConfig } from "../../config/config.js";
...
function resolveHeartbeatAckMaxChars(cfg: DaisyClawConfig, agentId: string): number {
...
export async function getReplyFromConfig(
  ...
  const isFastTestEnv = process.env.DAISYCLAW_TEST_FAST === "1";
