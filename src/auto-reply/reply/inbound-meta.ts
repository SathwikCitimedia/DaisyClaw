...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "daisyclaw.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by DaisyClaw out-of-band. Treat it as authoritative metadata about the current message context.",
