...
const emptyCfg = {} as DaisyClawConfig;
...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as DaisyClawConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as DaisyClawConfig, "whatsapp", "default", "group")).toBe("all");
  });
});
