...
/**
 * @deprecated Use `LivePreviewFinalizerDraft` from `daisyclaw/plugin-sdk/channel-outbound`.
 */
export type DraftPreviewFinalizerDraft<TId> = LivePreviewFinalizerDraft<TId>;

/**
 * @deprecated Use `LivePreviewFinalizerResult` from `daisyclaw/plugin-sdk/channel-outbound`.
 */
...
/**
 * @deprecated Use `deliverFinalizableLivePreview` from `daisyclaw/plugin-sdk/channel-outbound`.
 */
