...
export type ChannelMessageSendTextContext<TConfig = DaisyClawConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = DaisyClawConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = DaisyClawConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendPollContext<TConfig = DaisyClawConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
export type ChannelMessageSendAttemptContext<TConfig = DaisyClawConfig> =
...
export type ChannelMessageSendFailureContext<TConfig = DaisyClawConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = DaisyClawConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
