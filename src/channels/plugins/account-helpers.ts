...
export function createAccountListHelpers(
  ...
  options?: {
    ...
    hasImplicitDefaultAccount?: (cfg: DaisyClawConfig) => boolean;
  },
) {
  function hasImplicitDefaultAccount(cfg: DaisyClawConfig): boolean {
  ...
  function resolveConfiguredDefaultAccountId(cfg: DaisyClawConfig): string | undefined {
    const channel = cfg.channels?.[channelKey] as Record<string, unknown> | undefined;
  ...
  function listAccountIds(cfg: DaisyClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: DaisyClawConfig): string {
