...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: DaisyClawConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: DaisyClawConfig }>(
  collector: WarningCollector<{ cfg: DaisyClawConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: DaisyClawConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: DaisyClawConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: DaisyClawConfig },
>(
  projectCfg: (cfg: DaisyClawConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: DaisyClawConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: DaisyClawConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: DaisyClawConfig },
>(params: {
  providerConfigPresent: (cfg: DaisyClawConfig) => boolean;
