 ...
 */
export function listChannelMessageActions(cfg: DaisyClawConfig): ChannelMessageActionName[] {
 ...
 */
export function listChannelMessageCapabilities(cfg: DaisyClawConfig): ChannelMessageCapability[] {
