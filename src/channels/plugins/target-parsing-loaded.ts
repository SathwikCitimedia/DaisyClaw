...
/** @deprecated Use `channelRouteTargetsMatchExact` from `daisyclaw/plugin-sdk/channel-route`. */
...
/** @deprecated Use `channelRouteTargetsShareConversation` from `daisyclaw/plugin-sdk/channel-route`. */
