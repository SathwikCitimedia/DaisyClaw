...
export type ChannelAgentToolFactory = (params: { cfg?: DaisyClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: DaisyClawConfig; accountId?: string | null }) => string[];
