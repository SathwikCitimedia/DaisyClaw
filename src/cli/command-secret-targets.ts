...
function resolveFetchConfig(config: DaisyClawConfig): Record<string, unknown> | undefined {
...
function resolveSearchConfig(config: DaisyClawConfig): Record<string, unknown> | undefined {
...
function getCapabilityWebSearchAutoDetectTargets(config: DaisyClawConfig): CommandSecretTargetScope {
...
function getCapabilityWebFetchAutoDetectTargets(config: DaisyClawConfig): CommandSecretTargetScope {
  return getCapabilityWebProviderAutoDetectTargets({
    config,
...
function isScopedChannelSecretTargetEntry(params: {
  ...
  return (
    ...
    params.entry.configFile === "daisyclaw.json" &&
...
type CapabilityWebCommandSecretTargetParams = {
  ...
  autoDetectTargets: (config: DaisyClawConfig) => CommandSecretTargetScope;
  selectedProviderTargetIds: (
    config: DaisyClawConfig,
    providerId?: string | null,
  ) => SelectedProviderTargetIds;
