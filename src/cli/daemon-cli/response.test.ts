...
describe("buildDaemonHintItems", () => {
  it("classifies common daemon hint kinds", () => {
    expect(
      ...
      { kind: "install", text: "daisyclaw gateway install" },
      {
        kind: "container-restart",
        text: "Restart the container or the service that manages it for daisyclaw-demo-container.",
      },
      {
      ...
      },
      {
        ...
        text: "If you're in a container, run the gateway in the foreground instead of `daisyclaw gateway`.",
      },
      {
        kind: "wsl-systemd",
