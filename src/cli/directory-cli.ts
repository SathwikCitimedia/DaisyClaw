    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["daisyclaw directory self --channel slack", "Show the connected account identity."],
          [
            'daisyclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["daisyclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "daisyclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.daisyclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
