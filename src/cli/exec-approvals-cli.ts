...
import { readBestEffortConfig, type DaisyClawConfig } from "../config/config.js";
...
export function registerExecApprovalsCli(program: Command) {
  ...
  const approvals = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/approvals", "docs.daisyclaw.ai/cli/approvals")}\n`,
    );
