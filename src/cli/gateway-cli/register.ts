      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["daisyclaw gateway run", "Run the gateway in the foreground."],
            ["daisyclaw gateway status", "Show service status plus connectivity/capability."],
            ["daisyclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["daisyclaw gateway stability", "Show recent stability diagnostics."],
            ["daisyclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.daisyclaw.ai/cli/gateway")}\n`,
      ),
  );
