...
function addInstalledPluginToAllowlist(cfg: DaisyClawConfig, pluginId: string): DaisyClawConfig {
...
function removeInstalledPluginFromDenylist(cfg: DaisyClawConfig, pluginId: string): DaisyClawConfig {
  ...
  params.runtime.log(
    theme.warn(
      [
        ...
        "Run `daisyclaw plugins doctor` for repair options.",
      ].join("\n"),
    ),
  );
}
