    ...
    plugins: [
      {
        ...
        startup: {},
        packageInstall: {
          clawhubSpec: `clawhub:@daisyclaw/${pluginId}`,
...
describe("listPersistedBundledPluginLocationBridges", () => {
  ...
  it("keeps persisted bundled relocations npm-first for launch", async () => {
    readPersistedInstalledPluginIndexMock.mockResolvedValue(
      makeIndex({
        ...
        manifestPath: "/app/dist/extensions/diagnostics-otel/daisyclaw.plugin.json",
        manifestHash: "hash",
        ...
        packageInstall: {
          ...
          npm: {
            spec: "@daisyclaw/diagnostics-otel",
            packageName: "@daisyclaw/diagnostics-otel",
            selectorKind: "none",
            exactVersion: false,
  ...
  it("does not create a relocation bridge without persisted or official install metadata", async () => {
    readPersistedInstalledPluginIndexMock.mockResolvedValue(
      makeIndex({
        pluginId: "local-only",
        manifestPath: "/app/dist/extensions/local-only/daisyclaw.plugin.json",
        manifestHash: "hash",
