...
/** Register `daisyclaw agent` for one Gateway-backed agent turn. */
...
${formatHelpExamples([
  ['daisyclaw agent --to +15555550123 --message "status update"', "Start a new session."],
  ['daisyclaw agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  ['daisyclaw agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.daisyclaw.ai/cli/agent")}`,
    )
