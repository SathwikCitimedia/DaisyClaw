...
export function registerAgentsCommands(program: Command): void {
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.daisyclaw.ai/cli/agents")}\n`,
    );
...
${formatHelpExamples([
  ['daisyclaw agents set-identity --agent main --name "DaisyClaw" --emoji "🌼"', "Set name + emoji."],
  ["daisyclaw agents set-identity --agent main --avatar avatars/daisyclaw.png", "Set avatar path."],
  [
    "daisyclaw agents set-identity --workspace ~/.daisyclaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "daisyclaw agents set-identity --identity-file ~/.daisyclaw/workspace/IDENTITY.md --agent main",
