    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["daisyclaw", "Start Crestodian."],
          ["daisyclaw crestodian", "Start Crestodian explicitly."],
          ['daisyclaw crestodian -m "status"', "Run one status request."],
          [
            'daisyclaw crestodian -m "set default model openai/gpt-5.2" --yes',
