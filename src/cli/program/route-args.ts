...
/** Parse `daisyclaw health` flags for the route-first status family. */
...
/** Parse `daisyclaw status` flags without registering the full command tree. */
...
/** Parse `daisyclaw gateway status` RPC-only flags accepted by the fast route. */
...
/** Parse `daisyclaw sessions` filters for JSON/list route execution. */
...
/** Parse `daisyclaw agents list` display switches for route-first execution. */
...
/** Parse `daisyclaw config get <path>` while preserving root option handling. */
...
/** Parse `daisyclaw config unset <path>` and its mutation guard flags. */
...
/** Parse `daisyclaw models list` filters for the lightweight model catalog route. */
...
/** Parse `daisyclaw models status` probe controls for the route-first status path. */
...
/** Parse `daisyclaw channels list` display flags for the route-first list path. */
...
/** Parse `daisyclaw channels status` probe flags without full CLI registration. */
...
/** Parse JSON-only `daisyclaw plugins list` flags for plugin inventory output. */
...
/** Parse both `daisyclaw tasks --json` and `daisyclaw tasks list --json` aliases. */
...
/** Parse JSON-only `daisyclaw tasks audit` filters for the route-first audit path. */
