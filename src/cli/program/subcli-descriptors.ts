...
const subCliCommandCatalog = defineCommandDescriptorCatalog([
  ...
  {
    name: "gateway",
    description: "Run, inspect, and query the DaisyClaw Gateway",
    hasSubcommands: true,
  },
  {
    name: "daemon",
  ...
  {
    name: "docs",
    description: "Search the live DaisyClaw docs",
    hasSubcommands: false,
  },
  {
    name: "qa",
  ...
  {
    name: "proxy",
    description: "Run the DaisyClaw debug proxy and inspect captured traffic",
    hasSubcommands: true,
  },
  {
    name: "hooks",
