...
const DEFAULT_TAGLINE = "All your chats, one DaisyClaw.";
...
const TAGLINES: string[] = [
  ...
  "Your AI workspace, fully yours—no subscriptions, no vendor lock-in, no excuses.",
  "Self-hosted intelligence: because your data deserves a better landlord.",
  ...
  "You had me at 'daisyclaw gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.DAISYCLAW_TAGLINE_INDEX;
