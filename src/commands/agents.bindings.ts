...
import { normalizeSortedUniqueStringEntries } from "@daisyclaw/normalization-core/string-normalization";
...
function resolveDefaultAccountId(cfg: DaisyClawConfig, provider: ChannelId): string {
...
function listManifestChannelIds(config: DaisyClawConfig): Set<string> {
  return new Set(
