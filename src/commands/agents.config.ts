// Agent config mutation and summary builders used by `daisyclaw agents` commands.
import {
...
function resolveAgentModel(cfg: DaisyClawConfig, agentId: string) {
...
export function buildAgentSummaries(cfg: DaisyClawConfig): AgentSummary[] {
