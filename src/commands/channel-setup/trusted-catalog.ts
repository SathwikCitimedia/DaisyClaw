...
function resolveEffectiveTrustConfig(cfg: DaisyClawConfig, env?: NodeJS.ProcessEnv): DaisyClawConfig {
...
function resolveTrustedCatalogExtraPaths(cfg: DaisyClawConfig): string[] | undefined {
