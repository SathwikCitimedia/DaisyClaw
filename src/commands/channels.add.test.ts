...
const channelWizardMocks = vi.hoisted(() => {
  ...
  return {
    prompter,
    setupChannels: vi.fn(async (...args: unknown[]) => args[0] as DaisyClawConfig),
  };
});
