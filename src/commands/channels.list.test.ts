...
describe("channels list", () => {
  ...
  it("default output shows configured official external channels when the plugin is missing", async () => {
    ...
    mocks.resolveMissingOfficialExternalChannelPluginRepairHint.mockReturnValue({
      ...
      channelId: "discord",
      label: "Discord",
      installSpec: "@daisyclaw/discord",
      installCommand: "daisyclaw plugins install @daisyclaw/discord",
      doctorFixCommand: "daisyclaw doctor --fix",
      repairHint:
        "Install the official external plugin with: daisyclaw plugins install @daisyclaw/discord, or run: daisyclaw doctor --fix.",
    });
    mocks.readConfigFileSnapshot.mockResolvedValue({
      ...baseConfigSnapshot,
      config: {
    ...
    expect(output).toContain(
      "run daisyclaw plugins install @daisyclaw/discord or daisyclaw doctor --fix",
    );
