...
export function resetCleanupCommandMocks() {
  ...
  resolveCleanupPlanFromDisk.mockReturnValue({
    stateDir: "/tmp/.daisyclaw",
    configPath: "/tmp/.daisyclaw/daisyclaw.json",
    oauthDir: "/tmp/.daisyclaw/credentials",
    configInsideState: true,
    oauthInsideState: true,
    workspaceDirs: ["/tmp/.daisyclaw/workspace"],
  });
  removePath.mockResolvedValue({ ok: true });
  listAgentSessionDirs.mockResolvedValue(["/tmp/.daisyclaw/agents/main/sessions"]);
