...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: DaisyClawConfig, deps?: BrowserDoctorDeps) => Promise<void>;
...
export async function noteChromeMcpBrowserReadiness(cfg: DaisyClawConfig, deps?: BrowserDoctorDeps) {
  try {
