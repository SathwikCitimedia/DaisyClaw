...
function resolveConfiguredCommandOwners(cfg: DaisyClawConfig): string[] {
...
export function hasConfiguredCommandOwners(cfg: DaisyClawConfig): boolean {
...
export function noteCommandOwnerHealth(cfg: DaisyClawConfig): void {
  ...
  note(
    [
      ...
      `Fix: set commands.ownerAllowFrom to your channel user id, for example ${formatCliCommand("daisyclaw config set commands.ownerAllowFrom '[\"telegram:123456789\"]'")}`,
