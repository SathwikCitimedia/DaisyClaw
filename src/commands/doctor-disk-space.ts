/** Doctor contribution for low disk space around the DaisyClaw state directory. */
 ...
 *
 * This catches a common operational failure mode where DaisyClaw silently
...
export function noteDiskSpace(
  _cfg: DaisyClawConfig, // reserved for API consistency with other Doctor contributions
  deps?: {
