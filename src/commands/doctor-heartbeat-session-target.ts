...
function resolveHeartbeatConfig(cfg: DaisyClawConfig, agentId: string): HeartbeatConfig | undefined {
...
function listHeartbeatDoctorAgents(cfg: DaisyClawConfig) {
 ...
 */
export function describeHeartbeatSessionTargetIssues(cfg: DaisyClawConfig): string[] {
