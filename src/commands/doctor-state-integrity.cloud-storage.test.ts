...
describe("detectMacCloudSyncedStateDir", () => {
  ...
  it("detects state dir under Library/CloudStorage", () => {
    const stateDir = path.join(home, "Library", "CloudStorage", "Dropbox", "DaisyClaw", ".daisyclaw");
  ...
  it("detects cloud-synced target when state dir resolves via symlink", () => {
    const symlinkPath = "/tmp/daisyclaw-state";
  ...
  it("ignores cloud-synced symlink prefix when resolved target is local", () => {
    ...
    const resolvedLocalPath = path.join(home, ".daisyclaw");
  ...
  it("anchors cloud detection to OS homedir when DAISYCLAW_HOME is overridden", () => {
    const stateDir = path.join(home, "Library", "CloudStorage", "iCloud Drive", ".daisyclaw");
    const originalDaisyClawHome = process.env.DAISYCLAW_HOME;
    process.env.DAISYCLAW_HOME = "/tmp/daisyclaw-home-override";
