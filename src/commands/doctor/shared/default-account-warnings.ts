...
export function collectMissingDefaultAccountBindingWarnings(cfg: DaisyClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: DaisyClawConfig): string[] {
  const warnings: string[] = [];
