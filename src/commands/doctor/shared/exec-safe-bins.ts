...
function collectExecSafeBinScopes(cfg: DaisyClawConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: DaisyClawConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: DaisyClawConfig): {
