...
function pruneBindingsForMissingAgents(cfg: DaisyClawConfig, changes: string[]): DaisyClawConfig {
...
export function normalizeCompatibilityConfigValues(cfg: DaisyClawConfig): {
