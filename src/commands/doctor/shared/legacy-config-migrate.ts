...
/** Apply legacy migrations and validate the resulting DaisyClaw config shape when possible. */
export function migrateLegacyConfig(raw: unknown): {
  ...
  if (!validated.ok) {
    ...
    return { config: next as DaisyClawConfig, changes, partiallyValid: true };
  }
