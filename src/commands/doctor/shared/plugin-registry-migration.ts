...
export const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV = "DAISYCLAW_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV = "DAISYCLAW_FORCE_PLUGIN_REGISTRY_MIGRATION";
...
export type PluginRegistryInstallMigrationParams = LoadInstalledPluginIndexParams &
  InstalledPluginIndexStoreOptions & {
    ...
    readConfig?: () => Promise<DaisyClawConfig> | DaisyClawConfig;
  };
...
function listConfiguredChannelIds(config: DaisyClawConfig): Set<string> {
...
function listConfiguredModelProviderIds(config: DaisyClawConfig): Set<string> {
...
export async function migratePluginRegistryForInstall(
  ...
  const config = stripShippedPluginInstallConfigRecords(rawConfig) as DaisyClawConfig;
