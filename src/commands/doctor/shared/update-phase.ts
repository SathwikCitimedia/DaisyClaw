...
export const UPDATE_IN_PROGRESS_ENV = "DAISYCLAW_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "DAISYCLAW_UPDATE_POST_CORE_CONVERGENCE";
 ...
 * `DAISYCLAW_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * `DAISYCLAW_UPDATE_IN_PROGRESS`, so configured plugin repair must happen now.
 */
