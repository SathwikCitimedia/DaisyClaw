...
import type { DaisyClawConfig, ConfigFileSnapshot } from "../../config/types.js";
...
export function resolveTargets(cfg: DaisyClawConfig, explicitUrl?: string): GatewayStatusTarget[] {
...
/** Extracts the config fields displayed by `daisyclaw gateway status --deep`. */
...
export function buildNetworkHints(cfg: DaisyClawConfig) {
