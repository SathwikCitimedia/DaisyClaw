/** Row builders used by `daisyclaw models list` source orchestration. */
...
function toFallbackConfiguredListModel(entry: ConfiguredEntry, cfg: DaisyClawConfig): ListRowModel {
  return (
