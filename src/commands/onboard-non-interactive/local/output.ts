...
function recoveryHintForGatewayHealthFailure(
  ...
  switch (classification) {
    case "auth-mismatch":
      return "Fix: run `daisyclaw doctor --fix`.";
    case "module-missing":
      return "Fix: run `daisyclaw doctor --fix`.";
    case "service-missing":
      return "Fix: run `daisyclaw gateway install --force`.";
    case "service-stopped":
      return "Fix: run `daisyclaw gateway restart`.";
    case "startup-blocked":
      return "Fix: run `daisyclaw gateway status --deep`.";
    case "not-listening":
      return "Fix: start `daisyclaw gateway run`, or run `daisyclaw gateway restart` for a managed gateway.";
    default:
      return undefined;
  }
}
