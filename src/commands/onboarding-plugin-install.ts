...
import { isDaisyClawOrgNpmSpec, parseRegistryNpmSpec } from "../infra/npm-registry-spec.js";
...
function shouldFallbackClawHubToNpm(params: {
  ...
  // Only official DaisyClaw npm packages are safe fallback targets for ClawHub
...
function addPluginLoadPath(cfg: DaisyClawConfig, pluginPath: string): DaisyClawConfig {
