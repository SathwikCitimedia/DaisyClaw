      ...
      rows: [
        {
          ...
          state: "warn",
          detail:
            "plugin not installed - run daisyclaw plugins install @daisyclaw/feishu or daisyclaw doctor --fix",
        },
      ],
      details: [],
    });
      ...
      rows: [
        {
          ...
          enabled: true,
          state: "warn",
          detail: "plugin load failed: dependency tree corrupted; run daisyclaw doctor --fix",
        },
      ],
      details: [],
    });
