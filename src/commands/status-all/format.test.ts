...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://daisyclaw.local")).toBe("https://daisyclaw.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://daisyclaw.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: daisyclaw security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://daisyclaw.local" },
      ...
      { Item: "Security", Value: "Run: daisyclaw security audit --deep" },
