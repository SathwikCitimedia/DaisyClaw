// Fast `daisyclaw status --json` scan policy.
...
type StatusJsonScanPolicy = {
  ...
  gatewayProbeTimeoutMs?: number | ((cfg: DaisyClawConfig) => number | undefined);
...
function hasExplicitStatusJsonChannelConfig(cfg: DaisyClawConfig): boolean {
...
function hasPotentialConfiguredChannelsForStatusJson(cfg: DaisyClawConfig): boolean {
