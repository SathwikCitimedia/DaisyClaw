...
function hasExplicitMemorySearchConfig(cfg: DaisyClawConfig, agentId: string): boolean {
...
export function resolveMemoryPluginStatus(cfg: DaisyClawConfig): MemoryPluginStatus {
...
export async function resolveSharedMemoryStatusSnapshot(params: {
  ...
  resolveMemoryConfig: (cfg: DaisyClawConfig, agentId: string) => { store: { path: string } } | null;
