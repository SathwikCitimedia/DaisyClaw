...
import { normalizeOptionalString as asString } from "@daisyclaw/normalization-core/string-coerce";
...
export function buildCommitmentExtractionPrompt(params: {
  ...
  return `You are DaisyClaw's internal commitment extractor. This is a hidden background classification run. Do not address the user.
