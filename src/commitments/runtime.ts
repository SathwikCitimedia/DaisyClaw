...
type CommitmentExtractionRuntime = {
  ...
  resolveDefaultModel?: (params: { cfg: DaisyClawConfig; agentId?: string }) => ModelRef;
...
let queue: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: DaisyClawConfig }> = [];
...
async function hydrateBatch(
  batch: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: DaisyClawConfig }>,
