...
function expectDaisyClawSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = DaisyClawSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectDaisyClawSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = DaisyClawSchema.safeParse(config);
