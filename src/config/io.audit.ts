...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.DAISYCLAW_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.DAISYCLAW_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.DAISYCLAW_WATCH_COMMAND),
...
export type ConfigAuditScrubResult = {
  ...
  // to swap the file. Caller should re-run `daisyclaw doctor --fix` once the
