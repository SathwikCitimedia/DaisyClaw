...
import type { ConfigFileSnapshot } from "./types.daisyclaw.js";
...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/daisyclaw.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/daisyclaw/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/daisyclaw/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/daisyclaw/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/daisyclaw/nickserv-password.txt");
