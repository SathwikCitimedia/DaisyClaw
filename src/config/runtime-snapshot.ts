...
let runtimeConfigSnapshot: DaisyClawConfig | null = null;
let runtimeConfigSourceSnapshot: DaisyClawConfig | null = null;
...
function configSnapshotsMatch(left: DaisyClawConfig, right: DaisyClawConfig): boolean {
  if (left === right) {
    return true;
  }
  try {
...
export function hashRuntimeConfigValue(value: DaisyClawConfig): string {
...
export function getRuntimeConfigSourceSnapshot(): DaisyClawConfig | null {
...
export function resolveRuntimeConfigCacheKey(config: DaisyClawConfig): string {
...
export function selectApplicableRuntimeConfig(params: {
  inputConfig?: DaisyClawConfig;
  runtimeConfig?: DaisyClawConfig | null;
  runtimeSourceConfig?: DaisyClawConfig | null;
}): DaisyClawConfig | undefined {
...
export function loadPinnedRuntimeConfig(loadFresh: () => DaisyClawConfig): DaisyClawConfig {
...
export async function preflightRuntimeSnapshotWrite(params: {
  nextSourceConfig: DaisyClawConfig;
...
export async function finalizeRuntimeSnapshotWrite(params: {
  ...
  loadFreshConfig: () => DaisyClawConfig;
