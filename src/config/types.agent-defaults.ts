...
export type AgentDefaultsConfig = {
  ...
  /** Embedded DaisyClaw runner hardening and compatibility controls. */
  embeddedAgent?: {
    /**
     * How embedded DaisyClaw should trust workspace-local `.daisyclaw/settings.json`.
    ...
    /**
     * Embedded DaisyClaw execution contract:
...
export type AgentCompactionConfig = {
  ...
  /** Embedded DaisyClaw reserve tokens target before floor enforcement. */
  reserveTokens?: number;
  /** Embedded DaisyClaw keepRecentTokens budget used for cut-point selection. */
  keepRecentTokens?: number;
  /** Minimum reserve tokens enforced for embedded DaisyClaw compaction (0 disables the floor). */
