...
export type WideAreaDiscoveryConfig = {
  ...
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "daisyclaw.internal"). */
  domain?: string;
};
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/daisyclaw"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__daisyclaw__/canvas or /__daisyclaw__/a2ui content.
   */
...
export type GatewayTailscaleConfig = {
  ...
  resetOnExit?: boolean;
  /** Optional Tailscale Service name, such as `svc:daisyclaw`, for Serve mode. */
  serviceName?: string;
  /**
   ...
   * startup. Lets operators manage Funnel exposure outside DaisyClaw without
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/daisyclaw/daisyclaw/issues/65485
   */
...
export type GatewayConfig = {
   ...
   * Env var DAISYCLAW_HANDSHAKE_TIMEOUT_MS takes precedence. Default: 15000.
   */
