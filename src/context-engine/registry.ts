...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("daisyclaw.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("daisyclaw.contextEngineRegistryState");
