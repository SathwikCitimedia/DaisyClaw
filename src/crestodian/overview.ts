...
type DaisyClawReferencePaths = Awaited<ReturnType<typeof resolveDaisyClawReferencePaths>>;
...
type CrestodianOverviewDependencies = {
  ...
  resolveDaisyClawReferencePaths?: typeof resolveDaisyClawReferencePaths;
};
...
function buildAgentSummaries(cfg: DaisyClawConfig): CrestodianAgentSummary[] {
...
function resolveFastTestReferences(env: NodeJS.ProcessEnv): DaisyClawReferencePaths | undefined {
...
export async function loadCrestodianOverview(
  ...
  const resolveReferences = deps.resolveDaisyClawReferencePaths ?? resolveDaisyClawReferencePaths;
  ...
  return {
    ...
    references: {
      ...
      docsUrl: DAISYCLAW_DOCS_URL,
      sourcePath: references.sourcePath ?? undefined,
      sourceUrl: DAISYCLAW_SOURCE_URL,
    },
  };
}
