...
function hasConfiguredAuthProfiles(cfg: DaisyClawConfig): boolean {
  return (
...
function resolveCronActiveRuntimeConfig(cfg: DaisyClawConfig): DaisyClawConfig {
...
async function prepareCronRunContext(params: {
  ...
  const cfgWithAgentDefaults: DaisyClawConfig = {
    ...runtimeCfg,
