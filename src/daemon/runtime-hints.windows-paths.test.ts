...
const resolveGatewayLogPathsMock = vi.fn(() => ({
  logDir: "C:\\tmp\\daisyclaw-state\\logs",
  stdoutPath: "C:\\tmp\\daisyclaw-state\\logs\\gateway.log",
  stderrPath: "C:\\tmp\\daisyclaw-state\\logs\\gateway.err.log",
}));
const resolveGatewaySupervisorLogPathsMock = vi.fn(() => ({
  logDir: "C:\\Users\\test\\Library\\Logs\\daisyclaw",
  stdoutPath: "C:\\Users\\test\\Library\\Logs\\daisyclaw\\gateway.log",
  stderrPath: "C:\\Users\\test\\Library\\Logs\\daisyclaw\\gateway.err.log",
}));
const resolveGatewayRestartLogPathMock = vi.fn(
  () => "C:\\tmp\\daisyclaw-state\\logs\\gateway-restart.log",
);
