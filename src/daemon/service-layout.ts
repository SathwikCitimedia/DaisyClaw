/** Summarizes installed service command paths and DaisyClaw package layout. */
...
async function resolveDaisyClawPackageRoot(entrypoint: string): Promise<string | undefined> {
...
export async function summarizeGatewayServiceLayout(
  ...
  const packageRoot = entrypointReal ? await resolveDaisyClawPackageRoot(entrypointReal) : undefined;
