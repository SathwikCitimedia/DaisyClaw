...
const MANAGED_SERVICE_ENV_KEYS_VAR = "DAISYCLAW_SERVICE_MANAGED_ENV_KEYS";

// Tracks which service environment keys DaisyClaw owns across reinstall/start flows.
