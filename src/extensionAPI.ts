 ...
 * daisyclaw/extension-api. Use the injected plugin runtime or focused
 * daisyclaw/plugin-sdk subpaths instead.
 */

const shouldWarnExtensionApiImport =
  process.env.VITEST !== "true" &&
  process.env.NODE_ENV !== "test" &&
  process.env.DAISYCLAW_SUPPRESS_EXTENSION_API_WARNING !== "1";

if (shouldWarnExtensionApiImport) {
  process.emitWarning(
    "daisyclaw/extension-api is deprecated. Migrate to api.runtime.agent.* or focused daisyclaw/plugin-sdk/<subpath> imports. See https://docs.daisyclaw.ai/plugins/sdk-migration",
    {
      code: "DAISYCLAW_EXTENSION_API_DEPRECATED",
      detail:
        "This compatibility bridge is temporary. Bundled plugins should use the injected plugin runtime instead of importing host-side agent helpers directly. Migration guide: https://docs.daisyclaw.ai/plugins/sdk-migration",
    },
  );
}
