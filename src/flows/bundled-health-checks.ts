...
import { asOptionalObjectRecord as readRecord } from "@daisyclaw/normalization-core/record-coerce";
...
export function registerBundledHealthChecks(params: { cfg: DaisyClawConfig; cwd?: string }): void {
...
function shouldRegisterPolicyHealth(params: { cfg: DaisyClawConfig; cwd?: string }): boolean {
