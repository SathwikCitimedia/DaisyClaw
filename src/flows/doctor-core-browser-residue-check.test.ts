...
const residue = {
  legacyProfileDir: "/tmp/daisyclaw-home/browser/clawd",
  legacyUserDataDir: "/tmp/daisyclaw-home/browser/clawd/user-data",
  canonicalUserDataDir: "/tmp/daisyclaw-home/browser/daisyclaw/user-data",
};
...
describe("browser clawd profile residue health check", () => {
  ...
  it("reports legacy clawd profile residue through doctor lint", async () => {
    ...
    const cfg: DaisyClawConfig = { browser: { profiles: { daisyclaw: { color: "#FF4500" } } } };
    ...
    const findings = await check.detect({
      ...
      runtime: runtime(),
      cfg,
      configPath: "/tmp/daisyclaw-home/daisyclaw.json",
    });
