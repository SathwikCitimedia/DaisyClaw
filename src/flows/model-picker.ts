...
export type PromptDefaultModelResult = { model?: string; config?: DaisyClawConfig };
...
function resolveConfiguredModelRaw(cfg: DaisyClawConfig): string {
  return resolveAgentModelPrimaryValue(cfg.agents?.defaults?.model) ?? "";
}

function resolveConfiguredModelKeys(cfg: DaisyClawConfig): string[] {
