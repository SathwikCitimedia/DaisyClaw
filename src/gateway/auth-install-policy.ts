...
type GatewayInstallAuthMode = NonNullable<NonNullable<DaisyClawConfig["gateway"]>["auth"]>["mode"];
...
function hasConfiguredGatewayPasswordForInstall(cfg: DaisyClawConfig): boolean {
...
function hasDurableGatewayPasswordEnvForInstall(
  ...
  return Boolean(
    normalizeOptionalString(durableServiceEnv.DAISYCLAW_GATEWAY_PASSWORD) ||
