...
export function hasAmbiguousGatewayAuthModeConfig(cfg: DaisyClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: DaisyClawConfig): void {
