...
// Removes DaisyClaw-only envelopes before messages are shown in UI/RPC results.
...
/** Strips DaisyClaw envelope metadata from one display message without mutating it. */
