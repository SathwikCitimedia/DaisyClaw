...
// Deduplicates external history messages against local DaisyClaw transcripts.
...
function resolveImportedExternalIdentity(message: unknown): ImportedExternalIdentity | undefined {
  ...
  const meta =
    "__daisyclaw" in message &&
    (message as { __daisyclaw?: unknown })["__daisyclaw"] &&
    typeof (message as { __daisyclaw?: unknown })["__daisyclaw"] === "object"
      ? ((message as { __daisyclaw?: Record<string, unknown> })["__daisyclaw"] ?? {})
      : undefined;
