...
import type {
  ...
  DaisyClawPluginNodeInvokeTransportResult,
...
function createApprovalRuntime(params: {
  ...
  pluginId: string;
}): DaisyClawPluginNodeInvokePolicyContext["approvals"] | undefined {
...
export async function applyPluginNodeInvokePolicy(params: {
  ...
  const invokeNode: DaisyClawPluginNodeInvokePolicyContext["invokeNode"] = async (
    override = {},
