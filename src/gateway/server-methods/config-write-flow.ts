...
export function didSharedGatewayAuthChange(prev: DaisyClawConfig, next: DaisyClawConfig): boolean {
...
}): Promise<{ path: string; config: DaisyClawConfig; queueFollowUp: () => void }> {
