...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: DaisyClawConfig; writeConfig: DaisyClawConfig; schema: ConfigSchemaResponse } | null {
  ...
  return {
    ...
    writeConfig: validationCandidate as DaisyClawConfig,
    schema,
  };
}
