...
function listConfiguredAnnounceChannelIds(cfg: DaisyClawConfig): string[] {
...
function assertValidCronAnnounceDelivery(params: { cfg: DaisyClawConfig; delivery?: CronDelivery }) {
...
function assertValidCronCreateDelivery(cfg: DaisyClawConfig, jobCreate: CronJobCreate) {
