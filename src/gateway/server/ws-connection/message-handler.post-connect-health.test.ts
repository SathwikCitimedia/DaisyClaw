...
describe("resolvePinnedClientMetadata", () => {
  ...
  it.each([
    ["daisyclaw-ios", "iOS 26.5.0", "iOS 26.4.2", "iPhone"],
    ["daisyclaw-ios", "iPadOS 26.5.0", "iPadOS 26.4.2", "iPad"],
    ["daisyclaw-ios", "iPadOS 26.5.0", "iOS 26.4.2", "iPad"],
    ["daisyclaw-android", "Android 16", "Android 15", "Android"],
  ])(
