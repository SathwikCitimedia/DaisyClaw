...
function resolveDefaultStoreAgentId(cfg: DaisyClawConfig): string {
...
export function resolveSessionStoreAgentId(cfg: DaisyClawConfig, canonicalKey: string): string {
