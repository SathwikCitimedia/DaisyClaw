...
function resolveSessionKey(params: { cfg: DaisyClawConfig; input: ToolsInvokeInput }): string {
...
function resolveMemoryToolDisableReasons(cfg: DaisyClawConfig): string[] {
