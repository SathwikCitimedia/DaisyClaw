/**
 * Hook system for DaisyClaw agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("daisyclaw.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("daisyclaw.internalHooksEnabled");
