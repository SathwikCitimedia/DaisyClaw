...
import { normalizeUniqueStringEntriesLower } from "@daisyclaw/normalization-core/string-normalization";
import type { DaisyClawConfig } from "../config/types.daisyclaw.js";

const DIAGNOSTICS_ENV = "DAISYCLAW_DIAGNOSTICS";
...
/** Resolves enabled diagnostic flags from config plus `DAISYCLAW_DIAGNOSTICS` overrides. */
