...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "DAISYCLAW_OAUTH_DIR",
  "DAISYCLAW_PINNED_PYTHON",
  "DAISYCLAW_PINNED_WRITE_PYTHON",
  "DAISYCLAW_PLUGIN_INSTALL_OVERRIDES",
  ...
  "DAISYCLAW_STATE_DIR",
  "DAISYCLAW_TEST_TAILSCALE_BINARY",
  "PATH",
  "PI_CODING_AGENT_DIR",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  "CLAWHUB_",
  "OPENAI_API_KEY_",
  // Workspace .env is untrusted; reserve the full DaisyClaw runtime namespace
  // for shell/global config so new DAISYCLAW_* controls are fail-closed by default.
  "DAISYCLAW_",
  "DAISYCLAW_CLAWHUB_",
  "DAISYCLAW_DISABLE_",
  "DAISYCLAW_SKIP_",
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.daisyclaw/.env (or DAISYCLAW_STATE_DIR/.env),
