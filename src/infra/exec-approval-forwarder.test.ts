...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): DaisyClawConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): DaisyClawConfig {
  return {
