...
function resolveSlackPluginOriginTarget(params: { cfg: DaisyClawConfig; turnSourceTo: string }) {
...
describe("exec approval session target", () => {
  ...
  it("returns null for blank session keys, missing entries, and unresolved targets", () => {
    withTempDirSync({ prefix: "daisyclaw-exec-approval-session-target-" }, (tmpDir) => {
