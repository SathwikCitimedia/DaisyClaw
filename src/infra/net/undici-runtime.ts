...
// DaisyClaw HTTP/1, timeout, proxy TLS, and IP-safe proxy policies.
import { createRequire } from "node:module";
import net from "node:net";
import { isRecord as isObjectRecord } from "@daisyclaw/normalization-core/record-coerce";
...
export const TEST_UNDICI_RUNTIME_DEPS_KEY = "__DAISYCLAW_TEST_UNDICI_RUNTIME_DEPS__";
...
/** Creates a direct undici Agent with DaisyClaw's HTTP/1-only dispatcher policy. */
...
/**
 * Creates an EnvHttpProxyAgent with DaisyClaw proxy TLS, IP-safe proxy pools,
