...
describe("resolveOutboundSessionRoute", () => {
  ...
  const perChannelPeerCfg = { session: { dmScope: "per-channel-peer" } } as DaisyClawConfig;
  ...
  const perChannelPeerSessionCfg = { session: { dmScope: "per-channel-peer" } } as DaisyClawConfig;
