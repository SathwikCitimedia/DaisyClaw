...
describe("normalizePackageTagInput", () => {
  const packageNames = ["daisyclaw", "@daisyclaw/plugin"] as const;

  it.each([
    { input: undefined, expected: null },
    { input: "   ", expected: null },
    { input: "daisyclaw@beta", expected: "beta" },
    { input: "@daisyclaw/plugin@2026.2.24", expected: "2026.2.24" },
    { input: "daisyclaw@   ", expected: null },
    { input: "daisyclaw", expected: null },
    { input: " @daisyclaw/plugin ", expected: null },
    { input: " latest ", expected: "latest" },
    { input: "@other/plugin@beta", expected: "@other/plugin@beta" },
    { input: "daisyclawer@beta", expected: "daisyclawer@beta" },
