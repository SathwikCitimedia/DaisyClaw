...
const DEFAULT_VAPID_SUBJECT = "https://daisyclaw.ai";
...
function resolveVapidSubjectFromEnv(): string {
  return process.env.DAISYCLAW_VAPID_SUBJECT || DEFAULT_VAPID_SUBJECT;
}

function resolveVapidPublicKeyFromEnv(): string | undefined {
  return process.env.DAISYCLAW_VAPID_PUBLIC_KEY || undefined;
}

function resolveVapidPrivateKeyFromEnv(): string | undefined {
  return process.env.DAISYCLAW_VAPID_PRIVATE_KEY || undefined;
}
