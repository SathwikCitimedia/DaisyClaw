// Wraps fs-safe atomic replacement and move helpers for DaisyClaw install flows.
...
/**
 * Moves a path using fs-safe's copy fallback, with an DaisyClaw hardlink guard
