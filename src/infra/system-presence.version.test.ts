  ...
  return withEnvAsync(
    {
      ...
      DAISYCLAW_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when DAISYCLAW_VERSION is not set", async () => {
  ...
  it("prefers DAISYCLAW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over DAISYCLAW_SERVICE_VERSION when DAISYCLAW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        DAISYCLAW_VERSION: " ",
        DAISYCLAW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when DAISYCLAW_VERSION and DAISYCLAW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        DAISYCLAW_VERSION: " ",
        DAISYCLAW_SERVICE_VERSION: "\t",
