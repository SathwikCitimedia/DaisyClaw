...
type ConsoleConfigLoader = () => DaisyClawConfig["logging"] | undefined;
...
function normalizeConsoleLevel(level?: string): LogLevel {
  ...
  if (!level && process.env.VITEST === "true" && process.env.DAISYCLAW_TEST_CONSOLE !== "1") {
    return "silent";
  }
...
function resolveConsoleSettings(): ConsoleSettings {
  ...
  if (
    ...
    process.env.DAISYCLAW_TEST_CONSOLE !== "1" &&
    !isVerbose() &&
    !envLevel &&
  ...
  let cfg: DaisyClawConfig["logging"] | undefined =
