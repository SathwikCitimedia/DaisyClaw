...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __daisyclawDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore["__daisyclawDiagnosticStabilityState"] ??= createState();
  return globalStore["__daisyclawDiagnosticStabilityState"];
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore["__daisyclawDiagnosticStabilityState"] = next;
}
