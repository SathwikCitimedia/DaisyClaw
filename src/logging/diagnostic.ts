...
function resolveDiagnosticSessionStorePaths(config?: DaisyClawConfig): string[] | undefined {
  if (!config) {
    return undefined;
  }
  try {
...
function shouldWriteCriticalMemoryPressureBundle(config?: DaisyClawConfig): boolean {
...
export function isStuckSessionRecoveryEnabled(config?: DaisyClawConfig): boolean {
...
export function resolveStuckSessionWarnMs(config?: DaisyClawConfig): number {
