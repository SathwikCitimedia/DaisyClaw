...
import { clampTimerTimeoutMs } from "@daisyclaw/normalization-core/number-coercion";
...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: DaisyClawConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: DaisyClawConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: DaisyClawConfig;
  agentDir?: string;
  listProviders: (cfg?: DaisyClawConfig) => CapabilityProviderCandidate[];
}): string[] {
