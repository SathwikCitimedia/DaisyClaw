...
export function resolveConfiguredMediaMaxBytes(cfg?: DaisyClawConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: DaisyClawConfig | undefined, kind: MediaKind) {
