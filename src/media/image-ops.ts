...
/** DaisyClaw-facing image backend availability error, preserving the failed operation and causes. */
...
/** Creates a Rastermill processor with DaisyClaw temp-dir, pixel-limit, and command trust policy. */
...
/** Detects either DaisyClaw's wrapper error or Rastermill's native unavailable error. */
