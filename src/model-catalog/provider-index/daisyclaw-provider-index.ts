// Bundled DaisyClaw provider index advertises pre-install provider metadata for model picker discovery.
import type { DaisyClawProviderIndex } from "./types.js";

// DaisyClaw-owned preview metadata for providers whose plugins may not be
...
export const DAISYCLAW_PROVIDER_INDEX = {
  version: 1,
  providers: {
    moonshot: {
      id: "moonshot",
...
} satisfies DaisyClawProviderIndex;
