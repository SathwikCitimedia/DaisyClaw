...
import { loadDaisyClawProviderIndex, normalizeDaisyClawProviderIndex } from "./index.js";

describe("DaisyClaw provider index", () => {
  it("normalizes provider preview catalog rows through model catalog validation", () => {
    const index = normalizeDaisyClawProviderIndex({
      version: 1,
      providers: {
        Moonshot: {
          id: "moonshot",
