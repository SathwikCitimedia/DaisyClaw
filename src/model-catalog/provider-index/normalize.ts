...
const DAISYCLAW_PROVIDER_INDEX_VERSION = 1;
...
function normalizeInstall(value: unknown): DaisyClawProviderIndexPluginInstall | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
function normalizePlugin(value: unknown): DaisyClawProviderIndexPlugin | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
function normalizeOnboardingScopes(
  value: unknown,
): DaisyClawProviderIndexProviderAuthChoice["onboardingScopes"] | undefined {
...
function normalizeAssistantVisibility(
  value: unknown,
): DaisyClawProviderIndexProviderAuthChoice["assistantVisibility"] | undefined {
...
function normalizeAuthChoice(params: {
  ...
  providerName: string;
  value: unknown;
}): DaisyClawProviderIndexProviderAuthChoice | undefined {
...
function normalizeAuthChoices(params: {
  ...
  providerName: string;
  value: unknown;
}): readonly DaisyClawProviderIndexProviderAuthChoice[] | undefined {
  if (!Array.isArray(params.value)) {
    return undefined;
  }
  const choices = params.value
    .map((value) => normalizeAuthChoice({ ...params, value }))
    .filter((choice): choice is DaisyClawProviderIndexProviderAuthChoice => Boolean(choice));
...
function normalizeProvider(
  ...
  value: unknown,
): DaisyClawProviderIndexProvider | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
export function normalizeDaisyClawProviderIndex(value: unknown): DaisyClawProviderIndex | undefined {
  if (!isRecord(value) || value.version !== DAISYCLAW_PROVIDER_INDEX_VERSION) {
    return undefined;
  }
  if (!isRecord(value.providers)) {
    return undefined;
  }
  const providers: Record<string, DaisyClawProviderIndexProvider> = {};
  ...
  return {
    version: DAISYCLAW_PROVIDER_INDEX_VERSION,
