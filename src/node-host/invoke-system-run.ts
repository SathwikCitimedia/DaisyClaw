...
type ExecToolConfig = NonNullable<NonNullable<DaisyClawConfig["tools"]>["exec"]>;
...
async function loadSystemRunConfig(opts: HandleSystemRunInvokeOptions): Promise<DaisyClawConfig> {
