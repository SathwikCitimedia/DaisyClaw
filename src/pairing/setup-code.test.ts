...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    ...
    process.env.DAISYCLAW_GATEWAY_PORT = "";
  });
  ...
  it.each([
    ...
    {
      name: "uses DAISYCLAW_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          DAISYCLAW_GATEWAY_TOKEN: "new-token",
        },
  ...
  it.each([
    ...
    },
    {
      ...
      expected: {
        authLabel: "password",
        url: "wss://daisyclaw.tailnet.ts.net",
        urlSource: "gateway.tailscale.mode=serve",
      },
    },
    {
