...
type ChannelApprovalForwardingEvaluatorParams = {
  channel: string;
  isTransportEnabled: (params: { cfg: DaisyClawConfig; accountId?: string | null }) => boolean;
...
type NativeApprovalChannelRouteGateParams<TTarget extends NativeApprovalTarget> = {
  ...
  isTransportEnabled: (params: { cfg: DaisyClawConfig; accountId?: string | null }) => boolean;
  listAccountIds: (cfg: DaisyClawConfig) => readonly string[];
  resolveDefaultAccountId: (cfg: DaisyClawConfig) => string;
  normalizeForwardTarget: (target: NativeApprovalForwardTarget) => TTarget | null;
...
export function shouldSuppressLocalNativeExecApprovalPrompt(params: {
  ...
  isNativeDeliveryEnabled?: (params: { cfg: DaisyClawConfig; accountId?: string | null }) => boolean;
