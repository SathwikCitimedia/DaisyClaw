// Browser control auth helpers resolve plugin browser credentials from DaisyClaw config.
...
type BrowserControlAuthSurface = {
  resolveBrowserControlAuth: (cfg?: DaisyClawConfig, env?: NodeJS.ProcessEnv) => BrowserControlAuth;
