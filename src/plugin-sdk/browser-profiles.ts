...
export const DEFAULT_DAISYCLAW_BROWSER_ENABLED = true;
...
export const DEFAULT_DAISYCLAW_BROWSER_COLOR = "#FF4500";
/** Default DaisyClaw-managed browser profile name. */
export const DEFAULT_DAISYCLAW_BROWSER_PROFILE_NAME = "daisyclaw";
/** Default browser profile selected when config omits a profile name. */
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "daisyclaw";
...
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredDaisyClawTmpDir(), "uploads");
