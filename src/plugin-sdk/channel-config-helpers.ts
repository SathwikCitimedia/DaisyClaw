...
type ChannelConfigAccessorParams<Config extends DaisyClawConfig = DaisyClawConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends DaisyClawConfig = DaisyClawConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends DaisyClawConfig = DaisyClawConfig>(
...
function setTopLevelChannelEnabledInConfigSection<Config extends DaisyClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends DaisyClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends DaisyClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
