...
describe("defineChannelMessageAdapter", () => {
  const loadPluginSdkSubpaths = async () =>
    await Promise.all([
      import("daisyclaw/plugin-sdk/channel-outbound"),
      import("daisyclaw/plugin-sdk/channel-message"),
      import("daisyclaw/plugin-sdk/channel-message-runtime"),
      import("daisyclaw/plugin-sdk/channel-reply-pipeline"),
      import("daisyclaw/plugin-sdk/compat"),
    ] as const);
