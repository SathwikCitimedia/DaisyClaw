...
import { runSetupWizardFinalize } from "daisyclaw/plugin-sdk/plugin-test-runtime";
...
describe("createOptionalChannelSetupSurface", () => {
  it("returns a matched adapter and wizard for optional plugins", async () => {
    ...
    expect(
      ...
      "Example setup requires @daisyclaw/example to be installed. Docs: https://docs.daisyclaw.ai/channels/example",
    );
    ...
    ).rejects.toThrow("@daisyclaw/example");
  });
});
