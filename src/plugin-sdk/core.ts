...
import type { DaisyClawPluginApi } from "../plugins/types.js";
...
export type { DaisyClawConfig } from "../config/config.js";
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: DaisyClawConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
