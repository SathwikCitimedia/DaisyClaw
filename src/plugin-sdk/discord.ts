...
/**
 * @deprecated Compatibility facade for the `daisyclaw/plugin-sdk/discord` subpath.
...
export type { DaisyClawConfig } from "./config-types.js";
export type { DaisyClawPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
/** Discord channel config shape for one account in DaisyClaw config. */
export type DiscordAccountConfig = NonNullable<NonNullable<DaisyClawConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: DaisyClawConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: DaisyClawConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: DaisyClawConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: DaisyClawConfig }): DaisyClawConfig {
...
/** List configured Discord account ids from DaisyClaw config. */
export function listDiscordAccountIds(cfg: DaisyClawConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: DaisyClawConfig): string {
