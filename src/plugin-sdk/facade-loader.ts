...
let cachedDaisyClawPackageRoot: string | undefined;

function getDaisyClawPackageRoot() {
  if (cachedDaisyClawPackageRoot) {
    return cachedDaisyClawPackageRoot;
  }
  cachedDaisyClawPackageRoot =
...
function resolveFacadeModuleLocation(params: {
  ...
  return resolveBundledFacadeModuleLocation({
    ...
    packageRoot: getDaisyClawPackageRoot(),
    bundledPluginsDir,
  });
}
...
export function loadFacadeModuleAtLocationSync<T extends object>(params: {
  ...
  const opened = openRootFileSync({
    ...
    boundaryLabel:
      location.boundaryRoot === getDaisyClawPackageRoot()
        ? "DaisyClaw package root"
        : (() => {
...
export async function loadBundledPluginPublicSurfaceModule<T extends object>(params: {
  ...
  const opened = openRootFileSync({
    ...
    boundaryLabel:
      preparedLocation.boundaryRoot === getDaisyClawPackageRoot()
        ? "DaisyClaw package root"
        : "plugin root",
    rejectHardlinks: false,
  });
...
export function resetFacadeLoaderStateForTest(): void {
  ...
  cachedDaisyClawPackageRoot = undefined;
}
