...
/** @deprecated Use `resolveChannelMessageIngress` from `daisyclaw/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `daisyclaw/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use `resolveOpenProviderRuntimeGroupPolicy` plus `resolveChannelMessageIngress` from `daisyclaw/plugin-sdk/channel-ingress-runtime`. */
