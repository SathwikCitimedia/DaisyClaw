...
import type { ModelDefinitionConfig, DaisyClawConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: DaisyClawConfig) => DaisyClawConfig;
  applyLitellmProviderConfig: (cfg: DaisyClawConfig) => DaisyClawConfig;
...
/** Apply LiteLLM defaults to the full DaisyClaw config. */
