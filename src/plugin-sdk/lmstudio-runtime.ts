...
/** Normalized model metadata used by DaisyClaw provider catalogs. */
...
export const LMSTUDIO_DEFAULT_MODEL_ID: FacadeModule["LMSTUDIO_DEFAULT_MODEL_ID"] =
  "qwen/qwen3.5-9b";
/** Stable provider id used in DaisyClaw config and provider catalogs. */
...
/** Map one raw LM Studio model entry into DaisyClaw model metadata. */
...
/** Discover DaisyClaw model definitions from an LM Studio server. */
