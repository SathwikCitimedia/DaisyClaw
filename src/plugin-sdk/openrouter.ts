...
type FacadeModule = {
  applyOpenrouterConfig: (cfg: DaisyClawConfig) => DaisyClawConfig;
  applyOpenrouterProviderConfig: (cfg: DaisyClawConfig) => DaisyClawConfig;
...
/** Apply OpenRouter defaults to the full DaisyClaw config. */
