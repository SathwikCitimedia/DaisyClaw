...
export type DaisyClawPluginApi = import("../plugins/types.js").DaisyClawPluginApi;
export type DaisyClawPluginCommandDefinition =
  import("../plugins/types.js").DaisyClawPluginCommandDefinition;
export type DaisyClawPluginConfigSchema = import("../plugins/types.js").DaisyClawPluginConfigSchema;
export type DaisyClawPluginDefinition = import("../plugins/types.js").DaisyClawPluginDefinition;
export type DaisyClawPluginHttpRouteHandler =
  import("../plugins/types.js").DaisyClawPluginHttpRouteHandler;
export type DaisyClawPluginNodeHostCommand =
  import("../plugins/types.js").DaisyClawPluginNodeHostCommand;
export type DaisyClawPluginNodeInvokePolicy =
  import("../plugins/types.js").DaisyClawPluginNodeInvokePolicy;
export type DaisyClawPluginNodeInvokePolicyContext =
  import("../plugins/types.js").DaisyClawPluginNodeInvokePolicyContext;
export type DaisyClawPluginNodeInvokePolicyResult =
  import("../plugins/types.js").DaisyClawPluginNodeInvokePolicyResult;
export type DaisyClawPluginReloadRegistration =
  import("../plugins/types.js").DaisyClawPluginReloadRegistration;
export type DaisyClawPluginSecurityAuditCollector =
  import("../plugins/types.js").DaisyClawPluginSecurityAuditCollector;
export type DaisyClawPluginSecurityAuditContext =
  import("../plugins/types.js").DaisyClawPluginSecurityAuditContext;
export type DaisyClawPluginService = import("../plugins/types.js").DaisyClawPluginService;
export type DaisyClawPluginServiceContext =
  import("../plugins/types.js").DaisyClawPluginServiceContext;
export type DaisyClawPluginToolContext = import("../plugins/types.js").DaisyClawPluginToolContext;
export type DaisyClawPluginToolFactory = import("../plugins/types.js").DaisyClawPluginToolFactory;
...
export type DaisyClawGatewayDiscoveryAdvertiseContext =
  import("../plugins/types.js").DaisyClawGatewayDiscoveryAdvertiseContext;
export type DaisyClawGatewayDiscoveryService =
  import("../plugins/types.js").DaisyClawGatewayDiscoveryService;
...
type DefinePluginEntryOptions = {
   ...
   */
  kind?: DaisyClawPluginDefinition["kind"];
  configSchema?: DaisyClawPluginConfigSchema | (() => DaisyClawPluginConfigSchema);
  reload?: DaisyClawPluginDefinition["reload"];
  nodeHostCommands?: DaisyClawPluginDefinition["nodeHostCommands"];
  securityAuditCollectors?: DaisyClawPluginDefinition["securityAuditCollectors"];
  register: (api: DaisyClawPluginApi) => void;
};

/** Normalized object shape that DaisyClaw loads from a plugin entry module. */
type DefinedPluginEntry = {
  id: string;
  name: string;
  description: string;
  configSchema: DaisyClawPluginConfigSchema;
  register: NonNullable<DaisyClawPluginDefinition["register"]>;
} & Pick<
  DaisyClawPluginDefinition,
 ...
 * `daisyclaw/plugin-sdk/core` so they inherit the channel capability wiring.
 */
