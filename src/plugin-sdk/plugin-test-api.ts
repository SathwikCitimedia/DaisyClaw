...
import {
  ...
  type DaisyClawPluginApiWithoutFacades,
} from "../plugins/api-facades.js";
import type { DaisyClawPluginApi } from "./plugin-runtime.js";

/** Partial plugin API overrides accepted by the SDK test helper. */
export type TestPluginApiInput = Partial<DaisyClawPluginApi>;

/** Create a minimal plugin API object for plugin-sdk contract and unit tests. */
export function createTestPluginApi(api: TestPluginApiInput = {}): DaisyClawPluginApi {
  ...
  const mergedApi = {
    ...
    on() {},
    ...flatApi,
  } as DaisyClawPluginApiWithoutFacades;
