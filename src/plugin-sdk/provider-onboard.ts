...
import { findNormalizedProviderKey } from "@daisyclaw/model-catalog-core/provider-id";
...
export type { DaisyClawConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: DaisyClawConfig, ...args: TArgs) => DaisyClawConfig;
  applyConfig: (cfg: DaisyClawConfig, ...args: TArgs) => DaisyClawConfig;
};
...
function hasAgentDefaultModelPrimary(cfg: DaisyClawConfig): boolean {
...
>(params: {
  ...
  applyPreset: (cfg: DaisyClawConfig, preset: TParams) => DaisyClawConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: DaisyClawConfig): {
