// DaisyClaw-owned tool runtime contract helpers mock agent tool runtimes in SDK tests.
...
export function installDaisyClawOwnedToolHooks(params?: {
 ...
 * Pair with `installDaisyClawOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetDaisyClawOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
