...
export type TtsRuntimeFacade = {
  ...
  buildTtsSystemPromptHint: (cfg: DaisyClawConfig, agentId?: string) => string | undefined;
  ...
  resolveTtsProviderOrder: (primary: TtsProvider, cfg?: DaisyClawConfig) => TtsProvider[];
