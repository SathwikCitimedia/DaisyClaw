...
type FacadeModule = {
  applyXiaomiConfig: (cfg: DaisyClawConfig) => DaisyClawConfig;
  applyXiaomiProviderConfig: (cfg: DaisyClawConfig) => DaisyClawConfig;
...
/** Apply Xiaomi provider defaults to the full DaisyClaw config. */
