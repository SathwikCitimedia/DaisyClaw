...
export type DaisyClawAgentToolResult<TResult = unknown> = AgentToolResult<TResult>;

export type AgentToolResultMiddlewareRuntime = "daisyclaw" | "codex";
...
export type AgentToolResultMiddlewareEvent = {
  ...
  cwd?: string;
  isError?: boolean;
  result: DaisyClawAgentToolResult;
};
