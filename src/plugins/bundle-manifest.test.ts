/** Tests bundle manifest parsing for Codex, Claude, Cursor, and DaisyClaw formats. */
...
function makeTempDir() {
  return makeTrackedTempDir("daisyclaw-bundle-manifest", tempDirs);
}
...
describe("bundle manifest parsing", () => {
  it("does not treat daisyclaw.bundle.json as a bundle manifest", () => {
    const rootDir = makeTempDir();
    writeBundleManifest(rootDir, "daisyclaw.bundle.json", {
      name: "Not Real",
      skills: ["skills"],
    });
