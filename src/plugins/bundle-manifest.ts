/** Reads Codex/Claude/Cursor bundle manifests into DaisyClaw plugin manifest metadata. */
...
export type BundlePluginManifest = {
  ...
  // Only include hook roots that DaisyClaw can execute via HOOK.md + handler files.
  hooks: string[];
