...
import type { AnyAgentTool, DaisyClawPluginApi } from "./types.js";
...
describe("captured plugin registration", () => {
  ...
  it("returns synthetic scheduled-turn ids independent of human-readable names", async () => {
    let scheduleSessionTurn: DaisyClawPluginApi["scheduleSessionTurn"] | undefined;
    let registerSessionSchedulerJob: DaisyClawPluginApi["registerSessionSchedulerJob"] | undefined;
    const captured = capturePluginRegistration({
