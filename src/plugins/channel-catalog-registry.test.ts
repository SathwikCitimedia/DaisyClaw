...
const ENV: NodeJS.ProcessEnv = { HOME: "/tmp/daisyclaw-test-home" };
let loadCase = 0;

const RECORDS: Record<string, PluginInstallRecord> = {
  weixin: {
    source: "npm",
    spec: "@tencent-weixin/daisyclaw-weixin@2.3.7",
    installPath:
      "/tmp/daisyclaw-test-home/.daisyclaw/npm/node_modules/@tencent-weixin/daisyclaw-weixin",
...
async function loadWithMocks(params: {
  ...
  vi.doMock("./discovery.js", () => ({ discoverDaisyClawPlugins: discoverSpy }));
...
function createChannelCandidate(params: {
  ...
  return {
    ...
    source: "/tmp/daisyclaw-test-plugin/index.js",
    rootDir: "/tmp/daisyclaw-test-plugin",
    origin: params.origin ?? "global",
    packageName: "@vendor/daisyclaw-test-plugin",
    packageManifest: {
