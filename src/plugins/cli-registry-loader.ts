...
export type PluginCliCommandGroupEntry = {
  ...
  placeholders: readonly DaisyClawPluginCliCommandDescriptor[];
  names: readonly string[];
  register: (program: DaisyClawPluginCliContext["program"]) => Promise<void>;
};
...
export async function loadPluginCliMetadataRegistryWithContext(
  ...
  return {
    ...context,
    registry: await loadDaisyClawPluginCliRegistry(
...
): Promise<DaisyClawPluginCliCommandDescriptor[]> {
  try {
