...
import type { DaisyClawPluginCliCommandDescriptor, PluginLogger } from "./types.js";
...
const PLUGIN_CLI_ENTRIES_CACHE_KEY = Symbol.for("daisyclaw.plugin-cli-registration-entries-cache");
...
export const loadValidatedConfigForPluginRegistration =
  async (): Promise<DaisyClawConfig | null> => {
