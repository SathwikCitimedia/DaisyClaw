...
import {
  ...
  type DaisyClawPluginCommandDefinition,
} from "./types.js";
...
/** Returns true when a command name is owned by built-in DaisyClaw command handling. */
...
export function listPluginInvocationKeys(command: DaisyClawPluginCommandDefinition): string[] {
