...
import type { DaisyClawPluginCommandDefinition } from "./types.js";
...
function resolvePluginTextName(command: DaisyClawPluginCommandDefinition): string {
...
function serializePluginCommandSpec(
  cmd: DaisyClawPluginCommandDefinition,
  provider?: string,
): {
  name: string;
  description: string;
