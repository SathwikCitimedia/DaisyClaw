...
const CHANNEL_RUNTIME_SDK_SURFACE = ["daisyclaw/plugin-sdk/channel", "runtime"].join("-");
...
export const PLUGIN_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    surfaces: [
      ...
      "daisyclaw/plugin-sdk/memory-core-host-engine-embeddings registerMemoryEmbeddingProvider",
  ...
  },
  {
    ...
    warningStarts: "2026-04-24",
    removeAfter: "2026-07-24",
    replacement: "focused `daisyclaw/plugin-sdk/<subpath>` imports",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["daisyclaw/plugin-sdk", "daisyclaw/plugin-sdk/compat"],
    diagnostics: ["DAISYCLAW_PLUGIN_SDK_COMPAT_DEPRECATED"],
    tests: [
  ...
  },
  {
    ...
    surfaces: [
      "@daisyclaw/whatsapp WebInboundMessage flat fields",
  ...
  },
  {
    ...
    surfaces: [
      "daisyclaw/plugin-sdk/discord component message helpers",
      "daisyclaw/plugin-sdk/telegram-account resolveTelegramAccount",
    ],
  ...
  },
  {
    ...
    replacement:
      "`daisyclaw/plugin-sdk/bundled-channel-config-schema` for maintained bundled plugins; plugin-local schemas for third-party plugins",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["daisyclaw/plugin-sdk/channel-config-schema-legacy"],
  ...
  },
  {
    ...
    removeAfter: "2026-07-28",
    replacement:
      "focused `daisyclaw/plugin-sdk/*` test subpaths such as `plugin-test-runtime`, `channel-test-helpers`, `test-env`, and `test-fixtures`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["daisyclaw/plugin-sdk/testing"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
      "src/plugins/compat/registry.test.ts",
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "daisyclaw/plugin-sdk/channel-route channelRouteIdentityKey",
      "daisyclaw/plugin-sdk/channel-route channelRouteKey",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
  ...
  },
  {
    ...
    surfaces: [
      ...
      "daisyclaw/plugin-sdk/channel-route ChannelRouteExplicitTarget",
      "daisyclaw/plugin-sdk/channel-route ChannelRouteExplicitTargetParser",
      "daisyclaw/plugin-sdk/channel-route resolveChannelRouteTargetWithParser",
  ...
  },
  {
    ...
    warningStarts: "2026-05-23",
    removeAfter: "2026-08-23",
    replacement: "`daisyclaw/plugin-sdk/channel-targets`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["daisyclaw/plugin-sdk/messaging-targets"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
      "src/plugins/compat/registry.test.ts",
      "src/plugins/contracts/plugin-sdk-subpaths.test.ts",
  ...
  },
  {
    ...
    surfaces: ["daisyclaw.plugin.json providerAuthEnvVars", "provider setup"],
  ...
  },
  {
    ...
    docsPath: "/plugins/manifest",
    surfaces: ["daisyclaw.plugin.json channelEnvVars", "channel setup"],
    diagnostics: ["manifest compatibility diagnostic"],
    tests: [
  ...
  },
  {
    ...
    warningStarts: "2026-04-25",
    removeAfter: "2026-07-25",
    replacement: "`daisyclaw/plugin-sdk/agent-runtime`",
    docsPath: "/plugins/sdk-agent-harness",
    surfaces: ["daisyclaw/plugin-sdk/agent-harness", "daisyclaw/plugin-sdk/agent-harness-runtime"],
    diagnostics: ["plugin SDK compatibility warning"],
  ...
  },
  {
    ...
    surfaces: [
      ...
      "daisyclaw/extension-api runEmbeddedPiAgent",
      "daisyclaw/plugin-sdk/agent-harness-runtime EmbeddedPi* aliases",
    ],
    diagnostics: ["plugin SDK compatibility registry"],
    tests: [
  ...
  },
  {
    ...
    warningStarts: "2026-04-25",
    removeAfter: "2026-07-25",
    replacement: "`daisyclaw plugins registry --refresh` and `daisyclaw doctor --fix`",
    docsPath: "/cli/plugins#registry",
    surfaces: ["DAISYCLAW_DISABLE_PERSISTED_PLUGIN_REGISTRY", "plugin registry reads"],
  ...
  },
  {
    ...
    docsPath: "/cli/plugins#registry",
    surfaces: [
      "DAISYCLAW_DISABLE_PLUGIN_REGISTRY_MIGRATION",
      "DAISYCLAW_FORCE_PLUGIN_REGISTRY_MIGRATION",
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`daisyclaw.channel.exposure` metadata",
    docsPath: "/plugins/sdk-setup",
    surfaces: ["daisyclaw.channel.showConfigured", "daisyclaw.channel.showInSetup"],
  ...
  },
  {
    ...
    removeAfter: "2026-07-26",
    replacement:
      "focused channel SDK subpaths, especially `daisyclaw/plugin-sdk/channel-runtime-context`",
    docsPath: "/plugins/sdk-migration",
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`daisyclaw/plugin-sdk/command-status`",
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "daisyclaw/plugin-sdk/command-auth buildCommandsMessage",
      "daisyclaw/plugin-sdk/command-auth buildCommandsMessagePaginated",
      "daisyclaw/plugin-sdk/command-auth buildHelpMessage",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`DaisyClawConfig`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["daisyclaw/plugin-sdk `ClawdbotConfig` type export"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-index.test.ts"],
  },
  {
    code: "daisyclaw-schema-type-alias",
    status: "deprecated",
    owner: "sdk",
    introduced: "2026-04-26",
    deprecated: "2026-04-26",
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`DaisyClawConfig` from `daisyclaw/plugin-sdk/config-schema`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["daisyclaw/plugin-sdk `DaisyClawSchemaType` type export"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-index.test.ts"],
  },
  {
    ...
    removeAfter: "2026-07-26",
    replacement:
      "injected `api.runtime.*` helpers or focused `daisyclaw/plugin-sdk/<subpath>` imports",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["daisyclaw/extension-api"],
    diagnostics: ["DAISYCLAW_EXTENSION_API_DEPRECATED"],
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "daisyclaw/plugin-sdk/channel-actions createMessageToolButtonsSchema",
      "daisyclaw/plugin-sdk/channel-actions createMessageToolCardSchema",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "daisyclaw/plugin-sdk/channel-inbound resolveMentionGating",
      "daisyclaw/plugin-sdk/channel-inbound resolveMentionGatingWithBypass",
      "daisyclaw/plugin-sdk/channel-mention-gating resolveMentionGating",
      "daisyclaw/plugin-sdk/channel-mention-gating resolveMentionGatingWithBypass",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
    ...
    docsPath: "/plugins/sdk-provider-plugins",
    surfaces: ["daisyclaw/plugin-sdk/provider-web-search createPluginBackedWebSearchProvider"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "focused `daisyclaw/plugin-sdk/*` test subpaths",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["daisyclaw/plugin-sdk/test-utils"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
      "src/plugins/compat/registry.test.ts",
      "src/plugins/contracts/plugin-sdk-subpaths.test.ts",
