...
const mocks = vi.hoisted(() => {
  ...
  return {
    discoverDaisyClawPlugins: vi.fn(() => ({ candidates: [], diagnostics: [] })),
...
vi.mock("./discovery.js", () => ({
  discoverDaisyClawPlugins: mocks.discoverDaisyClawPlugins,
}));
...
function createPluginRecord(
  ...
  return {
    ...
    hooks: [],
    source: `/tmp/${overrides.id}/daisyclaw.plugin.json`,
...
describe("resolvePluginConfigContractsById", () => {
  beforeEach(() => {
    mocks.discoverDaisyClawPlugins.mockReset();
    mocks.discoverDaisyClawPlugins.mockReturnValue({ candidates: [], diagnostics: [] });
