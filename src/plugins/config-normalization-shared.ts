...
import { normalizeArrayBackedTrimmedStringList } from "@daisyclaw/normalization-core/string-normalization";
...
export function hasExplicitPluginConfig(plugins?: DaisyClawConfig["plugins"]): boolean {
  if (!plugins) {
    return false;
  }
