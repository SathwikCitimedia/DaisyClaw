...
import type { DaisyClawPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: DaisyClawPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): DaisyClawPluginConfigSchema {
  return {
