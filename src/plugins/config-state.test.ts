...
describe("normalizePluginsConfig", () => {
  ...
  it("normalizes unknown plugin ids without consulting discovery", async () => {
    const discoverPlugins = vi.spyOn(discovery, "discoverDaisyClawPlugins");
  ...
  it("does not consult discovery or manifests for alias lookup", async () => {
    const discoverPlugins = vi.spyOn(discovery, "discoverDaisyClawPlugins").mockReturnValue({
      candidates: [
        {
          idHint: "anthropic",
          source: "/tmp/daisyclaw-bundled-anthropic/index.js",
          rootDir: "/tmp/daisyclaw-bundled-anthropic",
          origin: "bundled",
          bundledManifest: {
            id: "anthropic",
            configSchema: {},
        ...
        },
        {
          ...
          source: "/tmp/daisyclaw-global-anthropic/index.js",
          rootDir: "/tmp/daisyclaw-global-anthropic",
          origin: "global",
        },
      ],
      diagnostics: [],
    ...
    const loadManifest = vi.spyOn(manifest, "loadPluginManifest").mockReturnValue({
      ok: true,
      manifestPath: "/tmp/daisyclaw-global-anthropic/daisyclaw.plugin.json",
      manifest: {
