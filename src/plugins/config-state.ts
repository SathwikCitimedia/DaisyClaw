...
} & PluginActivationConfigSourceLike<DaisyClawConfig>;
...
export const normalizePluginsConfig = (
  config?: DaisyClawConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: DaisyClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.hasOwn(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: DaisyClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.hasOwn(plugins.entries, defaultSlotIdForKey("memory")));

export const hasExplicitPluginConfig = (plugins?: DaisyClawConfig["plugins"]) =>
