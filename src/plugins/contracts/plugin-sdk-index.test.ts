...
import type { ClawdbotConfig, DaisyClawConfig, DaisyClawSchemaType } from "../../plugin-sdk/index.js";
...
describe("plugin-sdk exports", () => {
  ...
  it("keeps deprecated root config type aliases aligned", () => {
    expectTypeOf<ClawdbotConfig>().toEqualTypeOf<DaisyClawConfig>();
    expectTypeOf<DaisyClawSchemaType>().toEqualTypeOf<DaisyClawConfig>();
  });
