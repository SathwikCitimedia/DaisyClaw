...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "imessage", relativePath: "runtime-api.ts" })]:
    [
      'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin } from "daisyclaw/plugin-sdk/core";',
      ...
      'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "daisyclaw/plugin-sdk/status-helpers";',
      'export { formatTrimmedAllowFromEntries } from "daisyclaw/plugin-sdk/channel-config-helpers";',
      ...
      'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiDaisyClawConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
    ],
  [bundledPluginFile({
    rootDir: ROOT_DIR,
    pluginId: "googlechat",
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "daisyclaw/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema } from "daisyclaw/plugin-sdk/channel-config-primitives";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "daisyclaw/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "daisyclaw/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "daisyclaw/plugin-sdk/channel-outbound";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "daisyclaw/plugin-sdk/runtime-group-policy";',
    'export { isDangerousNameMatchingEnabled } from "daisyclaw/plugin-sdk/dangerous-name-runtime";',
    'export { readRemoteMediaBuffer, resolveChannelMediaMaxBytes } from "daisyclaw/plugin-sdk/media-runtime";',
    ...
    'export type { GoogleChatAccountConfig, GoogleChatConfig } from "daisyclaw/plugin-sdk/config-contracts";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "daisyclaw/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "daisyclaw/plugin-sdk/webhook-request-guards";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "msteams", relativePath: "runtime-api.ts" })]: [
    ...
    'export { mergeAllowlist, resolveAllowlistMatchSimple, summarizeMapping } from "daisyclaw/plugin-sdk/allow-from";',
    'export type { BaseProbeResult, ChannelDirectoryEntry, ChannelGroupContext, ChannelMessageActionName, ChannelOutboundAdapter } from "daisyclaw/plugin-sdk/channel-contract";',
    ...
    'export { createChannelMessageReplyPipeline } from "daisyclaw/plugin-sdk/channel-outbound";',
    'export { PAIRING_APPROVED_MESSAGE, buildProbeChannelStatusSummary, createDefaultChannelRuntimeState } from "daisyclaw/plugin-sdk/channel-status";',
    'export { buildChannelKeyCandidates, normalizeChannelSlug, resolveChannelEntryMatchWithFallback, resolveNestedAllowlistDecision } from "daisyclaw/plugin-sdk/channel-targets";',
    'export type { GroupPolicy, GroupToolPolicyConfig, MSTeamsChannelConfig, MSTeamsCloudName, MSTeamsConfig, MSTeamsReplyStyle, MSTeamsTeamConfig, MarkdownTableMode, DaisyClawConfig } from "daisyclaw/plugin-sdk/config-contracts";',
    'export { isDangerousNameMatchingEnabled } from "daisyclaw/plugin-sdk/dangerous-name-runtime";',
    ...
    'export { detectMime, extensionForMime, extractOriginalFilename, getFileExtension, resolveChannelMediaMaxBytes } from "daisyclaw/plugin-sdk/media-runtime";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "daisyclaw/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext } from "daisyclaw/plugin-sdk/channel-contract";',
    'export type { DaisyClawConfig } from "daisyclaw/plugin-sdk/config-contracts";',
    ...
    'export type { RuntimeEnv } from "daisyclaw/plugin-sdk/runtime-env";',
  ...
  [bundledPluginFile({
    ...
    'export { createChannelPairingController } from "daisyclaw/plugin-sdk/channel-pairing";',
    'export type { BlockStreamingCoalesceConfig, DmConfig, DmPolicy, GroupPolicy, GroupToolPolicyConfig, DaisyClawConfig } from "daisyclaw/plugin-sdk/config-contracts";',
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "daisyclaw/plugin-sdk/runtime-group-policy";',
    'export { createChannelMessageReplyPipeline } from "daisyclaw/plugin-sdk/channel-outbound";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export type { DaisyClawPluginService, DaisyClawPluginServiceContext, PluginLogger } from "daisyclaw/plugin-sdk/plugin-entry";',
      'export type { PluginRuntime } from "daisyclaw/plugin-sdk/runtime-store";',
      'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "daisyclaw/plugin-sdk/acp-runtime";',
      'export { AcpRuntimeError } from "daisyclaw/plugin-sdk/acp-runtime";',
      'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "daisyclaw/plugin-sdk/channel-plugin-common";',
      'export { clearAccountEntryFields } from "daisyclaw/plugin-sdk/channel-core";',
      ...
      'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "daisyclaw/plugin-sdk/channel-status";',
      'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "daisyclaw/plugin-sdk/channel-actions";',
      ...
      'export type { ChannelPlugin } from "daisyclaw/plugin-sdk/channel-core";',
      'export type { DaisyClawConfig } from "daisyclaw/plugin-sdk/config-contracts";',
      'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeDaisyClawConfig["channels"]>["telegram"] >;',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "twitch", relativePath: "runtime-api.ts" })]: [
    'export type { ChannelAccountSnapshot, ChannelCapabilities, ChannelGatewayContext, ChannelLogSink, ChannelMessageActionAdapter, ChannelMessageActionContext, ChannelMeta, ChannelOutboundAdapter, ChannelOutboundContext, ChannelResolveKind, ChannelResolveResult, ChannelStatusAdapter } from "daisyclaw/plugin-sdk/channel-contract";',
    'export type { ChannelPlugin } from "daisyclaw/plugin-sdk/channel-core";',
  ...
  [bundledPluginFile({
    ...
    'export { isRequestBodyLimitError, readRequestBodyWithLimit, requestBodyErrorToText } from "daisyclaw/plugin-sdk/webhook-request-guards";',
    ...
    'export { TtsAutoSchema, TtsConfigSchema, TtsModeSchema, TtsProviderSchema } from "daisyclaw/plugin-sdk/tts-runtime";',
...
describe("runtime api guardrails", () => {
  ...
  it("keeps bundled runtime api barrels off their own branded sdk facades", () => {
    for (const [pluginId, rootDir] of getBundledPluginRoots().entries()) {
      ...
      ).not.toContain(`"daisyclaw/plugin-sdk/${pluginId}"`);
      expect(
        source,
        `${pluginId} runtime api should use generic sdk subpaths or local exports`,
      ).not.toContain(`'daisyclaw/plugin-sdk/${pluginId}'`);
