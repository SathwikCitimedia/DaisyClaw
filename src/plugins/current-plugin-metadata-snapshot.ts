...
import { setCurrentManifestModelIdNormalizationRecords } from "@daisyclaw/model-catalog-core/provider-model-id-normalization";
...
let currentPluginMetadataConfigIdentityCache = new WeakSet<DaisyClawConfig>();
...
export function setCurrentPluginMetadataSnapshot(
  ...
  options: {
    config?: DaisyClawConfig;
    compatibleConfigs?: readonly DaisyClawConfig[];
