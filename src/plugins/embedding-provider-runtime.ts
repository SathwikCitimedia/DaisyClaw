...
export function listEmbeddingProviders(cfg?: DaisyClawConfig): EmbeddingProviderAdapter[] {
...
function resolveEmbeddingProviderLookupIds(id: string, cfg?: DaisyClawConfig): string[] {
