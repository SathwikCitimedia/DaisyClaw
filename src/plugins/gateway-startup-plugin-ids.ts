...
import { buildModelCatalogMergeKey } from "@daisyclaw/model-catalog-core/model-catalog-refs";
import {
...
function normalizePluginsConfigForInstalledIndex(
  config: DaisyClawConfig["plugins"] | undefined,
...
function listPotentialEnabledChannelIds(config: DaisyClawConfig, env: NodeJS.ProcessEnv): string[] {
...
function resolveGatewayStartupDreamingPluginIds(config: DaisyClawConfig): Set<string> {
...
function collectConfiguredWebSearchProviderIds(config: DaisyClawConfig): ReadonlySet<string> {
...
function collectConfiguredVoiceProviderIds(config: DaisyClawConfig): ConfiguredVoiceProviderIds {
...
function isMemorySlotExplicitlyDisabled(config: DaisyClawConfig): boolean {
...
function collectValidationHeartbeatTargetChannelIds(config: DaisyClawConfig): string[] {
...
function collectValidationChannelConfigIds(config: DaisyClawConfig): string[] {
...
function collectConfiguredProviderIds(config: DaisyClawConfig): string[] {
...
function collectValidationConfiguredProviderIds(config: DaisyClawConfig): string[] {
...
function collectValidationConfiguredShorthandModelIds(config: DaisyClawConfig): string[] {
  return sortUniquePluginIds(
