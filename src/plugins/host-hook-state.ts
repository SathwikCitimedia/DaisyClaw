...
function loadPluginHostHookSessionEntry(params: { cfg: DaisyClawConfig; sessionKey: string }): {
  storePath: string;
  entry?: SessionEntry;
  canonicalKey: string;
  storeKey: string;
...
function isPluginPromptInjectionEnabled(cfg: DaisyClawConfig, pluginId: string): boolean {
