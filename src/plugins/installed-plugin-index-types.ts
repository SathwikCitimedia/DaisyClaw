...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by DaisyClaw from plugin manifests, install records, and config policy. Use `daisyclaw plugins registry --refresh`, `daisyclaw plugins install/update/uninstall`, or `daisyclaw plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored daisyclaw.install metadata. This describes catalog/package
