  ...
  it.each([
    {
      ...
      input: {
        name: "@daisyclaw/demo",
        version: "1.2.3",
        resolvedSpec: "@daisyclaw/demo@1.2.3",
...
describe("resolveNpmInstallRecordSpec", () => {
  it("uses an exact resolved registry spec when managed installs request pinning", () => {
    expect(
      resolveNpmInstallRecordSpec({
        requestedSpec: "@daisyclaw/codex",
        resolution: {
          name: "@daisyclaw/codex",
          version: "2026.5.30-beta.1",
          resolvedSpec: "@daisyclaw/codex@2026.5.30-beta.1",
        },
        pinResolvedRegistrySpec: true,
      }),
    ).toBe("@daisyclaw/codex@2026.5.30-beta.1");
  });
    ...
    expect(
      resolveNpmInstallRecordSpec({
        ...
        resolution: {
          name: "@daisyclaw/codex",
          version: "2026.5.30-beta.1",
          resolvedSpec: "@daisyclaw/codex@beta",
        },
        pinResolvedRegistrySpec: true,
      }),
    ).toBe("@daisyclaw/codex");
