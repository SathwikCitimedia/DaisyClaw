...
import { loadDaisyClawPluginCliRegistry, loadDaisyClawPlugins } from "./loader.js";
import {
...
describe("plugin loader CLI metadata", () => {
  it.each([
    ...
    async ({ id, kind, error }) => {
      ...
      const registry = await loadDaisyClawPluginCliRegistry({
        cache: false,
        logger: {
          info: () => {},
          warn: () => {},
  ...
  it("uses the real channel entry in cli-metadata mode for CLI metadata capture", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@daisyclaw/cli-metadata-channel",
          daisyclaw: { extensions: ["./index.cjs"], setupEntry: "./setup-entry.cjs" },
        },
        null,
        2,
      ),
...
module.exports = {
  ...
  it("skips bundled channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@daisyclaw/bundled-skip-channel",
...
module.exports = {
  ...
  it("prefers bundled channel cli-metadata entries over full channel entries", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@daisyclaw/bundled-cli-channel",
          daisyclaw: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("skips bundled non-channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@daisyclaw/bundled-skip-provider",
          daisyclaw: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during full plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@daisyclaw/full-cli-metadata-channel",
          daisyclaw: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during discovery plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@daisyclaw/discovery-cli-metadata-channel",
          daisyclaw: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("can force channel runtime entries for CLI registration when setup entries exist", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@daisyclaw/force-runtime-cli-channel",
          daisyclaw: { extensions: ["./index.cjs"], setupEntry: "./setup-entry.cjs" },
        },
        null,
        2,
...
module.exports = {
  ...
  require("node:fs").writeFileSync(${JSON.stringify(runtimeMarker)}, "loaded", "utf-8");
    ...
    entry.register({
      ...
      runtime: {} as DaisyClawPluginApi["runtime"],
