...
function resolveMemoryRuntimePluginIds(config: DaisyClawConfig): string[] {
...
function resolveMemoryRuntimeWorkspaceDir(cfg: DaisyClawConfig): string | undefined {
...
function ensureMemoryRuntime(cfg?: DaisyClawConfig) {
...
export function resolveActiveMemoryBackendConfig(params: { cfg: DaisyClawConfig; agentId: string }) {
  return ensureMemoryRuntime(params.cfg)?.resolveMemoryBackendConfig(params) ?? null;
}

/** Closes all active plugin-backed memory search managers. */
export async function closeActiveMemorySearchManagers(cfg?: DaisyClawConfig): Promise<void> {
  void cfg;
