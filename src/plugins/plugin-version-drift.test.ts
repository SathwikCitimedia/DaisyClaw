...
function npmRecord(
  ...
  const resolvedName = overrides.resolvedName ?? "@daisyclaw/whatsapp";
  return {
    source: "npm",
...
describe("detectPluginVersionDrift", () => {
  it("returns empty drifts when all externalized plugins match the gateway", () => {
    const result = detectPluginVersionDrift({
      ...
      installRecords: {
        ...
        discord: npmRecord("2026.5.4", { resolvedName: "@daisyclaw/discord" }),
      },
    });
    ...
    const result = detectPluginVersionDrift({
      ...
      installRecords: {
        whatsapp: npmRecord("2026.5.3", {
          ...
          spec: "@daisyclaw/whatsapp@2026.5.3",
        }),
        discord: npmRecord("2026.5.4", { resolvedName: "@daisyclaw/discord" }),
      },
    });
  ...
  it("treats a build-qualifier suffix on either side as matching (2026.5.4-1 ≈ 2026.5.4)", () => {
    const result = detectPluginVersionDrift({
      ...
      installRecords: {
        ...
        discord: npmRecord("2026.5.4-1", { resolvedName: "@daisyclaw/discord" }),
      },
    });
  ...
  it("ignores official catalog installs pinned to independent package versions", () => {
    const result = detectPluginVersionDrift({
      gatewayVersion: "2026.5.4",
      installRecords: {
        "daisyclaw-plugin-yuanbao": npmRecord("2.13.1", {
          resolvedName: "daisyclaw-plugin-yuanbao",
          spec: "daisyclaw-plugin-yuanbao@2.13.1",
        }),
      },
    });
  ...
  it("ignores exact catalog pins even when the pin matches the gateway version", () => {
    const result = detectPluginVersionDrift({
      ...
      installRecords: {
        "wecom-daisyclaw-plugin": npmRecord("2026.5.6", {
          resolvedName: "@wecom/wecom-daisyclaw-plugin",
          spec: "@wecom/wecom-daisyclaw-plugin@2026.5.6",
        }),
      },
    });
    ...
    const result = detectPluginVersionDrift({
      ...
      installRecords: {
        ...
        archive: {
          ...
          spec: "@daisyclaw/whatsapp@archive",
        },
        local: {
          source: "path",
          resolvedName: "@daisyclaw/whatsapp",
  ...
  it("falls back to the install record's `version` field when `resolvedVersion` is absent", () => {
    const result = detectPluginVersionDrift({
      ...
      installRecords: {
        whatsapp: {
          source: "npm",
          spec: "@daisyclaw/whatsapp@latest",
          resolvedName: "@daisyclaw/whatsapp",
          version: "2026.5.3",
        },
      },
  ...
  it("skips plugins with no recorded version (cannot detect drift)", () => {
    const result = detectPluginVersionDrift({
      gatewayVersion: "2026.5.4",
      installRecords: {
        whatsapp: { source: "npm", spec: "@daisyclaw/whatsapp@latest" },
      },
    });
  ...
  it("skips plugins that are explicitly disabled in config", () => {
    ...
    const result = detectPluginVersionDrift({
      ...
      installRecords: {
        whatsapp: npmRecord("2026.5.3"),
        discord: npmRecord("2026.5.3", { resolvedName: "@daisyclaw/discord" }),
      },
      config,
    });
  ...
  it("includes plugins with no entry in config (default-enabled)", () => {
    const config: DaisyClawConfig = { plugins: { entries: {} } } as DaisyClawConfig;
    const result = detectPluginVersionDrift({
      gatewayVersion: "2026.5.4",
      installRecords: {
        whatsapp: npmRecord("2026.5.3"),
  ...
  it("returns drifts sorted by pluginId for deterministic output", () => {
    const result = detectPluginVersionDrift({
      ...
      installRecords: {
        whatsapp: npmRecord("2026.5.3"),
        discord: npmRecord("2026.5.3", { resolvedName: "@daisyclaw/discord" }),
        matrix: npmRecord("2026.5.3", { resolvedName: "@daisyclaw/matrix" }),
      },
    });
