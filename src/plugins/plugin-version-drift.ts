...
function isPluginEnabled(config: DaisyClawConfig | undefined, pluginId: string): boolean {
 ...
 *   `version` field of the installed daisyclaw package.json).
 ...
 * @param params.config The merged daemon-side DaisyClawConfig (optional).
