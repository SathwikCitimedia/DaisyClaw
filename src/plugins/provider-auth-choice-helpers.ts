...
function normalizeModelProviderConfigsForWrite(cfg: DaisyClawConfig): DaisyClawConfig {
...
function normalizeConfigModelRefsForWrite(cfg: DaisyClawConfig): DaisyClawConfig {
    ...
    agents: {
      ...
      defaults: {
        ...
        models: sanitizeConfigPatchValue(patchModels) as NonNullable<
          NonNullable<DaisyClawConfig["agents"]>["defaults"]
        >["models"],
      },
    },
  });
