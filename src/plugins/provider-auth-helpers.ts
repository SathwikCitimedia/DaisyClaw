...
const resolveAuthAgentDir = (agentDir?: string, config?: DaisyClawConfig) =>
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: DaisyClawConfig): SecretRef {
