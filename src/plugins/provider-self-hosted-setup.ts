...
export function applyProviderDefaultModel(cfg: DaisyClawConfig, modelRef: string): DaisyClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: DaisyClawConfig; modelId: string; modelRef: string; profileId: string } {
