...
describe("plugin registry runtime config scope", () => {
  it("adds plugin context to lazy runtime resolution failures", () => {
    const runtime = new Proxy({} as PluginRuntime, {
      get() {
        throw new Error("Unable to resolve plugin runtime module; loader=/tmp/daisyclaw-loader.js");
      },
    });
    ...
    const api = pluginRegistry.createApi(record, { config: {} as DaisyClawConfig });
