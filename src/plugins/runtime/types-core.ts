...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.daisyclaw.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.daisyclaw.js").DaisyClawConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.daisyclaw.js").DaisyClawConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.daisyclaw.js").DaisyClawConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.daisyclaw.js").DaisyClawConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.daisyclaw.js").DaisyClawConfig,
  ...
  media: {
    ...
    detectMime: typeof import("@daisyclaw/media-core/mime").detectMime;
    mediaKindFromMime: typeof import("@daisyclaw/media-core/constants").mediaKindFromMime;
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("daisyclaw/plugin-sdk/llm").Model<import("daisyclaw/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.daisyclaw.js").DaisyClawConfig;
      workspaceDir?: string;
