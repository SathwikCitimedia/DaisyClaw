...
import type { DaisyClawPluginService, DaisyClawPluginServiceContext } from "./types.js";
...
function createRegistry(
  services: DaisyClawPluginService[],
...
function expectServiceLogger(ctx: DaisyClawPluginServiceContext) {
...
function expectServiceContexts(
  contexts: DaisyClawPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: DaisyClawPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: DaisyClawPluginServiceContext[] = [];
    ...
    const officialInstallContexts: DaisyClawPluginServiceContext[] = [];
    ...
    const untrustedContexts: DaisyClawPluginServiceContext[] = [];
    ...
    const spoofedContexts: DaisyClawPluginServiceContext[] = [];
