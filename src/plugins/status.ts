...
import { normalizeDaisyClawVersionBase } from "../config/version.js";
...
import { loadDaisyClawPlugins } from "./loader.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeDaisyClawVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeDaisyClawVersionBase(plugin.version) ??
    plugin.version
  );
}
