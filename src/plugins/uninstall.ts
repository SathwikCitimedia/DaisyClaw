...
import { relinkDaisyClawPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link.js";
...
export function removePluginFromConfig(
  ...
  pluginId: string,
  opts?: { channelIds?: string[] },
): { config: DaisyClawConfig; actions: Omit<UninstallActions, "directory"> } {
  ...
  const config: DaisyClawConfig = {
    ...
    channels: channels as DaisyClawConfig["channels"],
  };
