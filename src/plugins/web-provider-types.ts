...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: DaisyClawConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: DaisyClawConfig, value: unknown) => void;
  getConfiguredCredentialFallback?: (
    config?: DaisyClawConfig,
  ) => WebSearchProviderConfiguredCredentialFallback | undefined;
  applySelectionConfig?: (config: DaisyClawConfig) => DaisyClawConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => DaisyClawConfig | Promise<DaisyClawConfig>;
