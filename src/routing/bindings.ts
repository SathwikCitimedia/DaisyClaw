...
export function listBindings(cfg: DaisyClawConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: DaisyClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: DaisyClawConfig) {
