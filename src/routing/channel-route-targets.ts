...
function listConfiguredChannelIds(cfg: DaisyClawConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: DaisyClawConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: DaisyClawConfig): ChannelRouteTarget[] {
