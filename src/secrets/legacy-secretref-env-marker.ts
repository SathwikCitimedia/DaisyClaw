...
function toCandidate(
  ...
  defaults: NonNullable<DaisyClawConfig["secrets"]>["defaults"] | undefined,
 ...
 */
export function migrateLegacySecretRefEnvMarkers(config: DaisyClawConfig): {
  config: DaisyClawConfig;
  changes: string[];
} {
  ...
  const next = structuredClone(config) as DaisyClawConfig & Record<string, unknown>;
