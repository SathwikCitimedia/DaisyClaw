...
function makeContext(sourceConfig: DaisyClawConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: DaisyClawConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: DaisyClawConfig): void {
