...
function hasConfiguredPluginEntries(config: DaisyClawConfig): boolean {
...
function hasConfiguredChannelEntries(config: DaisyClawConfig): boolean {
...
function hasConfiguredPluginIntegrationSecretProviders(config: DaisyClawConfig): boolean {
...
function shouldLoadPluginMetadataForSecrets(config: DaisyClawConfig): boolean {
  return (
