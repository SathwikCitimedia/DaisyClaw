...
// Candidate scanning only sees daisyclaw.json; auth-profile-only surfaces are audited elsewhere.
...
/**
 * Concrete unsupported config value discovered from an daisyclaw.json-like object.
 */
...
/**
 * Finds configured daisyclaw.json values whose surfaces currently reject SecretRef objects.
 */
