...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof DaisyClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: DaisyClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: DaisyClawConfig;
  changes: string[];
} {
