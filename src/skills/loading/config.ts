...
export function resolveSkillsInstallPreferences(config?: DaisyClawConfig): SkillsInstallPreferences {
...
export function isConfigPathTruthy(config: DaisyClawConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["daisyclaw-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: DaisyClawConfig): ReadonlySet<string> | undefined {
