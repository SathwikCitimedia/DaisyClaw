...
function hasConfiguredSkillApiKeyRef(config?: DaisyClawConfig): boolean {
...
export function resolveSkillRuntimeConfig(config?: DaisyClawConfig): DaisyClawConfig | undefined {
