...
import type { DaisyClawSkillMetadata, SkillEntry } from "../types.js";
...
const fixtureSuite = createFixtureSuite("daisyclaw-skills-prompt-suite-");
...
function createSkillEntry(params: {
  name: string;
  description?: string;
  metadata?: DaisyClawSkillMetadata;
}): SkillEntry {
