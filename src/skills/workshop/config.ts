// Workshop config helpers resolve skill workshop settings from DaisyClaw config.
...
export function resolveSkillWorkshopConfig(config?: DaisyClawConfig): SkillWorkshopConfig {
