...
export const SKILL_WORKSHOP_SCHEMA = "daisyclaw.skill-workshop.proposal.v1" as const;
export const SKILL_WORKSHOP_MANIFEST_SCHEMA =
  "daisyclaw.skill-workshop.proposals-manifest.v1" as const;
export const SKILL_WORKSHOP_ROLLBACK_SCHEMA = "daisyclaw.skill-workshop.rollback.v1" as const;
