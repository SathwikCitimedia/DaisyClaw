...
function resolveRealtimeVoiceProviderEntries(cfg?: DaisyClawConfig): RealtimeVoiceProviderPlugin[] {
 ...
 */
export function listRealtimeVoiceProviders(cfg?: DaisyClawConfig): RealtimeVoiceProviderPlugin[] {
