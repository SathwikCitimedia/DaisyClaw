...
function resolveTranscriptsSourceProviderEntries(cfg?: DaisyClawConfig): TranscriptSourceProvider[] {
...
function buildProviderMaps(cfg?: DaisyClawConfig): {
...
export function listTranscriptSourceProviders(cfg?: DaisyClawConfig): TranscriptSourceProvider[] {
