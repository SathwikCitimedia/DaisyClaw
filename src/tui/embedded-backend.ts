...
function hasProviderWildcardModelAllowlist(cfg: DaisyClawConfig) {
  const modelMaps = [
...
function resolveConfiguredReplaceModeCatalog(cfg: DaisyClawConfig) {
...
function shouldLoadFullGatewayCatalogForReplaceMode(cfg: DaisyClawConfig) {
...
async function loadEmbeddedTuiModelCatalog(cfg: DaisyClawConfig) {
      ...
      const result = await agentCommandFromIngress(
        {
          ...
          // bytes on the wire. See: https://github.com/daisyclaw/daisyclaw/issues/3658
