...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in DaisyClaw config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `daisyclaw doctor` next.",
    ...
    plugins: {
      ...
      sensitiveField:
        '"{label}" is sensitive. Set it via:\n  daisyclaw config set plugins.entries.{plugin}.config.{field} <value>\nor use the Web UI Settings page.',
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: DAISYCLAW_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in DaisyClaw config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in DaisyClaw config",
    ...
    security: {
      ...
      beta: "DaisyClaw is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run DaisyClaw.",
      learnMore: "Learn more",
      notMultitenant: "DaisyClaw is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, DaisyClaw is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.daisyclaw.ai/skills",
      enterEnv: "Enter {env}",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "DaisyClaw" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so DaisyClaw can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for DaisyClaw",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: daisyclaw channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL DaisyClaw uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "DaisyClaw"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var DAISYCLAW_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: DAISYCLAW_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to DaisyClaw with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with daisyclaw configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.daisyclaw.ai/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control DaisyClaw.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control DaisyClaw.",
      ...
      gatewayTokenStored:
        "Stored in: $DAISYCLAW_CONFIG_PATH (default: ~/.daisyclaw/daisyclaw.json) under gateway.auth.token, or in DAISYCLAW_GATEWAY_TOKEN.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control DaisyClaw.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control DaisyClaw.",
      outroSeeded:
      ...
      restart: "Restart",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.daisyclaw.ai/security",
      ...
      webDocs: "Docs: https://docs.daisyclaw.ai/tools/web",
      ...
      whatNow: 'What now: https://daisyclaw.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.daisyclaw.ai/concepts/agent-workspace",
