  ...
  it("installs selected optional official plugins through the shared onboarding installer", async () => {
      ...
      expect.arrayContaining([
        {
          value: "acpx",
          label: "ACPX Runtime",
          hint: "DaisyClaw ACP runtime backend",
        },
        {
          value: "diagnostics-otel",
          label: "Diagnostics OpenTelemetry",
          hint: "DaisyClaw diagnostics OpenTelemetry exporter",
        },
        {
          value: "diagnostics-prometheus",
          label: "Diagnostics Prometheus",
          hint: "DaisyClaw diagnostics Prometheus exporter",
        },
        {
          value: "tokenjuice",
          label: "Tokenjuice",
          hint: "DaisyClaw tokenjuice exec output compaction plugin",
        },
      ]),
    );
    expect(ensureOnboardingPluginInstalled).toHaveBeenCalledExactlyOnceWith({
      ...
      entry: {
        ...
        label: "Diagnostics OpenTelemetry",
        description: "DaisyClaw diagnostics OpenTelemetry exporter",
        install: {
          clawhubSpec: "clawhub:@daisyclaw/diagnostics-otel",
          npmSpec: "@daisyclaw/diagnostics-otel",
          defaultChoice: "npm",
