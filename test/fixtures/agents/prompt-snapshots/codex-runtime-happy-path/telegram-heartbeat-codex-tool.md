...
```json
{
  ...
  "simulatedHeartbeatWorkspaceFile": "/tmp/daisyclaw-happy-path/workspace/HEARTBEAT.md",
  "simulatedWorkspaceBootstrapFiles": ["/tmp/daisyclaw-happy-path/workspace/MEMORY.md"],
  "simulatedWorkspaceDeveloperInstructionFiles": ["/tmp/daisyclaw-happy-path/workspace/TOOLS.md"],
  "simulatedWorkspaceTurnScopedDeveloperInstructionFiles": [
    "/tmp/daisyclaw-happy-path/workspace/IDENTITY.md",
    "/tmp/daisyclaw-happy-path/workspace/SOUL.md",
    "/tmp/daisyclaw-happy-path/workspace/USER.md"
  ],
...
```json
{
  ...
  "cwd": "/tmp/daisyclaw-happy-path/workspace",
...
```json
{
  ...
  "daisyClawRuntime": {
    ...
    "workspaceBootstrapContextFrom": "extensions/codex app-server turn/start input DaisyClaw runtime context"
  }
}
```
...
Deferred searchable DaisyClaw dynamic tools available: agents_list, cron, gateway, heartbeat_respond, nodes, session_status, sessions_history, sessions_list, sessions_send, sessions_spawn, subagents, tts, web_fetch, web_search. Use `tool_search` to load exact callable specs before use.
...
### /tmp/daisyclaw-happy-path/workspace/TOOLS.md
...
## /tmp/daisyclaw-happy-path/workspace/MEMORY.md
