// DaisyClaw test instance helper spawns isolated DaisyClaw processes.
...
import {
  ...
  type DaisyClawTestStateOptions,
} from "../../src/test-utils/daisyclaw-test-state.js";
import { sleep } from "../../src/utils.js";

export type DaisyClawTestInstanceOptions = {
  name: string;
  cwd?: string;
  port?: number;
  gatewayToken?: string;
  ...
  state?: Omit<DaisyClawTestStateOptions, "applyEnv" | "gateway" | "env">;
  gatewayArgs?: string[];
  startTimeoutMs?: number;
  stopTimeoutMs?: number;
};

export type DaisyClawTestInstanceCommandResult = {
  code: number | null;
...
export type DaisyClawTestInstance = {
  name: string;
  port: number;
  url: string;
  hookToken: string;
  ...
  ) => Promise<DaisyClawTestInstanceCommandResult>;
...
export async function createDaisyClawTestInstance(
  options: DaisyClawTestInstanceOptions,
): Promise<DaisyClawTestInstance> {
  ...
  const instance: DaisyClawTestInstance = {
    name: options.name,
    port,
