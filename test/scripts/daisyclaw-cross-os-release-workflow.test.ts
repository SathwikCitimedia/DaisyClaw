// Daisyclaw Cross Os Release Workflow tests cover daisyclaw cross os release workflow script behavior.
import { readFileSync } from "node:fs";
import { describe, expect, it } from "vitest";

const WORKFLOW_PATH = ".github/workflows/daisyclaw-cross-os-release-checks-reusable.yml";
const WRAPPER_PATH = "scripts/github/run-daisyclaw-cross-os-release-checks.sh";
const HARNESS = "bash workflow/scripts/github/run-daisyclaw-cross-os-release-checks.sh";
