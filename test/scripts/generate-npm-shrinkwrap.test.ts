...
describe("generate-npm-shrinkwrap", () => {
  ...
  it("accepts strict npm shrinkwrap command timeout and buffer overrides", () => {
    expect(
      createNpmShrinkwrapExecOptions({ command: "npm", args: ["install"] }, "/tmp/package", {
        DAISYCLAW_NPM_SHRINKWRAP_COMMAND_MAX_BUFFER_BYTES: "1048576",
        DAISYCLAW_NPM_SHRINKWRAP_COMMAND_TIMEOUT_MS: "30000",
      }),
    ).toMatchObject({
      maxBuffer: 1024 * 1024,
      timeout: 30000,
  ...
  it("rejects loose npm shrinkwrap command timeout and buffer overrides", () => {
    expect(() =>
      createNpmShrinkwrapExecOptions({ command: "npm", args: ["install"] }, "/tmp/package", {
        DAISYCLAW_NPM_SHRINKWRAP_COMMAND_TIMEOUT_MS: "30s",
      }),
    ).toThrow("invalid DAISYCLAW_NPM_SHRINKWRAP_COMMAND_TIMEOUT_MS: 30s");
    expect(() =>
      createNpmShrinkwrapExecOptions({ command: "npm", args: ["install"] }, "/tmp/package", {
        DAISYCLAW_NPM_SHRINKWRAP_COMMAND_MAX_BUFFER_BYTES: "64mb",
      }),
    ).toThrow("invalid DAISYCLAW_NPM_SHRINKWRAP_COMMAND_MAX_BUFFER_BYTES: 64mb");
  });
  ...
  it("parses nested scoped package paths", () => {
    expect(
      parseLockPackagePath("node_modules/@daisyclaw/codex/node_modules/@anthropic-ai/sdk"),
    ).toEqual([
      {
        name: "@daisyclaw/codex",
        path: "node_modules/@daisyclaw/codex",
      },
      {
        name: "@anthropic-ai/sdk",
        path: "node_modules/@daisyclaw/codex/node_modules/@anthropic-ai/sdk",
      },
    ]);
  });
  ...
  it("disables embedded shrinkwraps that hide workspace overrides", () => {
    const lockfile = {
      packages: {
        ...
        "node_modules/@daisyclaw/codex": {
          version: "0.75.4",
          hasShrinkwrap: true,
        },
        "node_modules/@daisyclaw/codex/node_modules/protobufjs": {
          version: "7.5.9",
        },
        "node_modules/@daisyclaw/codex/node_modules/fetch-blob": {
          version: "4.0.0",
        },
        "node_modules/@daisyclaw/codex/node_modules/fetch-blob/node_modules/node-domexception": {
          version: "1.0.0",
        },
      },
    };
    ...
    expect(lockfile.packages["node_modules/@daisyclaw/codex"]).not.toHaveProperty("hasShrinkwrap");
    expect(
      lockfile.packages["node_modules/@daisyclaw/codex/node_modules/protobufjs"],
    ).toBeUndefined();
  });
  ...
  it("uses legacy peer resolution when the package has optional peers", () => {
    expect(
      shouldUseLegacyPeerDepsForShrinkwrap({
        ...
        peerDependencies: { daisyclaw: ">=2026.5.30" },
