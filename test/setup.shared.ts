...
const openAiCodexTokenRefreshTestHook = "__DAISYCLAW_TEST_REFRESH_OPENAI_CODEX_TOKEN__";
...
// arbitrary DAISYCLAW_BUNDLED_PLUGINS_DIR overrides unless this Vitest-only opt-in is present.
