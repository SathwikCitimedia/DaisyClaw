...
export type DaisyClawVitestPool = "forks" | "threads";
...
export function resolveLocalVitestMaxWorkers(
  ...
  pool: DaisyClawVitestPool = resolveDefaultVitestPool(env),
): number {
...
function hasWorkerOverride(env: Record<string, string | undefined>): boolean {
  return Boolean((env.DAISYCLAW_VITEST_MAX_WORKERS ?? env.DAISYCLAW_TEST_WORKERS)?.trim());
}

function sourcePackageAlias(packageId: string, subpath?: string) {
  return {
    find: `@daisyclaw/${packageId}${subpath ? `/${subpath}` : ""}`,
...
const dependencyModuleDirectories = ["/node_modules/", "/daisyclaw-pnpm-node-modules/"];
const dependencyExternalPatterns = [
  /\/daisyclaw-pnpm-node-modules\/(?!.*\/?vite\w*\/dist\/client\/env\.mjs$).*\.(?:cjs\.js|mjs)$/u,
];
...
export const sharedVitestConfig = {
  ...
  resolve: {
    alias: [
      ...
      {
        find: "@daisyclaw/gateway-protocol/schema",
        replacement: path.join(repoRoot, "packages", "gateway-protocol", "src", "schema.ts"),
      },
      {
        find: "@daisyclaw/gateway-protocol/startup-unavailable",
        replacement: path.join(
          repoRoot,
          "packages",
          "gateway-protocol",
      ...
      {
        find: "@daisyclaw/model-catalog-core/model-catalog-refs",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@daisyclaw/model-catalog-core/model-catalog-normalize",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@daisyclaw/model-catalog-core/model-catalog-types",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@daisyclaw/model-catalog-core/provider-id",
        replacement: path.join(repoRoot, "packages", "model-catalog-core", "src", "provider-id.ts"),
      },
      {
        find: "@daisyclaw/model-catalog-core/provider-model-id-normalization",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@daisyclaw/model-catalog-core/provider-model-id-normalize",
        replacement: path.join(
          repoRoot,
          "packages",
          "model-catalog-core",
      ...
      {
        find: "@daisyclaw/normalization-core/record-coerce",
        replacement: path.join(
          repoRoot,
          "packages",
          "normalization-core",
      ...
      {
        find: "@daisyclaw/normalization-core/string-coerce",
        replacement: path.join(
          repoRoot,
          "packages",
          "normalization-core",
      ...
      {
        find: "@daisyclaw/normalization-core/string-normalization",
        replacement: path.join(
          repoRoot,
          "packages",
          "normalization-core",
      ...
      {
        find: "@daisyclaw/normalization-core",
      ...
      ...sourcePluginSdkSubpaths.map((subpath) => ({
        find: `daisyclaw/plugin-sdk/${subpath}`,
  ...
  test: {
    ...
    forceRerunTriggers: [
      ...
      "test/setup-daisyclaw-runtime.ts",
