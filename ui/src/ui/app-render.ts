...
const SKILL_WORKSHOP_MODE_KEY = "daisyclaw:control-ui:skill-workshop-mode:v1";
const SKILL_WORKSHOP_CURRENT_CHAT_REVISIONS_KEY =
  "daisyclaw:control-ui:skill-workshop-current-chat-revisions:v1";
...
const UPDATE_BANNER_DISMISS_KEY = "daisyclaw:control-ui:update-banner-dismissed:v1";
            ...
            <div class="sidebar-shell__footer">
              <div class="sidebar-utility-group">
                ...
                ${(() => {
                  ...
                  const brandTitle = version
                    ? `daisy intelligence · v${version}`
                    : "daisy intelligence";
                  return html`
                    <div class="sidebar-version sidebar-brand" title=${brandTitle}>
                      ${!navCollapsed
                        ? html`
                            <span class="sidebar-brand__wordmark" aria-label="daisy intelligence">
                              <span class="sidebar-brand__name">daisy</span>
                              <span class="sidebar-brand__sub">intelligence</span>
                            </span>
