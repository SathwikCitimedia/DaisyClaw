...
export class DaisyClawFilePreviewModal extends LitElement {
...
if (!customElements.get("daisyclaw-file-preview-modal")) {
  customElements.define("daisyclaw-file-preview-modal", DaisyClawFilePreviewModal);
}
...
declare global {
  interface HTMLElementTagNameMap {
    "daisyclaw-file-preview-modal": DaisyClawFilePreviewModal;
  }
}
