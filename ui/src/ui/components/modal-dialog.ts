...
export class DaisyClawModalDialog extends LitElement {
  @property() label = "";
  ...
  override render() {
    const labelId = this.label ? "daisyclaw-modal-dialog-label" : "";
    const descriptionId = this.description ? "daisyclaw-modal-dialog-description" : "";
    return html`
      <dialog
        role="dialog"
        aria-modal="true"
...
if (!customElements.get("daisyclaw-modal-dialog")) {
  customElements.define("daisyclaw-modal-dialog", DaisyClawModalDialog);
}

declare global {
  interface HTMLElementTagNameMap {
    "daisyclaw-modal-dialog": DaisyClawModalDialog;
  }
}
