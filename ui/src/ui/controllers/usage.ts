...
const LEGACY_USAGE_DATE_PARAMS_STORAGE_KEY = "daisyclaw.control.usage.date-params.v1";
const LEGACY_USAGE_SCOPE_PARAMS_STORAGE_KEY = "daisyclaw.control.usage.scope-params.v1";
const LEGACY_USAGE_AGENT_PARAMS_STORAGE_KEY = "daisyclaw.control.usage.agent-params.v1";
const LEGACY_USAGE_AGENT_SCOPE_STORAGE_KEY = "daisyclaw.control.usage.agent-scope.v1";
