...
function withControlUiBasePath<T>(basePath: string, fn: () => T): T {
  Object.defineProperty(window, "__DAISYCLAW_CONTROL_UI_BASE_PATH__", {
    value: basePath,
    writable: true,
    configurable: true,
  });
  try {
    ...
    delete window["__DAISYCLAW_CONTROL_UI_BASE_PATH__"];
  }
}
...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/daisyclaw");
      expect(html).toBe(
        '<p>Visit <a href="http://github.com/daisyclaw" rel="noreferrer noopener" target="_blank">http://github.com/daisyclaw</a></p>\n',
      );
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[DaisyClaw中文](https://docs.daisyclaw.ai)");
      expect(html).toBe(
        '<p><a href="https://docs.daisyclaw.ai" rel="noreferrer noopener" target="_blank">DaisyClaw中文</a></p>\n',
      );
    });
...
`;
  ...
  describe("security", () => {
    ...
    it("strips href from host-local absolute file paths", () => {
      const html = toSanitizedMarkdownHtml(
        "[report.docx](/Users/test/.daisyclaw/data/skills/output/report.docx)",
      );
    ...
    it("rewrites docs-root links to the public docs host", () => {
      ...
      expect(html).toBe(
        '<p><a href="https://docs.daisyclaw.ai/concepts/agent-workspace" rel="noreferrer noopener" target="_blank">workspace</a> <a href="https://docs.daisyclaw.ai/automation/hooks#session-memory" rel="noreferrer noopener" target="_blank">hooks</a> <a href="https://docs.daisyclaw.ai/channels/telegram?tab=setup" rel="noreferrer noopener" target="_blank">telegram</a> <a href="https://docs.daisyclaw.ai/telegram" rel="noreferrer noopener" target="_blank">shortlink</a> <a href="https://docs.daisyclaw.ai/openai" rel="noreferrer noopener" target="_blank">openai</a> <a href="https://docs.daisyclaw.ai/images" rel="noreferrer noopener" target="_blank">images</a> <a href="https://docs.daisyclaw.ai/groups" rel="noreferrer noopener" target="_blank">groups</a> <a href="https://docs.daisyclaw.ai/nodes/camera" rel="noreferrer noopener" target="_blank">camera</a> <a href="https://docs.daisyclaw.ai/platforms/macos" rel="noreferrer noopener" target="_blank">macOS</a> <a href="https://docs.daisyclaw.ai/cli/sessions" rel="noreferrer noopener" target="_blank">cliSessions</a> <a href="https://docs.daisyclaw.ai/tools/skills" rel="noreferrer noopener" target="_blank">toolSkills</a> <a href="https://docs.daisyclaw.ai/plugins/reference/diffs" rel="noreferrer noopener" target="_blank">pluginDocs</a> <a href="https://docs.daisyclaw.ai/prose" rel="noreferrer noopener" target="_blank">prose</a> <a href="https://docs.daisyclaw.ai/refactor/ingress-core" rel="noreferrer noopener" target="_blank">refactor</a></p>\n',
      );
    });
