...
function renderServerRow(props: McpViewProps, server: McpServerRow) {
  ...
  const probeCommand = `daisyclaw mcp probe ${quotedName}`;
  const loginCommand = `daisyclaw mcp login ${quotedName}`;
  return html`
    ...
    <section class="mcp-page">
      ...
      <section class="card mcp-command-card">
        ...
        <div class="mcp-command-card__grid">
          <code>daisyclaw mcp status --verbose</code>
          <code>daisyclaw mcp doctor --probe</code>
          <code>daisyclaw mcp login &lt;name&gt;</code>
          <code>daisyclaw mcp reload</code>
        </div>
      </section>
