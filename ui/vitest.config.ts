...
const workspaceSourceAliases = [
  ...
  {
    find: "daisyclaw/plugin-sdk/test-fixtures",
    replacement: path.resolve(repoRoot, "src/plugin-sdk/test-fixtures.ts"),
  },
  {
    find: /^@daisyclaw\/model-catalog-core\/(.+)$/u,
  ...
  {
    find: /^@daisyclaw\/normalization-core\/(.+)$/u,
